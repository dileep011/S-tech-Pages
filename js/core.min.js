 ...
 */ !(function (e, t) {
  ...
  function s(e, t, n) {
    return ec.isFunction(t)
      ? ec.grep(e, function (e, i) {
          return !!t.call(e, i, e) !== n;
        })
      : t.nodeType
      ? ec.grep(e, function (e) {
          return (e === t) !== n;
        })
      : "string" != typeof t
      ? ec.grep(e, function (e) {
          return et.call(t, e) > -1 !== n;
        })
      : e$.test(t)
      ? ec.filter(t, e, n)
      : ((t = ec.filter(t, e)),
        ec.grep(e, function (e) {
          return et.call(t, e) > -1 !== n && 1 === e.nodeType;
        }));
  }
  function a(e, t) {
  ...
  function c(e, t, n, i) {
    var r;
    try {
      e && ec.isFunction((r = e.promise))
        ? r.call(e).done(t).fail(n)
        : e && ec.isFunction((r = e.then))
        ? r.call(e, t, n)
  ...
  function d() {
    this.expando = ec.expando + d.uid++;
  }
  function p(e, t, n) {
    var i, r;
    if (void 0 === n && 1 === e.nodeType) {
      if (
        ((i = "data-" + t.replace(ek, "-$&").toLowerCase()),
  ...
  function h(e, t, n, i) {
    var r,
      ...
      l = o(),
      c = (n && n[3]) || (ec.cssNumber[t] ? "" : "px"),
      u = (ec.cssNumber[t] || ("px" !== c && +l)) && eL.exec(ec.css(e, t));
    if (u && u[3] !== c) {
      (c = c || u[3]), (n = n || []), (u = +l || 1);
      do (u /= s = s || ".5"), ec.style(e, t, u + c);
      while (s !== (s = o() / l) && 1 !== s && --a);
    }
    return (
      n &&
  ...
  function g(e, t) {
    for (var n, i, r = [], s = 0, a = e.length; s < a; s++)
      (i = e[s]).style &&
        ...
        t
          ? ("none" === n &&
              ((r[s] = eI.get(i, "display") || null),
              r[s] || (i.style.display = "")),
            "" === i.style.display && ez(i) && (r[s] = f(i)))
          : "none" !== n && ((r[s] = "none"), eI.set(i, "display", n)));
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && r(e, t)) ? ec.merge([e], n) : n
    );
  }
  function y(e, t) {
  ...
  function b(e, t, n, i, r) {
    for (
      ...
      if ((s = e[h]) || 0 === s) {
        if ("object" === ec.type(s)) ec.merge(p, s.nodeType ? [s] : s);
        else if (eB.test(s)) {
          for (
            a = a || d.appendChild(t.createElement("div")),
              l =
                eR[(o = (eH.exec(s) || ["", ""])[1].toLowerCase())] ||
                eR._default,
              a.innerHTML = l[1] + ec.htmlPrefilter(s) + l[2],
              u = l[0];
            u--;

          )
            a = a.lastChild;
          ec.merge(p, a.childNodes), ((a = d.firstChild).textContent = "");
        } else p.push(t.createTextNode(s));
      }
    for (d.textContent = "", h = 0; (s = p[h++]); )
      if (i && ec.inArray(s, i) > -1) r && r.push(s);
      else if (
        ((c = ec.contains(s.ownerDocument, s)),
        (a = v(d.appendChild(s), "script")),
        c && y(a),
        n)
      )
        for (u = 0; (s = a[u++]); ) ej.test(s.type || "") && n.push(s);
    return d;
  }
  function x() {
    return !0;
  ...
  function C(e, t, n, i, r, s) {
    ...
    return (
      1 === s &&
        ((a = r),
        ((r = function (e) {
          return ec().off(e), a.apply(this, arguments);
        }).guid = a.guid || (a.guid = ec.guid++))),
      e.each(function () {
        ec.event.add(this, t, r, i, n);
      })
    );
  }
  function T(e, t) {
  ...
  function I(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        eI.hasData(e) &&
        ((s = eI.access(e)), (a = eI.set(t, s)), (c = s.events))
      )
        for (r in (delete a.handle, (a.events = {}), c))
          for (n = 0, i = c[r].length; n < i; n++) ec.event.add(t, r, c[r][n]);
      eA.hasData(e) &&
        ((o = eA.access(e)), (l = ec.extend({}, o)), eA.set(t, l));
    }
  }
  function A(e, t) {
    var n = t.nodeName.toLowerCase();
    "input" === n && e9.test(e.type)
      ? (t.checked = e.checked)
      : ("input" !== n && "textarea" !== n) ||
  ...
  function D(e, t, i, r) {
    ...
    var s,
      ...
      f = t[0],
      g = ec.isFunction(f);
    if (g || (p > 1 && "string" == typeof f && !eo.checkClone && e1.test(f)))
      return e.each(function (n) {
        var s = e.eq(n);
        g && (t[0] = f.call(this, n, s.html())), D(s, t, i, r);
      });
    if (
      p &&
      ((a = (s = b(t, e[0].ownerDocument, !1, e, r)).firstChild),
      1 === s.childNodes.length && (s = a),
      a || r)
    ) {
      for (l = (o = ec.map(v(s, "script"), E)).length; d < p; d++)
        (c = s),
          d !== h &&
            ((c = ec.clone(c, !0, !0)), l && ec.merge(o, v(c, "script"))),
          i.call(e[d], c, d);
      if (l)
        for (u = o[o.length - 1].ownerDocument, ec.map(o, S), d = 0; d < l; d++)
          (c = o[d]),
            ej.test(c.type || "") &&
              !eI.access(c, "globalEval") &&
              ec.contains(u, c) &&
              (c.src
                ? ec._evalUrl && ec._evalUrl(c.src)
                : n(c.textContent.replace(eX, ""), u));
    }
    return e;
  }
  function k(e, t, n) {
    for (var i, r = t ? ec.filter(t, e) : e, s = 0; null != (i = r[s]); s++)
      n || 1 !== i.nodeType || ec.cleanData(v(i)),
        i.parentNode &&
          (n && ec.contains(i.ownerDocument, i) && y(v(i, "script")),
    ...
    return (
      t ||
        (t = ec.cssProps[e] =
          (function e(t) {
            if (t in eJ) return t;
            for (var n = t[0].toUpperCase() + t.slice(1), i = eZ.length; i--; )
              if ((t = eZ[i] + n) in eJ) return t;
          })(e) || e),
      t
    );
  }
  ...
  function M(e, t, n, i, r) {
    ...
    for (
      ...
      "margin" === n && (a += ec.css(e, n + eP[s], !0, r)),
        i
          ? ("content" === n && (a -= ec.css(e, "padding" + eP[s], !0, r)),
            "margin" !== n &&
              (a -= ec.css(e, "border" + eP[s] + "Width", !0, r)))
          : ((a += ec.css(e, "padding" + eP[s], !0, r)),
            "padding" !== n &&
              (a += ec.css(e, "border" + eP[s] + "Width", !0, r)));
    return a;
  }
  function N(e, t, n) {
    var i,
      r = e7(e),
      s = O(e, t, r),
      a = "border-box" === ec.css(e, "boxSizing", !1, r);
    return e2.test(s)
      ? s
      : ((i = a && (eo.boxSizingReliable() || s === e.style[t])),
        "auto" === s && (s = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (s = parseFloat(s) || 0) +
          M(e, t, n || (a ? "border" : "content"), i, r) +
          "px");
  }
  ...
  function R(e, t) {
    ...
    for (t = t ? 1 : 0; i < 4; i += 2 - t)
      r["margin" + (n = eP[i])] = r["padding" + n] = e;
    return t && (r.opacity = r.width = e), r;
  }
  function W(e, t, n) {
    for (
      var i,
        r = (F.tweeners[t] || []).concat(F.tweeners["*"]),
        s = 0,
        a = r.length;
      s < a;
      s++
  ...
  function F(e, t, n) {
    var i,
      ...
      c = o.promise({
        ...
        opts: ec.extend(
          !0,
          { specialEasing: {}, easing: ec.easing._default },
          n
        ),
    ...
    for (
      (function e(t, n) {
        ...
        for (i in t)
          if (
            ((s = n[(r = ec.camelCase(i))]),
            Array.isArray((a = t[i])) && ((s = a[1]), (a = t[i] = a[0])),
            i !== r && ((t[r] = a), delete t[i]),
            (o = ec.cssHooks[r]) && ("expand" in o))
          )
            for (i in ((a = o.expand(a)), delete t[r], a))
              (i in t) || ((t[i] = a[i]), (n[i] = s));
          else n[r] = s;
      })(u, c.opts.specialEasing);
      s < a;
      s++
    )
      if ((i = F.prefilters[s].call(c, e, u, c.opts)))
        return (
          ec.isFunction(i.stop) &&
            (ec._queueHooks(c.elem, c.opts.queue).stop = ec.proxy(i.stop, i)),
          i
        );
    return (
      ec.map(u, W, c),
      ec.isFunction(c.opts.start) && c.opts.start.call(e, c),
      c
        .progress(c.opts.progress)
        .done(c.opts.done, c.opts.complete)
        .fail(c.opts.fail)
        .always(c.opts.always),
      ec.fx.timer(ec.extend(l, { elem: e, anim: c, queue: c.opts.queue })),
      c
    );
  }
  function B(e) {
    return (e.match(eC) || []).join(" ");
  }
  function q(e) {
  ...
  function V(e, t, n, i) {
    ...
    else if (n || "object" !== ec.type(t)) i(e, t);
  ...
  function Y(e, t) {
    var n,
      i,
      r = ec.ajaxSettings.flatOptions || {};
    for (n in t) void 0 !== t[n] && ((r[n] ? e : i || (i = {}))[n] = t[n]);
    return i && ec.extend(!0, e, i), e;
  }
  var X = [],
    Q = e.document,
    ...
    en = {},
    ei = en.toString,
    er = en.hasOwnProperty,
    es = er.toString,
    ea = es.call(Object),
    eo = {},
    el = "3.2.1",
    ec = function (e, t) {
      return new ec.fn.init(e, t);
    },
    eu = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
    ed = /^-ms-/,
    ep = /-([a-z])/g,
  ...
  (ec.fn = ec.prototype =
    {
      ...
      pushStack: function (e) {
        var t = ec.merge(this.constructor(), e);
        return (t.prevObject = this), t;
      },
      each: function (e) {
        return ec.each(this, e);
      },
      map: function (e) {
        return this.pushStack(
          ec.map(this, function (t, n) {
            return e.call(t, n, t);
          })
        );
      },
      ...
      function () {
        ...
        for (
          "boolean" == typeof a && ((c = a), (a = arguments[o] || {}), o++),
            "object" == typeof a || ec.isFunction(a) || (a = {}),
            o === l && ((a = this), o--);
          o < l;
          o++
        )
          if (null != (e = arguments[o]))
            for (t in e)
              (n = a[t]),
                a !== (i = e[t]) &&
                  (c && i && (ec.isPlainObject(i) || (r = Array.isArray(i)))
                    ? (r
                        ? ((r = !1), (s = n && Array.isArray(n) ? n : []))
                        : (s = n && ec.isPlainObject(n) ? n : {}),
                      (a[t] = ec.extend(c, s, i)))
                    : void 0 !== i && (a[t] = i));
        return a;
      }),
    ec.extend({
      expando: "jQuery" + (el + Math.random()).replace(/\D/g, ""),
      isReady: !0,
      error: function (e) {
        throw Error(e);
      },
      ...
      isPlainObject: function (e) {
        ...
        return !(
          !e ||
          "[object Object]" !== ei.call(e) ||
          ((t = K(e)) &&
            ("function" !=
              typeof (n = er.call(t, "constructor") && t.constructor) ||
              es.call(n) !== ea))
        );
      },
      ...
      camelCase: function (e) {
        return e.replace(ed, "ms-").replace(ep, eh);
      },
      each: function (e, t) {
        var n,
          r = 0;
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (i(Object(e))
              ? ec.merge(n, "string" == typeof e ? [e] : e)
              : ee.call(n, e)),
          n
        );
      },
      inArray: function (e, t, n) {
        return null == t ? -1 : et.call(t, e, n);
      },
      merge: function (e, t) {
      ...
      map: function (e, t, n) {
        ...
        else for (a in e) null != (s = t(e[a], a, n)) && o.push(s);
        return J.apply([], o);
      },
      guid: 1,
      proxy: function (e, t) {
    ...
    "function" == typeof Symbol &&
      (ec.fn[Symbol.iterator] = X[Symbol.iterator]),
    ec.each(
      "Boolean Number String Function Array Date RegExp Object Error Symbol".split(
        " "
      ),
      function (e, t) {
        en["[object " + t + "]"] = t.toLowerCase();
      }
    );
  var ef = (function (e) {
    function t(e, t, n, i) {
      ...
      if (
        !i &&
        ((t ? t.ownerDocument || t : j) !== k && D(t), (t = t || k), L)
      ) {
        if (11 !== f && (l = em.exec(e))) {
          if ((r = l[1])) {
            if (9 === f) {
            ...
            } else if (h && (a = h.getElementById(r)) && N(t, a) && a.id === r)
              return n.push(a), n;
          } else {
        ...
        if (b.qsa && !q[e + " "] && (!P || !P.test(e))) {
          if (1 !== f) (h = t), (p = e);
          else if ("object" !== t.nodeName.toLowerCase()) {
            for (
              (o = t.getAttribute("id"))
                ? (o = o.replace(e$, eb))
                : t.setAttribute("id", (o = H)),
                s = (u = C(e)).length;
              s--;

            )
              u[s] = "#" + o + " " + d(u[s]);
            (p = u.join(",")), (h = (eg.test(e) && c(t.parentNode)) || t);
          }
          if (p)
            try {
          ...
          ? t.parentNode && !1 === t.disabled
            ? "label" in t
              ? "label" in t.parentNode
                ...
                : t.disabled === e
              : t.isDisabled === e || (!e !== t.isDisabled && ew(t) === e)
            : t.disabled === e
        ...
        i(function (i, o, l, c) {
          var u,
            ...
            y =
              i ||
              (function e(n, i, r) {
                for (var s = 0, a = i.length; s < a; s++) t(n, i[s], r);
                return r;
              })(n || "*", l.nodeType ? [l] : l, []),
            b = e && (i || !n) ? f(y, h, e, l, c) : y,
            x = r ? (a || (i ? e : v || s) ? [] : o) : b;
          if ((r && r(b, x, l, c), s))
            for (u = f(x, g), s(u, [], l, c), d = u.length; d--; )
              (p = u[d]) && (x[g[d]] = !(b[g[d]] = p));
          if (i) {
            if (a || e) {
              if (a) {
          ...
          } else (x = f(x === o ? x.splice(v, x.length) : x)), a ? a(null, o, x, c) : Q.apply(o, x);
        })
      );
    }
    function v(e) {
      for (
        ...
        if ((n = x.relative[e[o].type])) u = [p(h(u), n)];
        else {
          if ((n = x.filter[e[o].type].apply(null, e[o].matches))[H]) {
    ...
    try {
      Q.apply((U = K.call(j.childNodes)), j.childNodes),
      ...
      function (e) {
        ...
        return (
          i !== k &&
            9 === i.nodeType &&
            i.documentElement &&
            ((O = (k = i).documentElement),
            (L = !_(k)),
            j !== k &&
              (n = k.defaultView) &&
              n.top !== n &&
              (n.addEventListener
                ? n.addEventListener("unload", ex, !1)
                : n.attachEvent && n.attachEvent("onunload", ex)),
            ...
            (b.getElementsByClassName = ef.test(k.getElementsByClassName)),
            ...
            (z = []),
            (P = []),
            (b.qsa = ef.test(k.querySelectorAll)) &&
              (r(function (e) {
            ...
            (N =
              (t = ef.test(O.compareDocumentPosition)) || ef.test(O.contains)
                ? function (e, t) {
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!b.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === k || (e.ownerDocument === j && N(j, e))
                        ? -1
                        : t === k || (t.ownerDocument === j && N(j, t))
                        ? 1
                        : I
                        ? Z(I, e) - Z(I, t)
                        : 0
    ...
    (t.contains = function (e, t) {
      return (e.ownerDocument || e) !== k && D(e), N(e, t);
    }),
    (t.attr = function (e, t) {
      (e.ownerDocument || e) !== k && D(e);
    ...
    ((x = t.selectors =
      {
        ...
        preFilter: {
          ATTR: function (e) {
            return (
              (e[1] = e[1].replace(ev, ey)),
              (e[3] = (e[3] || e[4] || e[5] || "").replace(ev, ey)),
              "~=" === e[2] && (e[3] = " " + e[3] + " "),
              e.slice(0, 4)
            );
          },
        ...
        filter: {
          TAG: function (e) {
            var t = e.replace(ev, ey).toLowerCase();
            return "*" === e
              ? function () {
                  return !0;
                }
            ...
            return 1 === i && 0 === r
              ...
              : function (t, n, l) {
                  var c,
                    ...
                    h,
                    f,
                    g = s !== a ? "nextSibling" : "previousSibling",
                    v = t.parentNode,
                      ...
                      for (
                        x =
                          (h =
                            (c =
                              (u =
                                (d = (p = v)[H] || (p[H] = {}))[p.uniqueID] ||
                                (d[p.uniqueID] = {}))[e] || [])[0] === R &&
                            c[1]) && c[2],
                          p = h && v.childNodes[h];
                        (p = (++h && p && p[g]) || (x = h = 0) || f.pop());
        ...
        pseudos: {
          ...
          lang: i(function (e) {
            return (
              eu.test(e || "") || t.error("unsupported lang: " + e),
              (e = e.replace(ev, ey).toLowerCase()),
              function (t) {
                var n;
                do
                  if (
    ...
    return (
      ...
      (C = t.tokenize =
        function (e, n) {
          ...
          for (o = e, l = [], c = x.preFilter; o; ) {
            for (a in ((!i || (r = ea.exec(o))) &&
              (r && (o = o.slice(r[0].length) || o), l.push((s = []))),
            (i = !1),
            (r = eo.exec(o)) &&
              ((i = r.shift()),
              s.push({ value: i, type: r[0].replace(es, " ") }),
              (o = o.slice(i.length))),
            x.filter))
              (r = ed[a].exec(o)) &&
                (!c[a] || (r = c[a](r))) &&
      ...
      (T = t.compile =
        function (e, n) {
          var r,
            ...
            p = q[e + " "];
          if (!p) {
            for (n || (n = C(e)), c = n.length; c--; )
              (p = v(n[c]))[H] ? u.push(p) : d.push(p);
            (p = q(
              e,
              ((r = d),
              (a = (s = u).length > 0),
              (o = r.length > 0),
              (l = function (e, n, i, l, c) {
                var u,
                  d,
                  p,
                  h = 0,
                ...
                for (
                  ...
                  if (o && u) {
                    for (
                      d = 0, n || u.ownerDocument === k || (D(u), (i = !L));
                      (p = r[d++]);
                  ...
                  a && ((u = !p && u) && h--, e && v.push(u));
                }
                if (((h += g), a && g !== h)) {
                  for (d = 0; (p = s[d++]); ) p(v, y, n, i);
                  if (e) {
                    if (h > 0) for (; g--; ) v[g] || y[g] || (y[g] = Y.call(l));
                    y = f(y);
                  }
                  Q.apply(l, y),
                    c &&
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === p.length)) {
            if (
              ...
              if (!(t = (x.find.ID(a.matches[0].replace(ev, ey), t) || [])[0]))
                return n;
              u && (t = t.parentNode), (e = e.slice(s.shift().value.length));
            }
            for (
              r = ed.needsContext.test(e) ? 0 : s.length;
              ...
              if (
                (l = x.find[o]) &&
                (i = l(
                  a.matches[0].replace(ev, ey),
                  (eg.test(s[0].type) && c(t.parentNode)) || t
                ))
              ) {
                if ((s.splice(r, 1), !(e = i.length && d(s))))
  ...
  (ec.find = ef),
    (ec.expr = ef.selectors),
    (ec.expr[":"] = ec.expr.pseudos),
    (ec.uniqueSort = ec.unique = ef.uniqueSort),
    (ec.text = ef.getText),
    (ec.isXMLDoc = ef.isXML),
    (ec.contains = ef.contains),
    (ec.escapeSelector = ef.escape);
  var em = function (e, t, n) {
      for (var i = [], r = void 0 !== n; (e = e[t]) && 9 !== e.nodeType; )
        if (1 === e.nodeType) {
          if (r && ec(e).is(n)) break;
          i.push(e);
        }
      return i;
    },
    ...
    ev = ec.expr.match.needsContext,
    ey = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,
    e$ = /^.[^:#\[\.,]*$/;
  (ec.filter = function (e, t, n) {
    var i = t[0];
    return (
      n && (e = ":not(" + e + ")"),
      1 === t.length && 1 === i.nodeType
        ? ec.find.matchesSelector(i, e)
          ? [i]
          : []
        : ec.find.matches(
            e,
            ec.grep(t, function (e) {
              return 1 === e.nodeType;
            })
          )
    );
    ...
    ec.fn.extend({
      find: function (e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            ec(e).filter(function () {
              for (t = 0; t < i; t++) if (ec.contains(r[t], this)) return !0;
            })
          );
        for (n = this.pushStack([]), t = 0; t < i; t++) ec.find(e, r[t], n);
        return i > 1 ? ec.uniqueSort(n) : n;
      },
      filter: function (e) {
      ...
      is: function (e) {
        return !!s(
          this,
          "string" == typeof e && ev.test(e) ? ec(e) : e || [],
          !1
        ).length;
      },
    });
  var eb,
    ex = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  ((ec.fn.init = function (e, t, n) {
    var i, r;
    if (!e) return this;
    if (((n = n || eb), "string" == typeof e)) {
      if (
        !(i =
      ...
      if (i[1]) {
        if (
          ((t = t instanceof ec ? t[0] : t),
          ec.merge(
            this,
            ec.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : Q, !0)
          ),
          ey.test(i[1]) && ec.isPlainObject(t))
        )
          for (i in t)
            ec.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
        return this;
      }
      return (
        (r = Q.getElementById(i[2])) && ((this[0] = r), (this.length = 1)), this
      );
    }
    return e.nodeType
    ...
    (eb = ec(Q));
  var ew = /^(?:parents|prev(?:Until|All))/,
    e_ = { children: !0, contents: !0, next: !0, prev: !0 };
  ec.fn.extend({
    has: function (e) {
      var t = ec(e, this),
        n = t.length;
      return this.filter(function () {
        for (var e = 0; e < n; e++) if (ec.contains(this, t[e])) return !0;
      });
    },
        ...
        for (; i < r; i++)
          for (n = this[i]; n && n !== t; n = n.parentNode)
            if (
              ...
              (a
                ? a.index(n) > -1
                : 1 === n.nodeType && ec.find.matchesSelector(n, e))
            ) {
              s.push(n);
              break;
            }
      }
      return this.pushStack(s.length > 1 ? ec.uniqueSort(s) : s);
    },
    index: function (e) {
      return e
        ? "string" == typeof e
          ? et.call(ec(e), this[0])
          : et.call(this, e.jquery ? e[0] : e)
        : this[0] && this[0].parentNode
        ? this.first().prevAll().length
        : -1;
    },
    add: function (e, t) {
      return this.pushStack(ec.uniqueSort(ec.merge(this.get(), ec(e, t))));
    },
    addBack: function (e) {
    ...
    ec.each(
      {
        ...
        parents: function (e) {
          return em(e, "parentNode");
        },
        parentsUntil: function (e, t, n) {
          return em(e, "parentNode", n);
        },
        next: function (e) {
        ...
        prevAll: function (e) {
          return em(e, "previousSibling");
        },
        nextUntil: function (e, t, n) {
          return em(e, "nextSibling", n);
        },
        prevUntil: function (e, t, n) {
          return em(e, "previousSibling", n);
        },
        siblings: function (e) {
        ...
        contents: function (e) {
          return r(e, "iframe")
            ...
            : (r(e, "template") && (e = e.content || e),
              ec.merge([], e.childNodes));
        },
      },
      function (e, t) {
        ec.fn[e] = function (n, i) {
          var r = ec.map(this, t, n);
          return (
            "Until" !== e.slice(-5) && (i = n),
            i && "string" == typeof i && (r = ec.filter(i, r)),
            this.length > 1 &&
              (e_[e] || ec.uniqueSort(r), ew.test(e) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
  ...
  var eC = /[^\x20\t\r\n\f]+/g;
  (ec.Callbacks = function (e) {
    e =
      "string" == typeof e
        ? ((t = e),
          (n = {}),
          ec.each(t.match(eC) || [], function (e, t) {
            n[t] = !0;
          }),
          n)
        : ec.extend({}, e);
    var t,
      ...
      c = -1,
      u = function () {
        for (a = a || e.once, s = i = !0; l.length; c = -1)
          for (r = l.shift(); ++c < o.length; )
            !1 === o[c].apply(r[0], r[1]) &&
              e.stopOnFalse &&
              ((c = o.length), (r = !1));
        e.memory || (r = !1), (i = !1), a && (o = r ? [] : "");
      },
      d = {
        add: function () {
          return (
            o &&
              ...
              (function t(n) {
                ec.each(n, function (n, i) {
                  ec.isFunction(i)
                    ? (e.unique && d.has(i)) || o.push(i)
                    : i && i.length && "string" !== ec.type(i) && t(i);
                });
              })(arguments),
              r && !i && u()),
            this
        ...
        remove: function () {
          return (
            ec.each(arguments, function (e, t) {
              for (var n; (n = ec.inArray(t, o, n)) > -1; )
                o.splice(n, 1), n <= c && c--;
            }),
            this
          );
        ...
        has: function (e) {
          return e ? ec.inArray(e, o) > -1 : o.length > 0;
        },
        empty: function () {
          return o && (o = []), this;
        },
    ...
    ec.extend({
          ...
          r = {
            ...
            pipe: function () {
              ...
              return ec
                .Deferred(function (t) {
                  ec.each(n, function (n, i) {
                    var r = ec.isFunction(e[i[4]]) && e[i[4]];
                    s[i[1]](function () {
                      var e = r && r.apply(this, arguments);
                      e && ec.isFunction(e.promise)
                        ? e
                            .promise()
                            .progress(t.notify)
                            .done(t.resolve)
            ...
            then: function (t, i, r) {
              function s(t, n, i, r) {
                return function () {
                    ...
                    d = function () {
                      ...
                      if (!(t < a)) {
                        ...
                        (d =
                          ...
                          ec.isFunction(d)
                            ? r
                              ? d.call(e, s(a, n, o, r), s(a, n, l, r))
                              : (a++,
                                d.call(
                                  e,
                                  s(a, n, o, r),
                                  s(a, n, l, r),
                                  s(a, n, o, n.notifyWith)
                                ))
                            : (i !== o && ((c = void 0), (u = [e])),
                              (r || n.resolveWith)(c, u));
                      }
                    ...
                    p = r
                      ...
                      : function () {
                          try {
                            ...
                            ec.Deferred.exceptionHook &&
                              ec.Deferred.exceptionHook(e, p.stackTrace),
                              t + 1 >= a &&
                                (i !== l && ((c = void 0), (u = [e])),
                                n.rejectWith(c, u));
                          }
                  ...
                  t
                    ? p()
                    : (ec.Deferred.getStackHook &&
                        (p.stackTrace = ec.Deferred.getStackHook()),
                      e.setTimeout(p));
                };
              }
              var a = 0;
              return ec
                .Deferred(function (e) {
                  n[0][3].add(s(0, e, ec.isFunction(r) ? r : o, e.notifyWith)),
                    n[1][3].add(s(0, e, ec.isFunction(t) ? t : o)),
                    n[2][3].add(s(0, e, ec.isFunction(i) ? i : l));
                })
                .promise();
            },
            promise: function (e) {
              return null != e ? ec.extend(e, r) : r;
            },
          },
          s = {};
        return (
          ec.each(n, function (e, t) {
            var a = t[2],
              o = t[5];
            (r[t[1]] = a.add),
              o &&
      ...
      when: function (e) {
        ...
        if (
          ...
          "pending" === s.state() || ec.isFunction(r[n] && r[n].then))
        )
          return s.then();
  ...
  (ec.Deferred.exceptionHook = function (t, n) {
    e.console &&
      e.console.warn &&
      t &&
      eT.test(t.name) &&
    ...
    (ec.readyException = function (t) {
      e.setTimeout(function () {
        throw t;
      });
    });
  var e8 = ec.Deferred();
  (ec.fn.ready = function (e) {
    return (
      e8.then(e).catch(function (e) {
        ec.readyException(e);
      }),
      this
    );
    ...
    ec.extend({
      ...
      readyWait: 1,
      ready: function (e) {
        (!0 === e ? --ec.readyWait : ec.isReady) ||
          ((ec.isReady = !0),
          (!0 !== e && --ec.readyWait > 0) || e8.resolveWith(Q, [ec]));
      },
    }),
    (ec.ready.then = e8.then),
    "complete" !== Q.readyState &&
    ("loading" === Q.readyState || Q.documentElement.doScroll)
      ? (Q.addEventListener("DOMContentLoaded", u),
        e.addEventListener("load", u))
      : e.setTimeout(ec.ready);
  var eE = function (e, t, n, i, r, s, a) {
      var o = 0,
        l = e.length,
        c = null == n;
      if ("object" === ec.type(n))
        for (o in ((r = !0), n)) eE(e, t, o, n[o], !0, s, a);
      else if (
        void 0 !== i &&
        ((r = !0),
        ec.isFunction(i) || (a = !0),
  ...
  (d.uid = 1),
    (d.prototype = {
      ...
      set: function (e, t, n) {
        var i,
          r = this.cache(e);
        if ("string" == typeof t) r[ec.camelCase(t)] = n;
        else for (i in t) r[ec.camelCase(i)] = t[i];
        return r;
      },
      get: function (e, t) {
        return void 0 === t
          ? this.cache(e)
          : e[this.expando] && e[this.expando][ec.camelCase(t)];
      },
        ...
        if (void 0 !== i) {
          if (void 0 !== t)
            for (
              ...
              delete i[t[n]];
          (void 0 === t || ec.isEmptyObject(i)) &&
            (e.nodeType ? (e[this.expando] = void 0) : delete e[this.expando]);
        }
      },
      hasData: function (e) {
        var t = e[this.expando];
        return void 0 !== t && !ec.isEmptyObject(t);
      },
    });
  var eI = new d(),
    eA = new d(),
  ...
  ec.extend({
    hasData: function (e) {
      return eA.hasData(e) || eI.hasData(e);
    },
    data: function (e, t, n) {
    ...
    ec.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((r = eA.get(s)), 1 === s.nodeType && !eI.get(s, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                0 === (i = a[n].name).indexOf("data-") &&
                p(s, (i = ec.camelCase(i.slice(5))), r[i]);
            eI.set(s, "hasDataAttrs", !0);
          }
          return r;
        }
        return "object" == typeof e
          ...
          : eE(
              ...
              function (t) {
                var n;
                if (s && void 0 === t) {
                  if (void 0 !== (n = eA.get(s, e)) || void 0 !== (n = p(s, e)))
                    return n;
                } else
                  this.each(function () {
                    eA.set(this, e, t);
    ...
    ec.extend({
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!i || Array.isArray(n)
                ? (i = eI.access(e, t, ec.makeArray(n)))
                : i.push(n)),
            i || []
          );
      },
      ...
      _queueHooks: function (e, t) {
        ...
        return (
          eI.get(e, n) ||
          eI.access(e, n, {
            empty: ec.Callbacks("once memory").add(function () {
    ...
    ec.fn.extend({
      queue: function (e, t) {
        ...
        return (
          ...
          arguments.length < n
            ...
            ? this
            : this.each(function () {
                var n = ec.queue(this, e, t);
                ec._queueHooks(this, e),
                  "fx" === e && "inprogress" !== n[0] && ec.dequeue(this, e);
              })
        );
      },
      dequeue: function (e) {
      ...
      promise: function (e, t) {
        ...
        for (
          ...
          (n = eI.get(s[a], e + "queueHooks")) &&
            n.empty &&
            (i++, n.empty.add(o));
        return o(), r.promise(t);
      },
    });
  var eO = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    eL = RegExp("^(?:([+-])=|)(" + eO + ")([a-z%]*)$", "i"),
    ...
    toggle: function (e) {
      return "boolean" == typeof e
        ? e
          ...
          : this.hide()
        : this.each(function () {
            ez(this) ? ec(this).show() : ec(this).hide();
          });
    },
  });
  var e9 = /^(?:checkbox|radio)$/i,
    eH = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i,
    ej = /^$|\/(?:java|ecma)script/i,
    eR = {
  ...
  (eR.optgroup = eR.option),
    (eR.tbody = eR.tfoot = eR.colgroup = eR.caption = eR.thead),
    (eR.th = eR.td);
  var eW,
    eF,
    eB = /<|&#?\w+;/;
  (eW = Q.createDocumentFragment().appendChild(Q.createElement("div"))),
    (eF = Q.createElement("input")).setAttribute("type", "radio"),
    eF.setAttribute("checked", "checked"),
    eF.setAttribute("name", "t"),
    eW.appendChild(eF),
    (eo.checkClone = eW.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (eW.innerHTML = "<textarea>x</textarea>"),
    (eo.noCloneChecked = !!eW.cloneNode(!0).lastChild.defaultValue);
  var e0 = Q.documentElement,
    eq = /^key/,
    eV = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
    e3 = /^([^.]*)(?:\.(.+)|)/;
  (ec.event = {
    global: {},
      ...
      if (v)
        for (
          n.handler && ((n = (s = n).handler), (r = s.selector)),
            r && ec.find.matchesSelector(e0, r),
            n.guid || (n.guid = ec.guid++),
            (l = v.events) || (l = v.events = {}),
            (a = v.handle) ||
              (a = v.handle =
                function (t) {
                  return void 0 !== ec && ec.event.triggered !== t.type
                    ? ec.event.dispatch.apply(e, arguments)
                    : void 0;
                }),
            c = (t = (t || "").match(eC) || [""]).length;
          c--;
          ...
          (h = g = (o = e3.exec(t[c]) || [])[1]),
            ...
            h &&
              ...
              (u = ec.extend(
                {
                  ...
                  guid: n.guid,
                  selector: r,
                  needsContext: r && ec.expr.match.needsContext.test(r),
                  namespace: f.join("."),
                },
                s
              )),
              (p = l[h]) ||
                ...
                (d.setup && !1 !== d.setup.call(e, i, f, a)) ||
          ...
          if (
            ...
            a &&
              ...
              ((d.teardown && !1 !== d.teardown.call(e, f, v.handle)) ||
                ec.removeEvent(e, h, v.handle),
              delete l[h]);
          } else for (h in l) ec.event.remove(e, h + t[c], n, i, !0);
        ec.isEmptyObject(l) && eI.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var t,
        ...
        c = (eI.get(this, "events") || {})[o.type] || [],
        u = ec.event.special[o.type] || {};
      ...
      if (
        ...
        for (
          a = ec.event.handlers.call(this, o, c), t = 0;
          ...
          for (
            ...
            (o.rnamespace && !o.rnamespace.test(s.namespace)) ||
              ...
              void 0 !==
                (i = (
                  (ec.event.special[s.origType] || {}).handle || s.handler
                ).apply(r.elem, l)) &&
                !1 === (o.result = i) &&
    ...
    addProp: function (e, t) {
      Object.defineProperty(ec.Event.prototype, e, {
        enumerable: !0,
        configurable: !0,
        get: ec.isFunction(t)
          ? function () {
    ...
    fix: function (e) {
      return e[ec.expando] ? e : new ec.Event(e);
    },
    special: {
      load: { noBubble: !0 },
      focus: {
    ...
    (ec.removeEvent = function (e, t, n) {
      e.removeEventListener && e.removeEventListener(t, n);
    }),
    (ec.Event = function (e, t) {
      return this instanceof ec.Event
        ? (e && e.type
            ...
            : (this.type = e),
          t && ec.extend(this, t),
          (this.timeStamp = (e && e.timeStamp) || ec.now()),
          void (this[ec.expando] = !0))
        : new ec.Event(e, t);
    }),
    (ec.Event.prototype = {
    ...
    ec.each(
      {
        ...
        which: function (e) {
          var t = e.button;
          return null == e.which && eq.test(e.type)
            ? null != e.charCode
              ? e.charCode
              : e.keyCode
            : !e.which && void 0 !== t && eV.test(e.type)
            ? 1 & t
              ? 1
              : 2 & t
              ? 3
  ...
  ec.extend({
    ...
    clone: function (e, t, n) {
      var i,
        ...
        a,
        o = e.cloneNode(!0),
        l = ec.contains(e.ownerDocument, e);
      if (
        !(
          eo.noCloneChecked ||
        ...
        for (a = v(o), s = v(e), i = 0, r = s.length; i < r; i++) A(s[i], a[i]);
      if (t) {
        if (n)
          for (s = s || v(e), a = a || v(o), i = 0, r = s.length; i < r; i++)
            I(s[i], a[i]);
        else I(e, o);
      }
      return (a = v(o, "script")).length > 0 && y(a, !l && v(e, "script")), o;
    },
    cleanData: function (e) {
      for (var t, n, i, r = ec.event.special, s = 0; void 0 !== (n = e[s]); s++)
        if (eS(n)) {
          if ((t = n[eI.expando])) {
            if (t.events)
              for (i in t.events)
                r[i] ? ec.event.remove(n, i) : ec.removeEvent(n, i, t.handle);
            n[eI.expando] = void 0;
          }
          n[eA.expando] && (n[eA.expando] = void 0);
        }
    },
  }),
    ec.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (ec.cleanData(v(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return eE(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !eU.test(e) &&
              !eR[(eH.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = ec.htmlPrefilter(e);
              try {
                for (; n < i; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (ec.cleanData(v(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (r) {}
            }
      ...
      replaceWith: function () {
        ...
        return D(
          ...
          function (t) {
            ...
            0 > ec.inArray(this, e) &&
              (ec.cleanData(v(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
    ...
    ec.each(
      ...
      function (e, t) {
        ec.fn[e] = function (e) {
          for (var n, i = [], r = ec(e), s = r.length - 1, a = 0; a <= s; a++)
  ...
  !(function () {
    ...
    o.style &&
      ...
      (eo.clearCloneStyle = "content-box" === o.style.backgroundClip),
      (a.style.cssText =
  ...
  var eK = /^(none|table(?!-c[ea]).+)/,
    ...
    e6 = { letterSpacing: "0", fontWeight: "400" },
    eZ = ["Webkit", "Moz", "ms"],
    eJ = Q.createElement("div").style;
  ec.extend({
    cssHooks: {
      opacity: {
        get: function (e, t) {
    ...
    ec.each(["height", "width"], function (e, t) {
      ec.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !eK.test(ec.css(e, "display")) ||
        ...
        set: function (e, n, i) {
          var r,
            ...
            a =
              i &&
              M(e, t, i, "border-box" === ec.css(e, "boxSizing", !1, s), s);
          return (
            a &&
              (r = eL.exec(n)) &&
              "px" !== (r[3] || "px") &&
              ((e.style[t] = n), (n = ec.css(e, t))),
            z(e, n, a)
          );
        },
      };
    }),
    (ec.cssHooks.marginLeft = L(eo.reliableMarginLeft, function (e, t) {
      if (t)
        return (
          (parseFloat(O(e, "marginLeft")) ||
            e.getBoundingClientRect().left -
              eM(e, { marginLeft: 0 }, function () {
                return e.getBoundingClientRect().left;
              })) + "px"
        );
    })),
    ec.each({ margin: "", padding: "", border: "Width" }, function (e, t) {
      (ec.cssHooks[e + t] = {
        expand: function (n) {
          for (
            ...
            r[e + eP[i] + t] = s[i] || s[i - 2] || s[0];
          return r;
        },
      }),
        eQ.test(e) || (ec.cssHooks[e + t].set = z);
    }),
    ec.fn.extend({
      css: function (e, t) {
        return eE(
          ...
          function (e, t, n) {
            var i,
              ...
              a = 0;
            if (Array.isArray(t)) {
              for (i = e7(e), r = t.length; a < r; a++)
                s[t[a]] = ec.css(e, t[a], !1, i);
              return s;
            }
            return void 0 !== n ? ec.style(e, t, n) : ec.css(e, t);
          },
          e,
          t,
          arguments.length > 1
    ...
    (H.prototype = {
      ...
      init: function (e, t, n, i, r, s) {
        (this.elem = e),
          (this.prop = n),
          (this.easing = r || ec.easing._default),
          (this.options = t),
          (this.start = this.now = this.cur()),
          (this.end = i),
          (this.unit = s || (ec.cssNumber[n] ? "" : "px"));
      },
      cur: function () {
      ...
      _default: {
        ...
        set: function (e) {
          ec.fx.step[e.prop]
            ? ec.fx.step[e.prop](e)
            : 1 === e.elem.nodeType &&
              (null != e.elem.style[ec.cssProps[e.prop]] || ec.cssHooks[e.prop])
            ? ec.style(e.elem, e.prop, e.now + e.unit)
            : (e.elem[e.prop] = e.now);
        },
      },
    }),
  ...
  var te,
    ...
    tr = /^(?:toggle|show|hide)$/,
    ts = /queueHooks$/;
  (ec.Animation = ec.extend(F, {
    tweeners: {
      "*": [
        function (e, t) {
          var n = this.createTween(e, t);
          return h(n.elem, e, eL.exec(t), n), n;
        },
      ],
    },
    tweener: function (e, t) {
      ec.isFunction(e) ? ((t = e), (e = ["*"])) : (e = e.match(eC));
    ...
    prefilters: [
      function (e, t, n) {
        var i,
          ...
          v = eI.get(e, "fxshow");
        for (i in (n.queue ||
          (null == (a = ec._queueHooks(e, "fx")).unqueued &&
            ((a.unqueued = 0),
            (o = a.empty.fire),
          ...
          d.always(function () {
            d.always(function () {
              a.unqueued--, ec.queue(e, "fx").length || a.empty.fire();
            });
          })),
        t))
          if (((r = t[i]), tr.test(r))) {
            ...
            p[i] = (v && v[i]) || ec.style(e, i);
          }
        if ((l = !ec.isEmptyObject(t)) || !ec.isEmptyObject(p))
          for (i in (("width" in t || "height" in t) &&
            1 === e.nodeType &&
            ((n.overflow = [h.overflow, h.overflowX, h.overflowY]),
            null == (c = v && v.display) && (c = eI.get(e, "display")),
            "none" === (u = ec.css(e, "display")) &&
              (c
                ? (u = c)
                : (g([e], !0),
                  (c = e.style.display || c),
          ...
          p))
            l ||
              (v
                ...
                : (v = eI.access(e, "fxshow", { display: c })),
              s && (v.hidden = !f),
              f && g([e], !0),
              d.done(function () {
                for (i in (f || g([e]), eI.remove(e, "fxshow"), p))
                  ec.style(e, i, p[i]);
              })),
              (l = W(f ? v[i] : 0, i, d)),
              i in v ||
                ((v[i] = l.start), f && ((l.end = l.start), (l.start = 0)));
      },
    ],
    ...
    (ec.speed = function (e, t, n) {
      var i =
        e && "object" == typeof e
          ? ec.extend({}, e)
          : {
              complete: n || (!n && t) || (ec.isFunction(e) && e),
              duration: e,
              easing: (n && t) || (t && !ec.isFunction(t) && t),
            };
      return (
        ec.fx.off
          ? (i.duration = 0)
          : "number" != typeof i.duration &&
            (i.duration in ec.fx.speeds
              ? (i.duration = ec.fx.speeds[i.duration])
              : (i.duration = ec.fx.speeds._default)),
        (null != i.queue && !0 !== i.queue) || (i.queue = "fx"),
        (i.old = i.complete),
        (i.complete = function () {
          ec.isFunction(i.old) && i.old.call(this),
            i.queue && ec.dequeue(this, i.queue);
        }),
        i
      );
    }),
    ec.fn.extend({
      ...
      animate: function (e, t, n, i) {
        var r = ec.isEmptyObject(e),
          s = ec.speed(t, n, i),
          a = function () {
            var t = F(this, ec.extend({}, e), s);
      ...
      stop: function (e, t, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (r in a) a[r] && a[r].stop && ts.test(r) && i(a[r]);
            for (r = s.length; r--; )
              s[r].elem !== this ||
                (null != e && s[r].queue !== e) ||
                (s[r].anim.stop(n), (t = !1), s.splice(r, 1));
            (!t && n) || ec.dequeue(this, e);
          })
        );
      },
      finish: function (e) {
    ...
    ec.each(["toggle", "show", "hide"], function (e, t) {
      var n = ec.fn[t];
      ec.fn[t] = function (e, i, r) {
        return null == e || "boolean" == typeof e
          ? n.apply(this, arguments)
          : this.animate(R(t, !0), e, i, r);
      };
    }),
    ec.each(
      {
    ...
    (ec.fx.tick = function () {
      var e,
        t = 0,
        n = ec.timers;
      for (te = ec.now(); t < n.length; t++)
        (e = n[t])() || n[t] !== e || n.splice(t--, 1);
      n.length || ec.fx.stop(), (te = void 0);
    }),
    (ec.fx.timer = function (e) {
      ec.timers.push(e), ec.fx.start();
    }),
    (ec.fx.interval = 13),
    (ec.fx.start = function () {
      tt ||
        ((tt = !0),
        (function t() {
          tt &&
    ...
    (ec.fx.speeds = { slow: 600, fast: 200, _default: 400 }),
    (ec.fn.delay = function (t, n) {
      return (
        (t = (ec.fx && ec.fx.speeds[t]) || t),
        (n = n || "fx"),
    ...
    (tn = Q.createElement("input")),
    (ti = Q.createElement("select").appendChild(Q.createElement("option"))),
    (tn.type = "checkbox"),
    (eo.checkOn = "" !== tn.value),
    (eo.optSelected = ti.selected),
    ((tn = Q.createElement("input")).value = "t"),
    (tn.type = "radio"),
    (eo.radioValue = "t" === tn.value);
  var ta,
    to = ec.expr.attrHandle;
  ec.fn.extend({
    attr: function (e, t) {
      return eE(this, ec.attr, e, t, arguments.length > 1);
    },
    removeAttr: function (e) {
      return this.each(function () {
        ec.removeAttr(this, e);
      });
    },
  }),
    ec.extend({
      attr: function (e, t, n) {
        ...
        if (3 !== s && 8 !== s && 2 !== s)
          return void 0 === e.getAttribute
            ...
            : ((1 === s && ec.isXMLDoc(e)) ||
                (r =
                  ec.attrHooks[t.toLowerCase()] ||
                  (ec.expr.match.bool.test(t) ? ta : void 0)),
              void 0 !== n
                ? null === n
                  ? void ec.removeAttr(e, t)
                  : r && "set" in r && void 0 !== (i = r.set(e, n, t))
                  ? i
                  : (e.setAttribute(t, n + ""), n)
                : r && "get" in r && null !== (i = r.get(e, t))
                ? i
                : null == (i = ec.find.attr(e, t))
                ? void 0
                : i);
      },
      attrHooks: {
        type: {
          set: function (e, t) {
            if (!eo.radioValue && "radio" === t && r(e, "input")) {
              var n = e.value;
    ...
    (ta = {
      set: function (e, t, n) {
        return !1 === t ? ec.removeAttr(e, n) : e.setAttribute(n, n), n;
      },
    }),
    ec.each(ec.expr.match.bool.source.match(/\w+/g), function (e, t) {
      var n = to[t] || ec.find.attr;
      to[t] = function (e, t, i) {
        var r,
          s,
          a = t.toLowerCase();
  ...
  ec.fn.extend({
    prop: function (e, t) {
      return eE(this, ec.prop, e, t, arguments.length > 1);
    },
    removeProp: function (e) {
      return this.each(function () {
        delete this[ec.propFix[e] || e];
      });
    },
  }),
    ec.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== s && 8 !== s && 2 !== s)
          return (
            (1 === s && ec.isXMLDoc(e)) ||
              ((t = ec.propFix[t] || t), (r = ec.propHooks[t])),
            void 0 !== n
              ? r && "set" in r && void 0 !== (i = r.set(e, n, t))
                ? i
                : (e[t] = n)
    ...
    ec.each(
      ...
      function () {
        ec.propFix[this.toLowerCase()] = this;
      }
    ),
    ec.fn.extend({
      addClass: function (e) {
        ...
        if (ec.isFunction(e))
          return this.each(function (t) {
            ec(this).addClass(e.call(this, t, q(this)));
          });
        if ("string" == typeof e && e) {
          for (t = e.match(eC) || []; (n = this[l++]); )
            if (((r = q(n)), (i = 1 === n.nodeType && " " + B(r) + " "))) {
              for (a = 0; (s = t[a++]); )
                0 > i.indexOf(" " + s + " ") && (i += s + " ");
              r !== (o = B(i)) && n.setAttribute("class", o);
            }
        }
        return this;
      },
      removeClass: function (e) {
        ...
        if (ec.isFunction(e))
          return this.each(function (t) {
            ec(this).removeClass(e.call(this, t, q(this)));
          });
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && "string" === n
          ...
          ? this.each(function (n) {
              ec(this).toggleClass(e.call(this, n, q(this), t), t);
            })
          : this.each(function () {
              var t, i, r, s;
              if ("string" === n)
                for (i = 0, r = ec(this), s = e.match(eC) || []; (t = s[i++]); )
                  r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = q(this)) && eI.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || !1 === e ? "" : eI.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && (" " + B(q(n)) + " ").indexOf(t) > -1)
            return !0;
        return !1;
      },
    });
  ...
  ec.fn.extend({
      ...
      return arguments.length
        ? ((i = ec.isFunction(e)),
          this.each(function (n) {
            var r;
            1 === this.nodeType &&
              (null == (r = i ? e.call(this, n, ec(this).val()) : e)
                ? (r = "")
                : "number" == typeof r
                ? (r += "")
                : Array.isArray(r) &&
                  (r = ec.map(r, function (e) {
                    return null == e ? "" : e + "";
                  })),
              ((t =
                ec.valHooks[this.type] ||
                ec.valHooks[this.nodeName.toLowerCase()]) &&
                "set" in t &&
                void 0 !== t.set(this, r, "value")) ||
                (this.value = r));
          }))
        : r
        ? (t = ec.valHooks[r.type] || ec.valHooks[r.nodeName.toLowerCase()]) &&
          "get" in t &&
    ...
    ec.extend({
      valHooks: {
        option: {
          get: function (e) {
            var t = ec.find.attr(e, "value");
            return null != t ? t : B(ec.text(e));
          },
        },
        select: {
          get: function (e) {
          ...
          set: function (e, t) {
            for (
              var n, i, r = e.options, s = ec.makeArray(t), a = r.length;
              a--;

            )
              ((i = r[a]).selected =
                ec.inArray(ec.valHooks.option.get(i), s) > -1) && (n = !0);
            return n || (e.selectedIndex = -1), s;
          },
        },
      },
    }),
    ec.each(["radio", "checkbox"], function () {
      (ec.valHooks[this] = {
        set: function (e, t) {
          if (Array.isArray(t))
            return (e.checked = ec.inArray(ec(e).val(), t) > -1);
        },
      }),
        eo.checkOn ||
          (ec.valHooks[this].get = function (e) {
  ...
  ec.extend(ec.event, {
    trigger: function (t, n, i, r) {
      var s,
        ...
        f = er.call(t, "namespace") ? t.namespace.split(".") : [];
      if (
        ((a = o = i = i || Q),
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !td.test(h + ec.event.triggered) &&
          (h.indexOf(".") > -1 && ((h = (f = h.split(".")).shift()), f.sort()),
          (c = 0 > h.indexOf(":") && "on" + h),
          ((t = t[ec.expando]
            ? t
            : new ec.Event(h, "object" == typeof t && t)).isTrigger = r
            ? 2
            : 3),
          (t.namespace = f.join(".")),
          ...
          (t.result = void 0),
          t.target || (t.target = i),
          (n = null == n ? [t] : ec.makeArray(n, [t])),
          (d = ec.event.special[h] || {}),
          r || !d.trigger || !1 !== d.trigger.apply(i, n)))
      ) {
        if (!r && !d.noBubble && !ec.isWindow(i)) {
          for (
            l = d.delegateType || h, td.test(l + h) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            p.push(a), (o = a);
          o === (i.ownerDocument || Q) &&
            p.push(o.defaultView || o.parentWindow || e);
        }
        for (s = 0; (a = p[s++]) && !t.isPropagationStopped(); )
          (t.type = s > 1 ? l : d.bindType || h),
            (u = (eI.get(a, "events") || {})[t.type] && eI.get(a, "handle")) &&
              u.apply(a, n),
            (u = c && a[c]) &&
              u.apply &&
              eS(a) &&
        ...
        return (
          ...
          r ||
            ...
            (c &&
              ...
              !ec.isWindow(i) &&
              ((o = i[c]) && (i[c] = null),
              (ec.event.triggered = h),
              i[h](),
              (ec.event.triggered = void 0),
              o && (i[c] = o))),
          t.result
        );
      }
    ...
    simulate: function (e, t, n) {
      var i = ec.extend(new ec.Event(), n, { type: e, isSimulated: !0 });
      ec.event.trigger(i, null, t);
    },
  }),
    ec.fn.extend({
      trigger: function (e, t) {
        return this.each(function () {
          ec.event.trigger(e, t, this);
        });
      },
      triggerHandler: function (e, t) {
        var n = this[0];
        if (n) return ec.event.trigger(e, t, n, !0);
      },
    }),
    ec.each(
    ...
    (eo.focusin = "onfocusin" in e),
    eo.focusin ||
      ec.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        var n = function (e) {
          ec.event.simulate(t, e.target, ec.event.fix(e));
        };
        ec.event.special[t] = {
          setup: function () {
            var i = this.ownerDocument || this,
              r = eI.access(i, t);
            r || i.addEventListener(e, n, !0), eI.access(i, t, (r || 0) + 1);
          },
          teardown: function () {
            var i = this.ownerDocument || this,
              r = eI.access(i, t) - 1;
            r
              ? eI.access(i, t, r)
              : (i.removeEventListener(e, n, !0), eI.remove(i, t));
          },
        };
      });
  var tp = e.location,
  ...
  (ec.param = function (e, t) {
    var n,
      i = [],
      r = function (e, t) {
        var n = ec.isFunction(t) ? t() : t;
        i[i.length] =
          encodeURIComponent(e) + "=" + encodeURIComponent(null == n ? "" : n);
      };
    if (Array.isArray(e) || (e.jquery && !ec.isPlainObject(e)))
      ec.each(e, function () {
    ...
    ec.fn.extend({
      serialize: function () {
        return ec.param(this.serializeArray());
      },
      serializeArray: function () {
        return this.map(function () {
          var e = ec.prop(this, "elements");
          return e ? ec.makeArray(e) : this;
        })
          .filter(function () {
            var e = this.type;
            return (
  ...
  (tS.href = tp.href),
    ec.extend({
      ...
      ajaxSettings: {
        ...
        converters: {
          ...
          "text xml": ec.parseXML,
        },
        flatOptions: { url: !0, context: !0 },
      },
      ajaxSetup: function (e, t) {
        return t ? Y(Y(e, ec.ajaxSettings), t) : Y(ec.ajaxSettings, e);
      },
      ajaxPrefilter: G(tT),
      ajaxTransport: G(t8),
      ajax: function (t, n) {
        function i(t, n, i, o) {
          ...
          u ||
            ...
            i &&
              (w = (function e(t, n, i) {
                for (
                  var r, s, a, o, l = t.contents, c = t.dataTypes;
                  "*" === c[0];
            ...
            c
              ? (f.ifModified &&
                  ((_ = T.getResponseHeader("Last-Modified")) &&
                    (ec.lastModified[s] = _),
                  (_ = T.getResponseHeader("etag")) && (ec.etag[s] = _)),
                204 === t || "HEAD" === f.type
                  ? (C = "nocontent")
                  : 304 === t
                  ? (C = "notmodified")
                  : ((C = w.state), (p = w.data), (c = !(h = w.error))))
              : ((h = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
            (T.status = t),
            (T.statusText = (n || C) + ""),
            c ? y.resolveWith(g, [p, C, T]) : y.rejectWith(g, [T, C, h]),
            T.statusCode(x),
            (x = void 0),
            ...
            d &&
              ...
              --ec.active || ec.event.trigger("ajaxStop")));
        }
        ...
        var r,
          ...
          f = ec.ajaxSetup({}, n),
          g = f.context || f,
          v = f.context && (g.nodeType || g.jquery) ? ec(g) : ec.event,
          y = ec.Deferred(),
          b = ec.Callbacks("once memory"),
          x = f.statusCode || {},
          w = {},
          _ = {},
          C = "canceled",
          T = {
            ...
            getResponseHeader: function (e) {
              ...
              if (u) {
                if (!o)
                  for (o = {}; (t = tw.exec(a)); ) o[t[1].toLowerCase()] = t[2];
                t = o[e.toLowerCase()];
              }
            ...
            setRequestHeader: function (e, t) {
              return (
                null == u &&
                  (w[(e = _[e.toLowerCase()] = _[e.toLowerCase()] || e)] = t),
                this
              );
            },
        ...
        if (
          (y.promise(T),
          (f.url = ((t || f.url || tp.href) + "").replace(
            tC,
            tp.protocol + "//"
          )),
          (f.type = n.method || n.type || f.method || f.type),
          (f.dataTypes = (f.dataType || "*").toLowerCase().match(eC) || [""]),
          null == f.crossDomain)
        ) {
          c = Q.createElement("a");
          try {
            (c.href = f.url),
              (c.href = c.href),
              (f.crossDomain =
                tS.protocol + "//" + tS.host != c.protocol + "//" + c.host);
          } catch (E) {
            f.crossDomain = !0;
          }
        }
        if (
          (f.data &&
            ...
            (f.data = ec.param(f.data, f.traditional)),
          U(tT, f, n, T),
          u)
        )
          return T;
        for (p in ((d = ec.event && f.global) &&
          0 == ec.active++ &&
          ec.event.trigger("ajaxStart"),
        (f.type = f.type.toUpperCase()),
        (f.hasContent = !t_.test(f.type)),
        (s = f.url.replace(tb, "")),
        f.hasContent
          ? f.data &&
            f.processData &&
          ...
          : ((h = f.url.slice(s.length)),
            f.data && ((s += (tf.test(s) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((s = s.replace(tx, "$1")),
              (h = (tf.test(s) ? "&" : "?") + "_=" + th++ + h)),
            (f.url = s + h)),
        f.ifModified &&
          (ec.lastModified[s] &&
            T.setRequestHeader("If-Modified-Since", ec.lastModified[s]),
          ec.etag[s] && T.setRequestHeader("If-None-Match", ec.etag[s])),
      ...
      getJSON: function (e, t, n) {
        return ec.get(e, t, n, "json");
      },
      getScript: function (e, t) {
        return ec.get(e, void 0, t, "script");
      },
    }),
    ec.each(["get", "post"], function (e, t) {
      ec[t] = function (e, n, i, r) {
        return (
          ec.isFunction(n) && ((r = r || i), (i = n), (n = void 0)),
          ec.ajax(
            ec.extend(
              { url: e, type: t, dataType: r, data: n, success: i },
              ec.isPlainObject(e) && e
            )
          )
        );
      };
    }),
    (ec._evalUrl = function (e) {
      return ec.ajax({
        url: e,
        type: "GET",
        dataType: "script",
    ...
    ec.fn.extend({
      wrapAll: function (e) {
        ...
        return (
          this[0] &&
            (ec.isFunction(e) && (e = e.call(this[0])),
            (t = ec(e, this[0].ownerDocument).eq(0).clone(!0)),
      ...
      wrapInner: function (e) {
        return ec.isFunction(e)
          ? this.each(function (t) {
              ec(this).wrapInner(e.call(this, t));
            })
          : this.each(function () {
              var t = ec(this),
                n = t.contents();
      ...
      wrap: function (e) {
        var t = ec.isFunction(e);
        return this.each(function (n) {
          ec(this).wrapAll(t ? e.call(this, n) : e);
        });
      },
      unwrap: function (e) {
        return (
          this.parent(e)
            .not("body")
            .each(function () {
              ec(this).replaceWith(this.childNodes);
            }),
          this
        );
      },
    }),
    (ec.expr.pseudos.hidden = function (e) {
      return !ec.expr.pseudos.visible(e);
    }),
    (ec.expr.pseudos.visible = function (e) {
  ...
  var tI = { 0: 200, 1223: 204 },
    tA = ec.ajaxSettings.xhr();
  (eo.cors = !!tA && "withCredentials" in tA),
    (eo.ajax = tA = !!tA),
    ec.ajaxTransport(function (t) {
      var n, i;
      if (eo.cors || (tA && !t.crossDomain))
        return {
          send: function (r, s) {
            var a,
              o = t.xhr();
    ...
    ec.ajaxSetup({
      ...
      converters: {
        "text script": function (e) {
          return ec.globalEval(e), e;
        },
      },
    }),
    ec.ajaxPrefilter("script", function (e) {
      void 0 === e.cache && (e.cache = !1), e.crossDomain && (e.type = "GET");
    }),
    ec.ajaxTransport("script", function (e) {
      if (e.crossDomain) {
        var t, n;
        return {
          send: function (i, r) {
  ...
  ec.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = tk.pop() || ec.expando + "_" + th++;
      return (this[e] = !0), e;
    },
  }),
    ec.ajaxPrefilter("json jsonp", function (t, n, i) {
      var r,
        s,
        a,
        o =
      ...
      if (o || "jsonp" === t.dataTypes[0])
        return (
          (r = t.jsonpCallback =
            ec.isFunction(t.jsonpCallback)
              ? t.jsonpCallback()
              : t.jsonpCallback),
          o
            ? (t[o] = t[o].replace(tO, "$1" + r))
            : !1 !== t.jsonp &&
              (t.url += (tf.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
          (t.converters["script json"] = function () {
            return a || ec.error(r + " was not called"), a[0];
          }),
          (t.dataTypes[0] = "json"),
          (s = e[r]),
          (e[r] = function () {
          ...
          i.always(function () {
            void 0 === s ? ec(e).removeProp(r) : (e[r] = s),
              t[r] && ((t.jsonpCallback = n.jsonpCallback), tk.push(r)),
              a && ec.isFunction(s) && s(a[0]),
              (a = s = void 0);
          }),
          "script"
        );
    }),
    (eo.createHTMLDocument =
      (((tD = Q.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
      2 === tD.childNodes.length)),
    (ec.parseHTML = function (e, t, n) {
      var i, r, s;
      return "string" != typeof e
        ...
        : ("boolean" == typeof t && ((n = t), (t = !1)),
          ...
          r
            ? [t.createElement(r[1])]
            : ((r = b([e], t, s)),
              s && s.length && ec(s).remove(),
              ec.merge([], r.childNodes)));
    }),
    (ec.fn.load = function (e, t, n) {
      var i,
        r,
        s,
        a = this,
        o = e.indexOf(" ");
      return (
        o > -1 && ((i = B(e.slice(o))), (e = e.slice(0, o))),
        ec.isFunction(t)
          ? ((n = t), (t = void 0))
        ...
        a.length > 0 &&
          ec
            ...
            .done(function (e) {
              (s = arguments),
                a.html(i ? ec("<div>").append(ec.parseHTML(e)).find(i) : e);
            })
            .always(
              n &&
                function (e, t) {
    ...
    (ec.expr.pseudos.animated = function (e) {
      return ec.grep(ec.timers, function (t) {
        return e === t.elem;
      }).length;
    }),
    (ec.offset = {
      setOffset: function (e, t, n) {
        ...
        "static" === c && (e.style.position = "relative"),
          ...
          ec.isFunction(t) && (t = t.call(e, n, ec.extend({}, o))),
        ...
        return s
          ? s.getClientRects().length
            ? ((i = s.getBoundingClientRect()),
              (n = (t = s.ownerDocument).documentElement),
              (r = t.defaultView),
              {
      ...
      position: function () {
        if (this[0]) {
          var e,
            ...
            i = { top: 0, left: 0 };
          return (
            "fixed" === ec.css(n, "position")
              ? (t = n.getBoundingClientRect())
              : ((e = this.offsetParent()),
                (t = this.offset()),
                r(e[0], "html") || (i = e.offset()),
                (i = {
                  top: i.top + ec.css(e[0], "borderTopWidth", !0),
                  left: i.left + ec.css(e[0], "borderLeftWidth", !0),
                })),
            {
              top: t.top - i.top - ec.css(n, "marginTop", !0),
              left: t.left - i.left - ec.css(n, "marginLeft", !0),
            }
          );
        }
      },
    ...
    ec.each(["top", "left"], function (e, t) {
      ec.cssHooks[t] = L(eo.pixelPosition, function (e, n) {
        if (n)
          return (n = O(e, t)), e2.test(n) ? ec(e).position()[t] + "px" : n;
      });
    }),
    ec.each({ Height: "height", Width: "width" }, function (e, t) {
      ec.each(
        { padding: "inner" + e, content: t, "": "outer" + e },
        function (n, i) {
          ec.fn[i] = function (r, s) {
    ...
    (ec.holdReady = function (e) {
      e ? ec.readyWait++ : ec.ready(!0);
    }),
    (ec.isArray = Array.isArray),
    (ec.parseJSON = JSON.parse),
    (ec.nodeName = r),
  ...
  var tL = e.jQuery,
    tP = e.$;
  return (
    (ec.noConflict = function (t) {
      return (
        e.$ === ec && (e.$ = tP), t && e.jQuery === ec && (e.jQuery = tL), ec
      );
    }),
    t || (e.jQuery = e.$ = ec),
    ec
  ...
  (function (e, t) {
    ...
    (e.migrateVersion = "3.0.0"),
      (r =
        ...
        ((e && !/^[12]\./.test(e.fn.jquery)) ||
          r("JQMIGRATE: jQuery 3.0.0+ REQUIRED"),
        e.migrateWarnings &&
          r("JQMIGRATE: Migrate plugin loaded multiple times"),
        r(
    ...
    for (s in ((e.fn.init = function (e) {
      ...
      return (
        "string" == typeof e &&
          "#" === e &&
          (n("jQuery( '#' ) is not a valid selector"), (t[0] = [])),
        o.apply(this, t)
      );
    }),
    ...
    (e.find = function (e) {
      ...
      if ("string" == typeof e && u.test(e))
        try {
          ...
          try {
            document.querySelector(e),
              n("Attribute selector with '#' must be quoted: " + t[0]),
              (t[0] = e);
          } catch (r) {
    ...
    c))
      Object.prototype.hasOwnProperty.call(c, s) && (e.find[s] = c[s]);
    (e.fn.size = function () {
      return (
      ...
      (e.isNumeric = function (t) {
        var i,
          ...
          a =
            ((r = (i = t) && i.toString()),
            !e.isArray(i) && r - parseFloat(r) + 1 >= 0);
        return (
          s !== a &&
      ...
      return (
        e.each(t.match(g), function (t, r) {
          e.expr.match.bool.test(r) &&
            (n("jQuery.fn.removeAttr no longer sets boolean properties: " + r),
            i.prop(r, !1));
        }),
            ...
            this.each(function () {
              ...
              n && e.data(this, "__className__", n),
                this.setAttribute &&
                  this.setAttribute(
                    "class",
                    n || !1 === t ? "" : e.data(this, "__className__") || ""
                  );
            }));
      });
    var v = !1;
    e.swap &&
      e.each(["height", "width", "reliableMarginRight"], function (t, n) {
        ...
        i &&
          (e.cssHooks[n].get = function () {
            var e;
            return (v = !0), (e = i.apply(this, arguments)), (v = !1), e;
          });
      }),
      (e.swap = function (e, t, i, r) {
        var s,
          a,
          o = {};
        for (a in (v || n("jQuery.swap() is undocumented and deprecated"), t))
          (o[a] = e.style[a]), (e.style[a] = t[a]);
        for (a in ((s = i.apply(e, r || [])), t)) e.style[a] = o[a];
        return s;
      });
    var y = e.data;
    e.data = function (t, i, r) {
      ...
      return i &&
        i !== e.camelCase(i) &&
        (s = e.hasData(t) && y.call(this, t)) &&
        i in s
        ? (n("jQuery.data() always sets/gets camelCased names: " + i),
          arguments.length > 2 && (s[i] = r),
          s[i])
        : y.apply(this, arguments);
    };
    var b = e.Tween.prototype.run;
    e.Tween.prototype.run = function (t) {
      e.easing[this.easing].length > 1 &&
        ...
        (e.easing[this.easing] = e.easing[this.easing].bind(
          e.easing,
          t,
    ...
    (e.event.props = []),
      ...
      (e.event.fix = function (t) {
        ...
        if (
          ...
          !s._migrated_ &&
          ((s._migrated_ = !0),
          n("jQuery.event.fixHooks are deprecated and removed: " + r),
          (a = s.props) && a.length)
        )
          for (; a.length; ) e.event.addProp(a.pop());
        return (i = w.call(this, t)), s && s.filter ? s.filter(i, t) : i;
      }),
    ...
    e.fn.offset = function () {
      var t,
        ...
        r = { top: 0, left: 0 };
      return i && i.nodeType
        ? ((t = (i.ownerDocument || document).documentElement),
          e.contains(t, i)
            ...
            : (n(
              ...
              r))
        : (n("jQuery.fn.offset() requires a valid DOM element"), r);
    };
    var C = e.param;
    ...
    var T = e.fn.andSelf || e.fn.addBack;
      ...
      s = (e.cookie = function (r, a, o) {
        if (arguments.length > 1 && !e.isFunction(a)) {
          ...
          return (document.cookie = [
            t(r),
            "=",
            ((l = a), t(s.json ? JSON.stringify(l) : String(l))),
   ...
   */ function () {
    ...
    (t = window.device),
      ...
      (a = function (e) {
        var t;
        return (t = RegExp(e, "i")), i.className.match(t);
      }),
      (n = function (e) {
        var t = null;
        a(e) ||
          ((t = i.className.replace(/^\s+|\s+$/g, "")),
          (i.className = t + " " + e));
      }),
      (l = function (e) {
      ...
      (s = function () {
        e.landscape()
          ? (l("portrait"), n("landscape"))
          : (l("landscape"), n("portrait"));
      }),
      (o = Object.prototype.hasOwnProperty.call(window, "onorientationchange")
        ? "orientationchange"
        : "resize"),
      window.addEventListener
        ? window.addEventListener(o, s, !1)
        : window.attachEvent
        ? window.attachEvent(o, s)
        : (window[o] = s),
      s(),
   ...
   */ (function (e, t, n) {
    ...
    (s[c] = 250),
      ...
      (e.event.special[o] = {
        setup: function () {
          if (!s[u] && this[a]) return !1;
          var n = e(this);
          (r = r.add(n)),
            e.data(this, l, { w: n.width(), h: n.height() }),
            1 === r.length &&
              (function n() {
                i = t[a](function () {
                  r.each(function () {
        ...
        teardown: function () {
          if (!s[u] && this[a]) return !1;
          var t = e(this);
          (r = r.not(t)), t.removeData(l), r.length || clearTimeout(i);
        },
        add: function (t) {
          var i;
          if (!s[u] && this[a]) return !1;
    ...
    e.extend(e.easing, {
      ...
      easeInOutElastic: function (e) {
        return 0 === e
          ...
          ? 1
          : e < 0.5
          ? (-n(2, 20 * e - 10) * r((20 * e - 11.125) * l)) / 2
          : (n(2, -20 * e + 10) * r((20 * e - 11.125) * l)) / 2 + 1;
      },
      ...
      easeInOutBack: function (e) {
        return e < 0.5
          ? (n(2 * e, 2) * (7.189819 * e - 2.5949095)) / 2
          : (n(2 * e - 2, 2) * (3.5949095 * (2 * e - 2) + 2.5949095) + 2) / 2;
      },
  ...
  (function (e) {
    ...
    function n(t, n) {
      function D(t) {
        if (
          !(
            !(!0 !== eC.data(A + "_intouch")) ||
            e(t.target).closest(n.excludedElements, eC).length > 0
          )
        ) {
          ...
          if (
            ...
            return (
              ...
              K(),
              ee(0, d),
              !u || e8 === n.fingers || n.fingers === b || B()
                ? ((eS = eo()),
                  2 == e8 &&
                    (ee(1, u[1]), (ey = e$ = es(eE[0].start, eE[1].start))),
                  (n.swipeStatus || n.pinchStatus) && (l = N(o, eT)))
                : (l = !1),
              !1 === l
                ? (N(o, (eT = T)), l)
                : (n.hold &&
                    (eL = setTimeout(
                      e.proxy(function () {
                        eC.trigger("hold", [o.target]),
                          n.hold && (l = n.hold.call(eC, o, o.target));
                      }, this),
                      n.longTapThreshold
                    )),
                  J(!0),
      ...
      function k(t) {
        var d = t.originalEvent ? t.originalEvent : t;
        if (eT !== C && eT !== T && !Z()) {
          var p,
            h,
            f,
          ...
          if (
            ((eI = eo()),
            g && (e8 = g.length),
            n.hold && clearTimeout(eL),
            (eT = _),
            2 == e8 &&
              (0 == ey
                ? (ee(1, g[1]), (ey = e$ = es(eE[0].start, eE[1].start)))
                : (et(g[1]),
                  (e$ = es(eE[0].end, eE[1].end)),
                  (ew = (eE[0].end, eE[1].end, eb < 1 ? l : o))),
              (eb = ((h = ey), (f = e$), ((f / h) * 1).toFixed(2))),
              (ex = Math.abs(ey - e$))),
            e8 === n.fingers || n.fingers === b || !g || B())
          ) {
            if (
              ((em = ea(x.start, x.end)),
              (function e(t, o) {
                if (!1 !== n.preventDefaultEvents) {
                  if (n.allowPageScroll === c) t.preventDefault();
                    ...
                    var l = n.allowPageScroll === u;
                    switch (o) {
                      case i:
                        ((n.swipeLeft && l) ||
                          (!l && n.allowPageScroll != v)) &&
                          t.preventDefault();
                        break;
                      case r:
                        ((n.swipeRight && l) ||
                        ...
                        break;
                      case s:
                        ((n.swipeUp && l) || (!l && n.allowPageScroll != y)) &&
                          t.preventDefault();
                        break;
                      case a:
                        ((n.swipeDown && l) ||
                          (!l && n.allowPageScroll != y)) &&
                          t.preventDefault();
                    }
                  }
                }
              })(t, (eg = ea(x.last, x.end))),
              (ef =
                ((E = x.start),
                (S = x.end),
                Math.round(
                  Math.sqrt(Math.pow(S.x - E.x, 2) + Math.pow(S.y - E.y, 2))
                ))),
              (ev = er()),
              (I = em),
              (A = ef),
              I != c && ((A = Math.max(A, en(I))), (e_[I].distance = A)),
              (p = N(d, eT)),
              ...
              if (n.triggerOnTouchLeave) {
                var E,
                  ...
                  P =
                    ...
                    {
                      left: k.left,
                      right: k.left + D.outerWidth(),
                      top: k.top,
                      bottom: k.top + D.outerHeight(),
                    });
                w =
                  ((O = x.end),
                  (L = P),
              ...
              !n.triggerOnTouchEnd && w
                ? (eT = M(_))
                : n.triggerOnTouchLeave && !w && (eT = M(C)),
                (eT != T && eT != C) || N(d, eT);
            }
          } else N(d, (eT = T));
          !1 === p && N(d, (eT = T));
      ...
      function O(e) {
        ...
        if (r) {
          if (r.length && !Z()) {
            return (t = i), (eA = eo()), (eD = t.touches.length + 1), !0;
          }
          if (r.length && Z()) return !0;
        }
        return (
          Z() && (e8 = eD),
          (eI = eo()),
          ...
          R() || !j()
            ? N(i, (eT = T))
            : n.triggerOnTouchEnd || (!1 === n.triggerOnTouchEnd && eT === _)
      ...
      function L() {
        (e8 = 0), (eI = 0), (eS = 0), (ey = 0), (e$ = 0), (eb = 1), K(), J(!1);
      }
      function P(e) {
        var t = e.originalEvent ? e.originalEvent : e;
        n.triggerOnTouchLeave && N(t, (eT = M(C)));
      }
      function z() {
        eC.unbind(ec, D),
          eC.unbind(eh, L),
      ...
      function M(e) {
        ...
        return (
          !i || s
            ? (t = T)
            : r && e == _ && (!n.triggerOnTouchEnd || n.triggerOnTouchLeave)
            ? (t = C)
            : !r && e == C && n.triggerOnTouchLeave && (t = T),
          t
        );
      }
      function N(e, t) {
        ...
        return (
          ...
          Q() && X() && !1 !== i
            ? (i = H(e, t, f))
            : ev > n.longTapThreshold && ef < x && n.longTap && !1 !== i
            ? (i = H(e, t, g))
            : !((1 === e8 || !E) && (isNaN(ef) || ef < n.threshold)) ||
              !Y() ||
              !1 === i ||
              (i = H(e, t, h)),
          t === T && L(e),
        ...
        if (u == d) {
          ...
          if (c == C && q()) {
            if (
              (clearTimeout(eO),
              clearTimeout(eL),
              eC.trigger("swipe", [em, ef, ev, e8, eE, eg]),
              n.swipe &&
                !1 === (v = n.swipe.call(eC, t, em, ef, ev, e8, eE, eg)))
            )
              return !1;
            switch (em) {
              case i:
                eC.trigger("swipeLeft", [em, ef, ev, e8, eE, eg]),
                  n.swipeLeft &&
                    (v = n.swipeLeft.call(eC, t, em, ef, ev, e8, eE, eg));
                break;
              case r:
                eC.trigger("swipeRight", [em, ef, ev, e8, eE, eg]),
                  n.swipeRight &&
                    (v = n.swipeRight.call(eC, t, em, ef, ev, e8, eE, eg));
                break;
              case s:
                eC.trigger("swipeUp", [em, ef, ev, e8, eE, eg]),
                  n.swipeUp &&
                    (v = n.swipeUp.call(eC, t, em, ef, ev, e8, eE, eg));
                break;
              case a:
                eC.trigger("swipeDown", [em, ef, ev, e8, eE, eg]),
                  n.swipeDown &&
                    (v = n.swipeDown.call(eC, t, em, ef, ev, e8, eE, eg));
            }
          }
        }
        if (u == p) {
          if (
            (eC.trigger("pinchStatus", [
              c,
              ew || null,
              ex || 0,
              ev || 0,
        ...
        return (
          u == h
              ...
              X() && !Q()
                ? ((ek = eo()),
                  (eO = setTimeout(
                    e.proxy(function () {
                      (ek = null),
                        eC.trigger("tap", [t.target]),
                        n.tap && (v = n.tap.call(eC, t, t.target));
                    }, this),
            ...
            ? (c !== T && c !== C) ||
              ...
              clearTimeout(eL),
              (ek = null),
              eC.trigger("doubletap", [t.target]),
              n.doubleTap && (v = n.doubleTap.call(eC, t, t.target)))
            : u == g &&
              ((c !== T && c !== C) ||
                (clearTimeout(eO),
                (ek = null),
                eC.trigger("longtap", [t.target]),
                n.longTap && (v = n.longTap.call(eC, t, t.target)))),
          v
        );
      }
      function j() {
        var e = !0;
        return null !== n.threshold && (e = ef >= n.threshold), e;
      }
      function R() {
        var e = !1;
        return (
          null !== n.cancelThreshold &&
            null !== em &&
            (e = en(em) - ef >= n.cancelThreshold),
          e
        );
      }
      function W() {
        return !(n.maxTimeThreshold && ev >= n.maxTimeThreshold);
      }
      function F() {
        var e = G(),
          t = U(),
          i = null === n.pinchThreshold || ex >= n.pinchThreshold;
        return e && t && i;
      }
      function B() {
      ...
      function G() {
        return e8 === n.fingers || n.fingers === b || !E;
      }
      function U() {
        return 0 !== eE[0].end.x;
      }
      ...
      function Q() {
        if (null == ek) return !1;
        var e = eo();
        return X() && e - ek <= n.doubleTapThreshold;
      }
      function K() {
        (eA = 0), (eD = 0);
      }
      function Z() {
        var e = !1;
        return eA && eo() - eA <= n.fingerReleaseThreshold && (e = !0), e;
      }
      function J(e) {
        eC &&
          (!0 === e
            ? (eC.bind(eu, k), eC.bind(ed, O), ep && eC.bind(ep, P))
            : (eC.unbind(eu, k, !1),
              eC.unbind(ed, O, !1),
              ep && eC.unbind(ep, P, !1)),
          eC.data(A + "_intouch", !0 === e));
      }
      function ee(e, t) {
        var n = {
          start: { x: 0, y: 0 },
      ...
      function et(e) {
        var t,
          n = void 0 !== e.identifier ? e.identifier : 0,
          i = ((t = n), eE[t] || null);
        return (
          null === i && (i = ee(n, e)),
          (i.last.x = i.end.x),
      ...
      function ea(e, t) {
        if (((n = e), (o = t), n.x == o.x && n.y == o.y)) return c;
        var n,
          o,
          l,
          u,
          ...
          h =
            ...
            (u = t),
            (d = l.x - u.x),
            (p = Math.round((180 * Math.atan2(u.y - l.y, d)) / Math.PI)) < 0 &&
              (p = 360 - Math.abs(p)),
            p);
        return h <= 45 && h >= 0
          ? i
      ...
      var n = e.extend({}, n),
        el = E || I || !n.fallbackToMouseEvents,
        ec = el
          ? I
            ? S
              ? "MSPointerDown"
        ...
        ed = el
          ? I
            ...
            : "touchend"
          : "mouseup",
        ep = el ? (I ? "mouseleave" : null) : "mouseleave",
        eh = I ? (S ? "MSPointerCancel" : "pointercancel") : "touchcancel",
        ef = 0,
        em = null,
        eg = null,
        ev = 0,
        ...
        eL = null;
      try {
        eC.bind(ec, D), eC.bind(eh, L);
      } catch (eP) {
        e.error("events not supported " + ec + "," + eh + " on jQuery.swipe");
      }
      (this.enable = function () {
        return this.disable(), eC.bind(ec, D), eC.bind(eh, L), eC;
      }),
        (this.disable = function () {
          return z(), eC;
        }),
        (this.destroy = function () {
          z(), eC.data(A, null), (eC = null);
        }),
   ...
   */ (function (e, t) {
    ...
    function i(e) {
      ...
      var r = t(e),
        ...
        a = r.overflowX,
        o = r.overflowY;
      return /(auto|scroll)/.test(s + o + a) ? e : i(n(e));
    }
    function r(e) {
    ...
    function a(e, t) {
      ...
      u.setStart(l, 0), u.setEnd(c, 0);
      var d = u.commonAncestorContainer;
      if ((e !== d && t !== d) || l.contains(c))
        return "BODY" !== (i = (n = d).nodeName) &&
          ("HTML" === i || r(n.firstElementChild) === n)
          ? d
          : r(d);
      var p = s(e);
    ...
    function l(e, t) {
      ...
      return (
        ...
        +e["border" + ("Left" == n ? "Right" : "Bottom") + "Width"].split(
          "px"
        )[0]
      );
    }
    ...
    function p(e) {
      ...
      var a = {
        ...
        c = "HTML" === e.nodeName ? u() : {},
        p = c.width || e.clientWidth || a.right - a.left,
        h = c.height || e.clientHeight || a.bottom - a.top,
        f = e.offsetWidth - p,
        g = e.offsetHeight - h;
      if (f || g) {
        var v = t(e);
        (f -= l(v, "x")), (g -= l(v, "y")), (a.width -= f), (a.height -= g);
      }
      return d(a);
    }
    function h(e, n) {
      ...
      if (((g.marginTop = 0), (g.marginLeft = 0), !r && s)) {
        var v = +u.marginTop.split("px")[0],
          y = +u.marginLeft.split("px")[0];
        (g.top -= h - v),
          (g.bottom -= h - v),
          (g.left -= f - y),
          (g.right -= f - y),
      ...
      return (
        (r ? n.contains(c) : n === c && "BODY" !== c.nodeName) &&
          (g = (function e(t, n) {
            var i =
    ...
    function f(e, r, s, l) {
      ...
      if ("viewport" === l)
        c =
          ((f = p),
          (v = h(f, (g = window.document.documentElement))),
          (y = M(g.clientWidth, window.innerWidth || 0)),
          (b = M(g.clientHeight, window.innerHeight || 0)),
          (x = o(g)),
          (w = o(g, "left")),
          d({
            top: x - v.top + v.marginTop,
            left: w - v.left + v.marginLeft,
            width: y,
            height: b,
          }));
      else {
        "scrollParent" === l
          ? "BODY" === (_ = i(n(e))).nodeName &&
            (_ = window.document.documentElement)
          : (_ = "window" === l ? window.document.documentElement : l);
        var f,
          g,
          v,
          y,
        ...
        if (
          ...
          var T = u(),
            E = T.height,
            S = T.width;
          (c.top += C.top - C.marginTop),
            (c.bottom = E + C.top),
            (c.left += C.left - C.marginLeft),
            (c.right = S + C.left);
        } else c = C;
      }
      return (c.left += s), (c.top += s), (c.right -= s), (c.bottom -= s), c;
    }
    ...
    function x(e, t, n) {
      ...
      return (
        (r[a] = t[a] + t[l] / 2 - i[l] / 2),
        (r[o] = n === o ? t[o] - i[s ? "width" : "height"] : t[b(o)]),
        r
      );
    }
    function w(e, t) {
    ...
    function C() {
      if (!this.state.isDestroyed) {
        ...
        (e.offsets.reference = v(this.state, this.popper, this.reference)),
          (e.placement = g(
        ...
        (this.state =
          ...
          (function e(t, n, r, s) {
            var a = "BODY" === t.nodeName,
              o = a ? window : t;
            o.addEventListener(n, r, { passive: !0 }),
              a || e(i(o.parentNode), n, r, s),
              s.push(o);
          })((s = i(e)), "scroll", n.updateBound, n.scrollParents),
          (n.scrollElement = s),
          (n.eventsEnabled = !0),
          n));
    }
    ...
    for (
      ...
      if (N && 0 <= navigator.userAgent.indexOf(H[R])) {
        j = 1;
        break;
      }
    var W,
      ...
      B =
        ...
        ["native code", "[object MutationObserverConstructor]"].some(function (
          e
        ) {
      ...
      q = function () {
        return (
          void 0 == F && (F = -1 !== navigator.appVersion.indexOf("MSIE 10")), F
        );
      },
      V = function (e, t) {
        if (!(e instanceof t))
      ...
      Z = (function () {
        function t(n, i) {
          ...
          V(this, t),
            ...
            Object.keys(Y({}, t.Defaults.modifiers, s.modifiers)).forEach(
              function (e) {
                r.options.modifiers[e] = Y(
                  {},
        ...
        modifiers: {
              ...
              return (
                (n = D(+f)
                  ...
                  : ((i = f),
                    ...
                    (s = b),
                    (o = [0, 0]),
                    (l = -1 !== ["right", "left"].indexOf((a = x))),
                    c[
                      (u = (c = i.split(/(\+|\-)/).map(function (e) {
                        return e.trim();
                      })).indexOf(
                        w(c, function (e) {
                          return -1 !== e.search(/,|\s/);
          ...
          preventOverflow: {
            ...
            fn: function (e, t) {
              ...
              var i = f(e.instance.popper, e.instance.reference, t.padding, n);
              t.boundaries = i;
              var s = t.priority,
                a = e.offsets.popper,
                o = {
          ...
          keepTogether: {
            ...
            fn: function (e) {
              ...
              return (
                n[o] < s(i[l]) &&
                  (e.offsets.popper[l] = s(i[l]) - n[a ? "width" : "height"]),
                n[l] > s(i[o]) && (e.offsets.popper[l] = s(i[o])),
                e
              );
            },
          },
          arrow: {
            ...
            fn: function (e, t) {
              ...
              var f = a[c] + a[l] / 2 - h / 2 - d(e.offsets.popper)[c];
              return (
                (f = M(P(s[l] - h, f), 0)),
                (e.arrowElement = n),
                (e.offsets.arrow = {}),
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              var n = t.x,
                i = t.y,
                s = e.offsets.popper,
                a = w(e.instance.modifiers, function (e) {
              ...
              (o = "right" == v ? -d.width + f.right : f.left),
              c && y)
                ? ((h[y] = "translate3d(" + o + "px, " + l + "px, 0)"),
                  (h[g] = 0),
                  (h[v] = 0),
          ...
          applyStyle: {
            ...
            fn: function (e) {
              return (
                ...
                e.offsets.arrow && k(e.arrowElement, e.offsets.arrow),
                e
              );
            },
 ...
 */ var bootstrap = (function (e, t, n) {
  ...
  var r,
    ...
    eg = (function () {
      ...
      return (
        (n = (function e() {
          ...
          for (var n in i) if (void 0 !== t.style[n]) return { end: i[n] };
          return !1;
        })()),
    ...
    e$ =
      ...
      (l = (function () {
        ...
        return (
          ...
          (n._getRootElement = function (e) {
            var n = eg.getSelectorFromElement(e),
              i = !1;
            return (
              n && (i = t(n)[0]), i || (i = t(e).closest("." + o.ALERT)[0]), i
            );
          }),
          ...
          (n._removeElement = function (e) {
            var n = this;
            t(e).removeClass(o.SHOW),
              eg.supportsTransitionEnd() && t(e).hasClass(o.FADE)
                ? t(e)
                    .one(eg.TRANSITION_END, function (t) {
      ...
      (t.fn[r] = l._jQueryInterface),
      (t.fn[r].Constructor = l),
      (t.fn[r].noConflict = function () {
        return (t.fn[r] = s), l._jQueryInterface;
      }),
      l),
    eb =
      ((c = "button"),
      ...
      (f = (function () {
        ...
        return (
          (n.toggle = function () {
            ...
            if (i) {
              var r = t(this._element).find(p.INPUT)[0];
              if (r) {
                if ("radio" === r.type) {
                  if (r.checked && t(this._element).hasClass(d.ACTIVE)) e = !1;
                  else {
                    var s = t(i).find(p.ACTIVE)[0];
                ...
                if (e) {
                  if (
                    ...
                    return;
                  (r.checked = !t(this._element).hasClass(d.ACTIVE)),
                    t(r).trigger("change");
                }
                r.focus(), (n = !1);
              }
      ...
      t(document)
        .on(h.CLICK_DATA_API, p.DATA_TOGGLE_CARROT, function (e) {
          e.preventDefault();
          var n = e.target;
          t(n).hasClass(d.BUTTON) || (n = t(n).closest(p.BUTTON)),
      ...
      (t.fn[c] = f._jQueryInterface),
      (t.fn[c].Constructor = f),
      (t.fn[c].noConflict = function () {
        return (t.fn[c] = u), f._jQueryInterface;
      }),
      f),
    ex =
      ((g = "carousel"),
      ...
      (S = (function () {
        function e(e, n) {
          (this._items = null),
            ...
            (this._element = t(e)[0]),
            (this._indicatorsElement = t(this._element).find(E.INDICATORS)[0]),
        ...
        return (
          ...
          (n.pause = function (e) {
            e || (this._isPaused = !0),
              t(this._element).find(E.NEXT_PREV)[0] &&
                eg.supportsTransitionEnd() &&
                (eg.triggerTransitionEnd(this._element), this.cycle(!0)),
          ...
          (n.to = function (e) {
            var n = this;
            this._activeElement = t(this._element).find(E.ACTIVE_ITEM)[0];
          ...
          (n._getConfig = function (e) {
            return (e = t.extend({}, x, e)), eg.typeCheckConfig(g, e, w), e;
          }),
            ...
            this._config.keyboard &&
              ...
              "hover" === this._config.pause &&
                ...
                "ontouchstart" in document.documentElement &&
                  t(this._element).on(C.TOUCHEND, function () {
                    e.pause(),
          ...
          (n._getItemIndex = function (e) {
            return (
              (this._items = t.makeArray(t(e).parent().find(E.ITEM))),
          ...
          (n._getItemByDirection = function (e, t) {
            ...
            if (((i && 0 === r) || (n && r === s)) && !this._config.wrap)
              return t;
            var a = (r + (e === _.PREV ? -1 : 1)) % this._items.length;
            return -1 === a
          ...
          (n._triggerSlideEvent = function (e, n) {
            var i = this._getItemIndex(e),
              r = this._getItemIndex(t(this._element).find(E.ACTIVE_ITEM)[0]),
              s = t.Event(C.SLIDE, {
                relatedTarget: e,
                direction: n,
                from: r,
          ...
          (n._setActiveIndicatorElement = function (e) {
            if (this._indicatorsElement) {
              t(this._indicatorsElement).find(E.ACTIVE).removeClass(T.ACTIVE);
          ...
          (n._slide = function (e, n) {
            var i,
              ...
              s,
              a = this,
              o = t(this._element).find(E.ACTIVE_ITEM)[0],
              l = this._getItemIndex(o),
              c = n || (o && this._getItemByDirection(e, o)),
              u = this._getItemIndex(c),
              d = Boolean(this._interval);
            if (
              (e === _.NEXT
                ? ((i = T.LEFT), (r = T.NEXT), (s = _.LEFT))
                : ((i = T.RIGHT), (r = T.PREV), (s = _.RIGHT)),
              c && t(c).hasClass(T.ACTIVE))
            )
              this._isSliding = !1;
            else if (
              ...
              var p = t.Event(C.SLID, {
                relatedTarget: c,
                direction: s,
                from: l,
                to: u,
              });
              eg.supportsTransitionEnd() && t(this._element).hasClass(T.SLIDE)
                ? (t(c).addClass(r),
                  eg.reflow(c),
                  t(o).addClass(i),
                  t(c).addClass(i),
                  t(o)
                    .one(eg.TRANSITION_END, function () {
                      t(c)
                        .removeClass(i + " " + r)
                        .addClass(T.ACTIVE),
                        t(o).removeClass(T.ACTIVE + " " + r + " " + i),
                        (a._isSliding = !1),
                        setTimeout(function () {
                ...
                : (t(o).removeClass(T.ACTIVE),
                  t(c).addClass(T.ACTIVE),
                  (this._isSliding = !1),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this).data(v),
                r = t.extend({}, x, t(this).data());
              "object" == typeof n && t.extend(r, n);
              var s = "string" == typeof n ? n : r.slide;
              if (
                (i || ((i = new e(this, r)), t(this).data(v, i)),
                "number" == typeof n)
              )
                i.to(n);
          ...
          (e._dataApiClickHandler = function (n) {
            var i = eg.getSelectorFromElement(this);
            if (i) {
              var r = t(i)[0];
              if (r && t(r).hasClass(T.CAROUSEL)) {
      ...
      t(document).on(C.CLICK_DATA_API, E.DATA_SLIDE, S._dataApiClickHandler),
      ...
      (t.fn[g] = S._jQueryInterface),
      (t.fn[g].Constructor = S),
      (t.fn[g].noConflict = function () {
        return (t.fn[g] = b), S._jQueryInterface;
      }),
      S),
    ew =
      ((I = "collapse"),
        ...
        return (
          ...
          (n.show = function () {
            ...
            if (
              ...
              !t(this._element).hasClass(P.SHOW) &&
              (this._parent &&
                ((n = t.makeArray(
              ...
              if ((t(this._element).trigger(s), !s.isDefaultPrevented())) {
                n &&
                  (e._jQueryInterface.call(t(n), "hide"),
                  i || t(n).data(A, null));
                ...
                var o = function () {
                  t(r._element)
                    ...
                    t(r._element).trigger(L.SHOWN);
                };
                if (eg.supportsTransitionEnd()) {
                  var l = "scroll" + (a[0].toUpperCase() + a.slice(1));
                  t(this._element)
                    .one(eg.TRANSITION_END, o)
                    .emulateTransitionEnd(600),
              ...
              if ((t(this._element).trigger(n), !n.isDefaultPrevented())) {
                ...
                if (
                  ...
                  for (var r = 0; r < this._triggerArray.length; r++) {
                    ...
                    null !== a &&
                      (t(a).hasClass(P.SHOW) ||
                        t(s).addClass(P.COLLAPSED).attr("aria-expanded", !1));
                  }
                this.setTransitioning(!0);
                var o = function () {
          ...
          (n._getConfig = function (e) {
            return (
              ((e = t.extend({}, k, e)).toggle = Boolean(e.toggle)),
              eg.typeCheckConfig(I, e, O),
              e
            );
          }),
          (n._getDimension = function () {
            return t(this._element).hasClass(z.WIDTH) ? z.WIDTH : z.HEIGHT;
          }),
          (n._getParent = function () {
            var n = this,
              i = null;
            eg.isElement(this._config.parent)
          ...
          (n._addAriaAndCollapsedClass = function (e, n) {
            if (e) {
              ...
              n.length &&
                t(n).toggleClass(P.COLLAPSED, !i).attr("aria-expanded", i);
            }
          }),
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this),
                r = i.data(A),
                s = t.extend({}, k, i.data(), "object" == typeof n && n);
              if (
                (!r && s.toggle && /show|hide/.test(n) && (s.toggle = !1),
                r || ((r = new e(this, s)), i.data(A, r)),
                "string" == typeof n)
              ) {
                if (void 0 === r[n]) throw Error('No method named "' + n + '"');
                r[n]();
              }
            });
          }),
      ...
      t(document).on(L.CLICK_DATA_API, M.DATA_TOGGLE, function (e) {
        ...
        var n = t(this);
        t(eg.getSelectorFromElement(this)).each(function () {
          var e = t(this),
            i = e.data(A) ? "toggle" : n.data();
          N._jQueryInterface.call(e, i);
        });
      }),
      (t.fn[I] = N._jQueryInterface),
      (t.fn[I].Constructor = N),
      (t.fn[I].noConflict = function () {
        return (t.fn[I] = D), N._jQueryInterface;
      }),
      N),
    e_ = (function () {
      if (void 0 === n)
      ...
      var e = "dropdown",
        ...
        d = { offset: 0, flip: !0 },
        p = { offset: "(number|string|function)", flip: "boolean" },
        h = (function () {
          function s(e, t) {
            (this._element = e),
              (this._popper = null),
          ...
          return (
            (h.toggle = function () {
              if (
                ...
                var e = s._getParentFromElement(this._element),
                  i = t(this._menu).hasClass(l.SHOW);
                if ((s._clearMenus(), !i)) {
                  var r = { relatedTarget: this._element },
                    a = t.Event(o.SHOW, r);
                  if ((t(e).trigger(a), !a.isDefaultPrevented())) {
                    var u = this._element;
                    t(e).hasClass(l.DROPUP) &&
                      (t(this._menu).hasClass(l.MENULEFT) ||
                      ...
                      "ontouchstart" in document.documentElement &&
                        !t(e).closest(c.NAVBAR_NAV).length &&
                        t("body").children().on("mouseover", null, t.noop),
                      this._element.focus(),
                      this._element.setAttribute("aria-expanded", !0),
                      t(this._menu).toggleClass(l.SHOW),
                      t(e).toggleClass(l.SHOW).trigger(t.Event(o.SHOWN, r));
                  }
                }
              }
            }),
            ...
            (h._getConfig = function (n) {
              return (
                ...
                eg.typeCheckConfig(e, n, this.constructor.DefaultType),
                n
              );
            }),
            ...
            (h._getPlacement = function () {
              ...
              return (
                e.hasClass(l.DROPUP)
                  ? ((n = u.TOP),
                    t(this._menu).hasClass(l.MENURIGHT) && (n = u.TOPEND))
                  : t(this._menu).hasClass(l.MENURIGHT) && (n = u.BOTTOMEND),
                n
              );
            }),
            ...
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  (n ||
                    ((n = new s(this, "object" == typeof e ? e : null)),
                    t(this).data(i, n)),
                  "string" == typeof e)
                ) {
                  if (void 0 === n[e])
            ...
            (s._clearMenus = function (e) {
              if (
                ...
                for (
                  var n = t.makeArray(t(c.DATA_TOGGLE)), r = 0;
                  r < n.length;
                  r++
                ) {
                  var a = s._getParentFromElement(n[r]),
                    u = t(n[r]).data(i),
                    d = { relatedTarget: n[r] };
                  if (u) {
                    var p = u._menu;
                    if (
                      ...
                      var h = t.Event(o.HIDE, d);
                      t(a).trigger(h),
                        h.isDefaultPrevented() ||
                          ("ontouchstart" in document.documentElement &&
                            t("body").children().off("mouseover", null, t.noop),
                          n[r].setAttribute("aria-expanded", "false"),
                          t(p).removeClass(l.SHOW),
                          t(a)
                            .removeClass(l.SHOW)
                            .trigger(t.Event(o.HIDDEN, d)));
                    }
                  }
                }
            }),
            ...
            (s._dataApiKeydownHandler = function (e) {
              if (
                ...
                if (
                  ...
                  if (27 === e.which) {
                    var u = t(n).find(c.DATA_TOGGLE)[0];
                    t(u).trigger("focus");
                  }
      ...
      return (
        t(document)
          .on(o.KEYDOWN_DATA_API, c.DATA_TOGGLE, h._dataApiKeydownHandler)
          .on(o.KEYDOWN_DATA_API, c.MENU, h._dataApiKeydownHandler)
          .on(o.CLICK_DATA_API + " " + o.KEYUP_DATA_API, h._clearMenus)
          .on(o.CLICK_DATA_API, c.DATA_TOGGLE, function (e) {
            e.preventDefault(),
              e.stopPropagation(),
              h._jQueryInterface.call(t(this), "toggle");
          })
          .on(o.CLICK_DATA_API, c.FORM_CHILD, function (e) {
            e.stopPropagation();
          }),
    ...
    eC =
      ...
      (V = (function () {
        function e(e, n) {
          (this._config = this._getConfig(n)),
            (this._element = e),
            (this._dialog = t(e).find(q.DIALOG)[0]),
            (this._backdrop = null),
            (this._isShown = !1),
        ...
        return (
          ...
          (n.show = function (e) {
            ...
            if (!this._isTransitioning && !this._isShown) {
              eg.supportsTransitionEnd() &&
                t(this._element).hasClass(B.FADE) &&
              ...
              t(this._element).trigger(i),
                this._isShown ||
                  ...
                  this._setScrollbar(),
                  this._adjustDialog(),
                  t(document.body).addClass(B.OPEN),
            ...
            if (
              ...
              if (
                ...
                r && (this._isTransitioning = !0),
                  ...
                  t(this._element).removeClass(B.SHOW),
                  t(this._element).off(F.CLICK_DISMISS),
                  t(this._dialog).off(F.MOUSEDOWN_DISMISS),
                  r
                    ? t(this._element)
                        .one(eg.TRANSITION_END, function (e) {
          ...
          (n._getConfig = function (e) {
            return (e = t.extend({}, R, e)), eg.typeCheckConfig(H, e, W), e;
          }),
          (n._showElement = function (e) {
            var n = this,
              i =
                eg.supportsTransitionEnd() && t(this._element).hasClass(B.FADE);
            (this._element.parentNode &&
              ...
              i && eg.reflow(this._element),
              t(this._element).addClass(B.SHOW),
          ...
          (n._setResizeEvent = function () {
            var e = this;
            this._isShown
              ? t(window).on(F.RESIZE, function (t) {
          ...
          (n._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                t(document.body).removeClass(B.OPEN),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
          ...
          (n._showBackdrop = function (e) {
            var n = this,
              i = t(this._element).hasClass(B.FADE) ? B.FADE : "";
            if (this._isShown && this._config.backdrop) {
              var r = eg.supportsTransitionEnd() && i;
              if (
                ((this._backdrop = document.createElement("div")),
                (this._backdrop.className = B.BACKDROP),
                i && t(this._backdrop).addClass(i),
                t(this._backdrop).appendTo(document.body),
                t(this._element).on(F.CLICK_DISMISS, function (e) {
                ...
                r && eg.reflow(this._backdrop),
                t(this._backdrop).addClass(B.SHOW),
                !e)
              )
                return;
              if (!r) return void e();
              t(this._backdrop)
                .one(eg.TRANSITION_END, e)
                .emulateTransitionEnd(150);
            } else if (!this._isShown && this._backdrop) {
              t(this._backdrop).removeClass(B.SHOW);
              var s = function () {
          ...
          (n._setScrollbar = function () {
            ...
            if (this._isBodyOverflowing) {
              t(q.FIXED_CONTENT).each(function (n, i) {
                ...
                t(q.STICKY_CONTENT).each(function (n, i) {
                ...
                t(q.NAVBAR_TOGGLER).each(function (n, i) {
                  var r = t(i)[0].style.marginRight,
                    s = t(i).css("margin-right");
                  t(i)
                    .data("margin-right", r)
          ...
          (n._resetScrollbar = function () {
            t(q.FIXED_CONTENT).each(function (e, n) {
              var i = t(n).data("padding-right");
              void 0 !== i &&
                t(n).css("padding-right", i).removeData("padding-right");
            }),
              t(q.STICKY_CONTENT + ", " + q.NAVBAR_TOGGLER).each(function (
                e,
                n
              ) {
          ...
          (n._getScrollbarWidth = function () {
            ...
            (e.className = B.SCROLLBAR_MEASURER), document.body.appendChild(e);
      ...
      t(document).on(F.CLICK_DATA_API, q.DATA_TOGGLE, function (e) {
        var n,
          i = this,
          r = eg.getSelectorFromElement(this);
        r && (n = t(r)[0]);
        var s = t(n).data("bs.modal")
          ? "toggle"
          : t.extend({}, t(n).data(), t(this).data());
        ("A" !== this.tagName && "AREA" !== this.tagName) || e.preventDefault();
        var a = t(n).one(F.SHOW, function (e) {
      ...
      (t.fn[H] = V._jQueryInterface),
      (t.fn[H].Constructor = V),
      (t.fn[H].noConflict = function () {
        return (t.fn[H] = j), V._jQueryInterface;
      }),
      V),
    eT = (function () {
      if (void 0 === n)
      ...
      var e = "tooltip",
        ...
        f = (function () {
          ...
          return (
            ...
            (f.show = function () {
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                var a = this.getTipElement(),
                  o = eg.getUID(this.constructor.NAME);
                a.setAttribute("id", o),
                  this.element.setAttribute("aria-describedby", o),
                  this.setContent(),
                  this.config.animation && t(a).addClass(d.FADE);
                var l =
                ...
                var f = function () {
                  ...
                  (e._hoverState = null),
                    ...
                    n === c.OUT && e._leave(null, e);
                };
                eg.supportsTransitionEnd() && t(this.tip).hasClass(d.FADE)
                  ? t(this.tip)
                      .one(eg.TRANSITION_END, f)
            ...
            (f.hide = function (e) {
              ...
              t(this.element).trigger(r),
                r.isDefaultPrevented() ||
                  ...
                  eg.supportsTransitionEnd() && t(this.tip).hasClass(d.FADE)
                    ? t(i).one(eg.TRANSITION_END, s).emulateTransitionEnd(150)
                    : s(),
                  (this._hoverState = ""));
            }),
            (f.update = function () {
            ...
            (f.setElementContent = function (e, n) {
            ...
            (f._getAttachment = function (e) {
              return o[e.toUpperCase()];
            }),
            (f._setListeners = function () {
              var e = this;
            ...
            (f._enter = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                e &&
                  (n._activeTrigger["focusin" === e.type ? h.FOCUS : h.HOVER] =
                    !0),
                t(n.getTipElement()).hasClass(d.SHOW) ||
                n._hoverState === c.SHOW
                  ? (n._hoverState = c.SHOW)
            ...
            (f._leave = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)) ||
                ...
                t(e.currentTarget).data(i, n)),
                e &&
                  (n._activeTrigger["focusout" === e.type ? h.FOCUS : h.HOVER] =
                    !1),
            ...
            (f._handlePopperPlacementChange = function (e) {
              this._cleanTipClass(),
                this.addAttachmentClass(this._getAttachment(e.placement));
            }),
            (f._fixTransition = function () {
    ...
    e8 =
      ...
      (U = ".bs.popover"),
      (Y = t.fn[G]),
      (X = RegExp("(^|\\s)bs-popover\\S+", "g")),
      (Q = t.extend({}, eT.Default, {
        placement: "right",
        trigger: "click",
        content: "",
        template:
      ...
      (K = t.extend({}, eT.DefaultType, {
        content: "(string|element|function)",
      })),
      (Z = { FADE: "fade", SHOW: "show" }),
      (J = { TITLE: ".popover-header", CONTENT: ".popover-body" }),
      (ee = {
        HIDE: "hide" + U,
        HIDDEN: "hidden" + U,
        SHOW: "show" + U,
        ...
        return (
          ...
          (i.setContent = function () {
            ...
            this.setElementContent(e.find(J.TITLE), this.getTitle()),
              this.setElementContent(e.find(J.CONTENT), this._getContent()),
              e.removeClass(Z.FADE + " " + Z.SHOW);
          }),
          ...
          (n._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (i ||
                  ((i = new n(this, "object" == typeof e ? e : null)),
      ...
      (t.fn[G] = et._jQueryInterface),
      (t.fn[G].Constructor = et),
      (t.fn[G].noConflict = function () {
        return (t.fn[G] = Y), et._jQueryInterface;
      }),
      et),
    eE =
      ((en = "scrollspy"),
      ...
      (ec = { OFFSET: "offset", POSITION: "position" }),
      (eu = (function () {
        function e(e, n) {
          var i = this;
          (this._element = e),
            ...
            t(this._scrollElement).on(ea.SCROLL, function (e) {
              return i._process(e);
            }),
            this.refresh(),
            this._process();
        ...
        return (
          (n.refresh = function () {
            var e = this,
              ...
              r = i === ec.POSITION ? this._getScrollTop() : 0;
            (this._offsets = []),
              (this._targets = []),
          ...
          (n._getConfig = function (e) {
            if ("string" != typeof (e = t.extend({}, er, e)).target) {
              var n = t(e.target).attr("id");
              n || ((n = eg.getUID(en)), t(e.target).attr("id", n)),
                (e.target = "#" + n);
            }
            return eg.typeCheckConfig(en, e, es), e;
          }),
          ...
          (n._activate = function (e) {
            ...
            i.hasClass(eo.DROPDOWN_ITEM)
              ? (i
                  .closest(el.DROPDOWN)
                  .find(el.DROPDOWN_TOGGLE)
                  .addClass(eo.ACTIVE),
                i.addClass(eo.ACTIVE))
              : (i.addClass(eo.ACTIVE),
                i
                  .parents(el.NAV_LIST_GROUP)
                  .prev(el.NAV_LINKS + ", " + el.LIST_ITEMS)
                  .addClass(eo.ACTIVE),
                i
                  .parents(el.NAV_LIST_GROUP)
                  .prev(el.NAV_ITEMS)
                  .children(el.NAV_LINKS)
                  .addClass(eo.ACTIVE)),
              t(this._scrollElement).trigger(ea.ACTIVATE, { relatedTarget: e });
          }),
          (n._clear = function () {
            t(this._selector).filter(el.ACTIVE).removeClass(eo.ACTIVE);
          }),
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                if (void 0 === i[n]) throw Error('No method named "' + n + '"');
                i[n]();
              }
            });
          }),
      ...
      t(window).on(ea.LOAD_DATA_API, function () {
        for (var e = t.makeArray(t(el.DATA_SPY)), n = e.length; n--; ) {
          var i = t(e[n]);
          eu._jQueryInterface.call(i, i.data());
        }
      }),
      (t.fn[en] = eu._jQueryInterface),
      (t.fn[en].Constructor = eu),
      (t.fn[en].noConflict = function () {
        return (t.fn[en] = ei), eu._jQueryInterface;
      }),
      eu),
    eS =
      ((ed = t.fn.tab),
        ...
        return (
          (n.show = function () {
            ...
            if (
              !(
                (this._element.parentNode &&
                  this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                  t(this._element).hasClass(eh.ACTIVE)) ||
                t(this._element).hasClass(eh.DISABLED)
              )
            ) {
              var n,
                i,
                r = t(this._element).closest(ef.NAV_LIST_GROUP)[0],
                s = eg.getSelectorFromElement(this._element);
              if (r) {
                var a = "UL" === r.nodeName ? ef.ACTIVE_UL : ef.ACTIVE;
                i = (i = t.makeArray(t(r).find(a)))[i.length - 1];
              }
              var o = t.Event(ep.HIDE, { relatedTarget: this._element }),
                l = t.Event(ep.SHOW, { relatedTarget: i });
              if (
                (i && t(i).trigger(o),
                ...
                var c = function () {
                  var n = t.Event(ep.HIDDEN, { relatedTarget: e._element }),
                    r = t.Event(ep.SHOWN, { relatedTarget: i });
          ...
          (n._activate = function (e, n, i) {
            var r,
              ...
              a = (r =
                "UL" === n.nodeName
                  ? t(n).find(ef.ACTIVE_UL)
                  : t(n).children(ef.ACTIVE))[0],
              o =
                i && eg.supportsTransitionEnd() && a && t(a).hasClass(eh.FADE),
              l = function () {
                return s._transitionComplete(e, a, o, i);
              };
            a && o
              ? t(a).one(eg.TRANSITION_END, l).emulateTransitionEnd(150)
              : l(),
              a && t(a).removeClass(eh.SHOW);
          }),
          (n._transitionComplete = function (e, n, i, r) {
            if (n) {
              t(n).removeClass(eh.ACTIVE);
              var s = t(n.parentNode).find(ef.DROPDOWN_ACTIVE_CHILD)[0];
              s && t(s).removeClass(eh.ACTIVE),
                "tab" === n.getAttribute("role") &&
                  n.setAttribute("aria-selected", !1);
            }
            if (
              (t(e).addClass(eh.ACTIVE),
              "tab" === e.getAttribute("role") &&
                e.setAttribute("aria-selected", !0),
              i
                ? (eg.reflow(e), t(e).addClass(eh.SHOW))
                : t(e).removeClass(eh.FADE),
              e.parentNode && t(e.parentNode).hasClass(eh.DROPDOWN_MENU))
            ) {
              var a = t(e).closest(ef.DROPDOWN)[0];
              a && t(a).find(ef.DROPDOWN_TOGGLE).addClass(eh.ACTIVE),
      ...
      t(document).on(ep.CLICK_DATA_API, ef.DATA_TOGGLE, function (e) {
        e.preventDefault(), em._jQueryInterface.call(t(this), "show");
      }),
      (t.fn.tab = em._jQueryInterface),
      (t.fn.tab.Constructor = em),
      (t.fn.tab.noConflict = function () {
        return (t.fn.tab = ed), em._jQueryInterface;
      }),
      em);
  return (
    (function () {
 ...
 */ function pageTransition(e) {
  ((e = e || {}).target = e.target || null),
    ...
    (e.classIn = e.classIn || null),
    (e.classOut = e.classOut || null),
    (e.classActive = e.classActive || null),
    (e.onReady = e.onReady || null),
    (e.onTransitionStart = e.onTransitionStart || null),
    (e.onTransitionEnd = e.onTransitionEnd || null),
    (e.conditions =
      e.conditions ||
      function (e, t) {
    ...
    e.target &&
      (setTimeout(function () {
        e.onReady && e.onReady(e),
          e.classIn && e.target.classList.add(e.classIn),
          e.classActive && e.target.classList.add(e.classActive),
          e.duration && (e.target.style.animationDuration = e.duration + "ms"),
          e.target.addEventListener("animationstart", function () {
            setTimeout(function () {
              e.classIn && e.target.classList.remove(e.classIn),
                e.onTransitionEnd && e.onTransitionEnd(e);
            }, e.duration);
          });
      }, e.delay),
      $("a").click(function (t) {
        ...
        if (e.conditions(t, n)) {
          var i = this.href;
          t.preventDefault(),
            e.onTransitionStart && e.onTransitionStart(e),
            e.classIn && e.target.classList.remove(e.classIn),
            e.classOut && e.target.classList.add(e.classOut),
            setTimeout(function () {
              (window.location = i),
                /firefox/i.test(navigator.userAgent) &&
                  setTimeout(function () {
                    e.onReady && e.onReady(e),
                      e.classOut && e.target.classList.remove(e.classOut);
                  }, 1e3),
 ...
 */ (function (e, t) {
  "function" == typeof define && define.amd
    ...
    : (void 0 === e.regulaModules && (e.regulaModules = {}),
  ...
  return {
    iterateOverMap: function (e, t) {
      var n = 0;
      for (var i in e)
        e.hasOwnProperty(i) && "__size__" !== i && (t.call(e, i, e[i], n), n++);
    },
    exists: function (e, t) {
  ...
  (function (e, t) {
    ...
    return {
      ...
      getElementsByAttribute: function e(t, n, i, r) {
        for (
          var s,
            a,
            o = "*" == n && t.all ? t.all : t.getElementsByTagName(n),
            l = [],
            c = void 0 !== r ? RegExp("(^|\\s)" + r + "(\\s|$)") : null,
            u = 0;
          u < o.length;
          u++
        )
          "string" ==
            typeof (a = (s = o[u]).getAttribute && s.getAttribute(i)) &&
            a.length > 0 &&
            (void 0 === r || (c && c.test(a))) &&
            l.push(s);
        return l;
      },
      getAttributeValueForElement: function e(t, n) {
        var i = (t.getAttribute && t.getAttribute(n)) || null;
        if (!i)
          for (var r = t.attributes, s = 0; s < r.length; s++)
            r[s].nodeName === n && (i = r[s].nodeValue);
        return i;
      },
      generateRandomId: function e() {
        return "regula-generated-" + Math.floor(1e6 * Math.random());
      },
      supportsHTML5Validation: function e() {
        return (
          "function" == typeof document.createElement("input").checkValidity
        );
      },
    };
  }),
  ...
  (function (e, t) {
    ...
    return {
      explode: function e(t, n) {
        for (var i = "", r = 0; r < t.length; r++) i += t[r] + n;
        return i.replace(RegExp(n + "$"), "");
      },
    };
  }),
  (function (e, t) {
    ...
    for (var n in t)
      if (t.hasOwnProperty(n)) {
        var i = t[n];
        (i.prototype = Error()), (i.prototype.constructor = i);
      }
    return {
      Exception: t,
      generateExceptionMessage: function e(t, n, i) {
        var r = "";
        return (
          null != t
            ? ((r = t.id),
              "" == n || null == n || void 0 == n
                ? (r += ": ")
                : (r += "." + n + ": "))
            : "" != n && null != n && void 0 != n && (r = "@" + n + ": "),
          r + i
        );
      },
      explodeParameters: function t(n) {
        var i = "Function received: {";
        for (var r in n)
          n.hasOwnProperty(r) &&
            ("string" == typeof n[r]
              ? (i += r + ": " + n[r] + ", ")
  ...
  (function (e, t) {
    ...
    function s(e, t) {
      var n = t[e],
        r = e.replace(/(^[A-Z]+)/, function (e) {
          return e.toLowerCase();
        });
      n.async
        ? (M[r] = function (t, r, s) {
            if (void 0 === s)
              throw new i.Exception.IllegalArgumentException(
                e +
                  " is an asynchronous constraint, but you have not provided a callback."
              );
            return n.validator.call(t, r, M, s);
          })
        : (M[r] = function (e, t) {
            return n.validator.call(e, t, M);
          });
    }
    function a(e, t) {
      var n = D.validateEmptyFields;
      return (
        void 0 !== t.ignoreEmpty && (n = !t.ignoreEmpty),
        !N.blank.call(e) || !!n
      );
    }
    function o(e) {
      ...
      var i = this.value.split(n),
        r = new Date(i[t.Year], i[t.Month] - 1, i[t.Day]),
        s = new Date();
      return (
        void 0 !== e.date &&
          ((i = e.date.split(n)),
          (s = new Date(i[t.Year], i[t.Month] - 1, i[t.Day]))),
        { dateToValidate: r, dateToTestAgainst: s }
      );
    }
    function l() {
    ...
    function u(e) {
      ...
      for (var n in L)
        if (L.hasOwnProperty(n)) {
          var i = L[n];
          for (var r in i)
            if (i.hasOwnProperty(r) && i[r][e.constraintType]) {
              var s = C(n, r, e.constraintType);
              s.async ? t.asyncContexts.push(s) : t.syncContexts.push(s);
            }
        }
      return w((t = b(t)), e);
    }
    function d(e) {
      ...
      for (var s in L)
        if (L.hasOwnProperty(s))
          for (var a = L[s], o = 0; o < e.elementIds.length; o++) {
            var l = e.elementIds[o];
            void 0 === t[l] && (t[l] = 0);
            var c = a[l];
            if (void 0 !== c) {
              for (var u in (t[l]++, c))
                if (c.hasOwnProperty(u)) {
                  var d = C(s, l, u);
                  d.async ? n.asyncContexts.push(d) : n.syncContexts.push(d);
                }
            }
          }
      var p = [];
      for (var l in t) t.hasOwnProperty(l) && 0 === t[l] && p.push(l);
      if (p.length > 0)
        throw new i.Exception.IllegalArgumentException(
          "No constraints have been bound to the specified elements: " +
            r.explode(p) +
            ". " +
            i.explodeParameters(e)
        );
      return w((n = b(n)), e);
    }
    function p(e) {
    ...
    function h(e) {
      for (
        ...
        if (void 0 === a)
          throw new i.Exception.IllegalArgumentException(
            "Undefined group in group list. " + i.explodeParameters(e)
          );
        for (var o in a)
            ...
            for (var c in l)
              if (l.hasOwnProperty(c)) {
                ...
                n.groupedContexts[s] ||
                  ...
                  u.async
                    ? ((t = !0), n.groupedContexts[s].asyncContexts.push(u))
                    : n.groupedContexts[s].syncContexts.push(u);
              }
          }
        r++;
      }
      var d = x(n);
      return (
        (e.groups = d.groups), _(e, (n = d.uniqueConstraintsToValidate), t)
      );
    }
    function f(e) {
      for (
        ...
        var o = !1;
        for (var l in a)
          if (a.hasOwnProperty(l) && a[l][e.constraintType]) {
            o = !0;
            var c = C(s, l, e.constraintType);
            n.groupedContexts[s] ||
              (n.groupedContexts[s] = { asyncContexts: [], syncContexts: [] }),
              c.async
      ...
      var u = x(n);
      return (
        (e.groups = u.groups), _(e, (n = u.uniqueConstraintsToValidate), t)
      );
    }
    function g(e) {
      for (
        var t = [], n = [], s = !1, a = { groupedContexts: {} }, o = 0;
        o < e.groups.length;
            ...
            for (var h in p)
              if (p.hasOwnProperty(h)) {
                ...
                a.groupedContexts[l] ||
                  ...
                  f.async
                    ? ((s = !0), a.groupedContexts[l].asyncContexts.push(f))
                    : a.groupedContexts[l].syncContexts.push(f);
              }
          } else t.push(l), n.push(d);
        }
        o++;
      }
      if (t.length > 0)
        throw new i.Exception.IllegalArgumentException(
          "The following elements: " +
            ...
            r.explode(t, ",").replace(/,/g, ", ") +
            "]. " +
            i.explodeParameters(e)
        );
      var g = x(a);
      return (
        (e.groups = g.groups), _(e, (a = g.uniqueConstraintsToValidate), s)
      );
    }
    function v(e) {
      for (
        ...
        for (var r = e.groups[i], s = 0; s < e.elementIds.length; s++) {
          var a = C(r, e.elementIds[s], e.constraintType);
          n.groupedContexts[r] ||
            (n.groupedContexts[r] = { asyncContexts: [], syncContexts: [] }),
            a.async
              ? ((t = !0), n.groupedContexts[r].asyncContexts.push(a))
              : n.groupedContexts[r].syncContexts.push(a);
        }
        i++;
      }
      var o = x(n);
      return (
        (e.groups = o.groups), _(e, (n = o.uniqueConstraintsToValidate), t)
      );
    }
    function y(e) {
      var t = !0;
      P[e.elementId] || (P[e.elementId] = {});
      var n = document.getElementById(e.elementId).cloneNode(!1),
        i = n.name.replace(/\s/g, "");
      return (
        (void 0 !== n.type &&
          "radio" === n.type.toLowerCase() &&
          "" !== i &&
          z[i]) ||
          (z[i] = {}),
        P[e.elementId][e.elementConstraint] ||
          ...
          ((t = !1),
          (P[e.elementId][e.elementConstraint] = !0),
          void 0 === n.type ||
            "radio" !== n.type.toLowerCase() ||
            "" === i ||
            (z[i][e.elementConstraint] = !0)),
        t
      );
    }
    function b(e) {
      for (
        var t = { asyncContexts: [], syncContexts: [] }, n = 0;
        n < e.syncContexts.length;
        n++
      ) {
        var i = e.syncContexts[n];
        y(i) || t.syncContexts.push(i);
      }
      for (var n = 0; n < e.asyncContexts.length; n++) {
        var i = e.asyncContexts[n];
        y(i) || t.asyncContexts.push(i);
      }
      return t;
    }
    function x(e) {
      ...
      for (var i in e.groupedContexts)
        if (e.groupedContexts.hasOwnProperty(i)) {
          for (var r = 0; r < e.groupedContexts[i].syncContexts.length; r++) {
            var s = e.groupedContexts[i].syncContexts[r];
            y(s) ||
              (n.groupedContexts[i] ||
                (n.groupedContexts[i] = {
                  asyncContexts: [],
              ...
              n.groupedContexts[i].syncContexts.push(s),
              -1 == t.indexOf(i) && t.push(i));
          }
          for (var r = 0; r < e.groupedContexts[i].asyncContexts.length; r++) {
            var s = e.groupedContexts[i].asyncContexts[r];
            y(s) ||
              (n.groupedContexts[i] ||
                (n.groupedContexts[i] = {
                  asyncContexts: [],
              ...
              n.groupedContexts[i].asyncContexts.push(s),
              -1 == t.indexOf(i) && t.push(i));
          }
        }
    ...
    function w(e, t) {
      var n = [];
      if (
        (e.syncContexts.length > 0 &&
          (n = (function e(t) {
            for (var n = [], i = 0; i < t.syncContexts.length; ) {
              var r = t.syncContexts[i],
                s = T(r.group, r.elementId, r.elementConstraint, r.params);
              s && n.push(s), i++;
            }
            return n;
          })(e)),
        e.asyncContexts.length > 0)
      ) {
        if (!t.callback)
          throw new i.Exception.IllegalArgumentException(
        ...
        (function e(t, n) {
          function i(e) {
            s++, e && r.push(e), s === t.asyncContexts.length && n(r);
          }
          for (var r = [], s = 0, a = 0; a < t.asyncContexts.length; a++) {
            var o = t.asyncContexts[a];
            E(o.group, o.elementId, o.elementConstraint, o.params, i);
          }
        })(e, function (e) {
          (n = n.length > 0 ? n.concat(e) : e), t.callback(n);
        });
    ...
    function _(e, t, n) {
      var r = (function e(t, n, i) {
        for (var r = [], s = 0, a = !0; s < t.length && a; ) {
          for (
            var o = t[s], l = i.groupedContexts[o].syncContexts, c = 0;
            c < l.length;
            c++
          ) {
            var u = l[c],
              d = T(u.group, u.elementId, u.elementConstraint, u.params);
            d && r.push(d);
          }
          s++, (a = 0 == r.length || (n && 0 != r.length));
        }
        return r;
      })(e.groups, e.independent, t);
      if (n) {
        if (!e.callback)
          throw new i.Exception.IllegalArgumentException(
            "One or more constraints to be validated are asynchronous, but a callback has not been provided."
          );
        if (!e.independent && r.length > 0) {
          var s = r[0].group,
            a = t.groupedContexts[s];
          (t.groupedContexts = {}), (t.groupedContexts[s] = a);
        }
        (function e(t, n, i, r) {
          var s = [],
            a = !0;
          (function e(o) {
            if (o < t.length && a) {
              for (
                var l = t[o],
                  c = i.groupedContexts[l].asyncContexts,
                  u = 0,
                  d = 0;
                d < c.length;
                d++
                ...
                var p = c[d];
                E(p.group, p.elementId, p.elementConstraint, p.params, h);
              }
              function h(t) {
                u++,
                  t && s.push(t),
                  u === c.length &&
                    ((a = 0 === s.length || (n && 0 != s.length)), e(++o));
              }
            } else r(s);
          })(0);
        })(e.groups, e.independent, t, function (t) {
          (r = r.length > 0 ? r.concat(t) : t), e.callback(r);
        });
      } else e.callback && e.callback(r);
      return r;
    }
    function C(e, t, n) {
      var r = L[e];
      ...
      if (
        (s.constraintPassed ||
          ...
          (r = {
            group: e,
            constraintName: n,
            formSpecific: O[n].formSpecific,
            custom: O[n].custom,
            compound: O[n].compound,
            async: O[n].async,
            composingConstraintViolations:
              s.composingConstraintViolations || [],
            constraintParameters: i,
            failingElements: s.failingElements,
            message: a,
          })),
        D.enableHTML5Validation)
      )
        for (var o = 0; o < s.failingElements.length; o++)
          s.failingElements[o].setCustomValidity("");
      return r;
    }
    function E(e, t, n, i, r) {
      var s;
      I(e, t, n, i, function (a) {
        var o = "";
        if (
          (a.constraintPassed ||
            ((o = A(t, n, i)),
    ...
    function S(t, n, i, r) {
      var s = !1,
        ...
        l = [];
      O[i].formSpecific
        ? (s = 0 == (a = O[i].validator.call(o, r, M)).length)
        : O[i].compound
        ? (s = 0 == (l = O[i].validator.call(o, r, t, O[i], null)).length) ||
          a.push(o)
        : (s = O[i].validator.call(o, r, M)) || a.push(o);
      var c = o.cloneNode(!1).name.replace(/\s/g, ""),
        u = o.cloneNode(!1).type;
      void 0 !== u &&
        "radio" === u.toLowerCase() &&
        "" !== c &&
        (a = e.getElementsByAttribute(
          document.body,
          "input",
          "name",
          c.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
        ));
      var d = { constraintName: i, constraintPassed: s, failingElements: a };
      return (
        O[i].reportAsSingleViolation || (d.composingConstraintViolations = l), d
      );
    }
    function I(t, n, i, r, s) {
      function a(t, n, r, s) {
        var a = o.cloneNode(!1).name.replace(/\s/g, ""),
          l = o.cloneNode(!1).type;
        void 0 !== l &&
          "radio" === l.toLowerCase() &&
          "" !== a &&
          (r = e.getElementsByAttribute(document.body, "input", "name", a));
        var c = { constraintName: i, constraintPassed: t, failingElements: r };
        O[i].reportAsSingleViolation || (c.composingConstraintViolations = n),
          s(c);
      }
      var o = document.getElementById(n);
      O[i].formSpecific
        ? O[i].validator.call(o, r, M, function (e) {
            a(0 === e.length, null, e, s);
          })
        : O[i].compound
        ? O[i].validator.call(o, r, t, O[i], function (e) {
            var t = [],
              n = 0 === e.length;
    ...
    function A(t, n, i) {
      ...
      if (O[n].compound && void 0 !== O[n].composingConstraints)
        for (var l = 0; l < O[n].composingConstraints.length; l++) {
          var c = O[n].composingConstraints[l];
          for (var a in c.params)
            if (c.params.hasOwnProperty(a)) {
              var o = RegExp("{" + a + "}", "g");
              s = s.replace(o, c.params[a]);
            }
        }
      if (/{label}/.test(s)) {
        var u = e.friendlyInputNames[r.cloneNode(!1).tagName.toLowerCase()];
        u || (u = e.friendlyInputNames[r.cloneNode(!1).type.toLowerCase()]),
          (s = (s = s.replace(/{label}/, u)).replace(/{flags}/g, ""));
      }
      return s.replace(/\\\"/g, '"');
    }
    var D = {},
      ...
      N = {
        checked: function (t) {
          var n = !1;
          if (
            "radio" === this.type.toLowerCase() &&
            "" !== this.name.replace(/\s/g, "")
          )
            for (
              var i = e.getElementsByAttribute(
                  document.body,
                  "input",
                  "name",
                  this.name.replace(
        ...
        max: function (e) {
          var t = !0;
          return (
            a(this, e) && (t = parseFloat(this.value) <= parseFloat(e.value)), t
          );
        },
        min: function (e) {
          var t = !0;
        ...
        alpha: function (e) {
          var t = !0;
          return a(this, e) && (t = /^[A-Za-z]+$/.test(this.value)), t;
        },
        numeric: function (e) {
          var t = !0;
          return a(this, e) && (t = /^[0-9]+$/.test(this.value)), t;
        },
        integer: function (e) {
          var t = !0;
          return a(this, e) && (t = /^-?[0-9]+$/.test(this.value)), t;
          ...
          return (
            this.tagName &&
              ("select" === this.tagName.toLowerCase()
                ? (t = N.selected.call(this))
                : "checkbox" === this.type.toLowerCase() ||
                  "radio" === this.type.toLowerCase()
                ? (t = N.checked.call(this))
                : ("input" === this.tagName.toLowerCase() ||
                    "textarea" === this.tagName.toLowerCase()) &&
                  "button" != this.type.toLowerCase() &&
                  (t = N.notBlank.call(this))),
            t
          );
        },
        length: function (e) {
        ...
        digits: function (e) {
          ...
          if (a(this, e)) {
            ...
            (t = !1),
              n.length > 0 &&
                (1 == i.length && (i[1] = ""),
                (t = !(e.integer > 0) || i[0].length <= e.integer),
                e.fraction > 0 && (t = t && i[1].length <= e.fraction));
          }
          return t;
        },
        past: function (e) {
    ...
    return {
      ...
      init: function e(t) {
        (D = t.config),
          (k = t.ReverseConstraint),
          (O = t.constraintDefinitions),
          (L = t.boundConstraints);
      },
      wrapValidatorWithEmptyCheck: function e(t) {
        return function (e, n, i) {
          var r = !0;
          return a(this, e) && (r = t.call(this, e, n, i)), r;
        };
      },
      initializePublicValidators: function e(t) {
        for (var n in t) t.hasOwnProperty(n) && s(n, t);
      },
      compoundValidator: function e(n, i, r, s) {
        function o(e, i) {
          var r = {};
          for (var s in e)
            e.hasOwnProperty(s) && "__size__" != s && t.put(r, s, e[s]);
          if (i.length > 0)
            for (var s in n)
              n.hasOwnProperty(s) && "__size__" != s && t.put(r, s, n[s]);
          return r;
        }
        function l(e, t, n, i) {
          var s = k[g.constraintType],
            a = A(t, s, i),
            o = {
              group: n,
              constraintName: e.constraintName,
              custom: O[s].custom,
              compound: O[s].compound,
              async: O[s].async,
              constraintParameters: g.params,
              failingElements: e.failingElements,
              message: a,
            };
          return (
            r.reportAsSingleViolation ||
              (o.composingConstraintViolations =
        ...
        for (
          var c = [], u = [], d = 0;
          d < r.composingConstraints.length;
          d++
        ) {
          var p = r.composingConstraints[d];
          O[k[p.constraintType]].async ? u.push(p) : c.push(p);
        }
        var h = null,
          f = this;
        if (a(this, n)) {
          if (c.length > 0) {
            ...
            for (var d = 0; d < c.length; d++) {
              var g = c[d],
                v = k[g.constraintType],
                y = o(g.params, r.params),
                b = S(i, f.id, v, y);
              if (!b.constraintPassed) {
                var x = l(b, f.id, i, y);
                if (D.enableHTML5Validation)
                  for (var w = 0; w < b.failingElements.length; w++)
                    b.failingElements[w].setCustomValidity(x.message);
                h.push(x);
              }
            }
          }
          if (u.length > 0) {
            ...
            function C(e) {
              if (!e.constraintPassed) {
                var t = l(e, f.id, i, y);
                if (D.enableHTML5Validation)
                  for (var n = 0; n < e.failingElements.length; n++)
                    e.failingElements[n].setCustomValidity(t.message);
                h.push(t);
              }
              ++_ === u.length && s(h);
            }
      ...
      validate: function e(t) {
        if (
          ...
          (z = {}),
          (t && void 0 !== t) || (t = {}),
          void 0 === t.independent && (t.independent = !0),
          void 0 !== t.constraintType &&
            (t.constraintType = k[t.constraintType]),
          void 0 !== t.groups)
        ) {
          var i,
            r,
          ...
          for (var y = 0; y < l.length; y++)
            t.groups.push(n.ReverseGroup[l[y]]);
        }
        if (void 0 !== t.elements) {
          t.elementIds = [];
          for (var y = 0; y < t.elements.length; y++)
            t.elementIds.push(t.elements[y].id);
        } else void 0 !== t.elementId && (t.elementIds = [t.elementId]);
        return { 0: c, 1: u, 10: d, 11: p, 100: h, 101: f, 110: g, 111: v }[
          ((r = (i = t).groups || null),
          (s = i.elementIds || null),
          (a = (void 0 === i.constraintType ? null : i.constraintType) || null),
          (o = ""),
          (o += null == r ? "0" : "1"),
          (o += null == s ? "0" : "1"),
          (o += null == a ? "0" : "1"))
    ...
    return {
      ...
      addNode: function e(t) {
        var r = t.type,
          ...
          o =
            void 0 === n[r]
              ? { visited: !1, name: s, type: r, parents: [], children: [] }
              : n[r];
        null == a
          ? i.children.push(o)
          : (a.children.push(o), o.parents.push(a)),
          (n[r] = o);
      },
      getNodeByType: function e(t) {
        var i = n[t];
      ...
      analyze: function e(t) {
        var n = (function e(t, n) {
          ...
          if (t.visited) i.cycle = !0;
            ...
            t.visited = !0;
            for (var r = 0; r < t.children.length && !i.cycle; )
              (i = e(t.children[r], n + "." + t.children[r].name)), r++;
          }
          return i;
        })(t, t.name);
        return (
          ...
          n = (function e(n, i) {
            var r =
              void 0 === t[n.type]
                ...
                : t[n.type];
            null !== i && r.parents.push(i);
            for (var s = 0; s < n.children.length; s++)
              r.children.push(e(n.children[s], r));
            return (t[n.type] = r), r;
          })(i, null);
        return { typeToNodeMap: t, root: n };
      },
      initializeFromClone: function e(t) {
        (n = t.typeToNodeMap), (i = t.root);
      },
    };
  }),
  (function (e, t) {
    ...
    function s(e, t, i) {
      ...
      for (var a = [], o = 0; o < t.params.length; o++) {
        var l = t.params[o];
        void 0 === i[l] && a.push(l);
      }
      return (
    ...
    function a(e, n) {
      var i = t.getNodeByType(l[e]);
      null == i &&
        (t.addNode({ type: l[e], name: e, parent: null }),
        (i = t.getNodeByType(l[e])));
      for (var r = 0; r < i.children.length; r++) {
        for (var s = i.children[r], a = [], o = 0; o < s.parents.length; o++)
          s.parents[o] !== i && a.push(s.parents[o]);
        s.parents = a;
      }
      i.children = [];
      for (var r = 0; r < n.length; r++) {
        var u = d[c[n[r].constraintType]];
        t.addNode({
          type: u.constraintType,
    ...
    function o(e, t, r) {
      for (var a = 0; a < t.length; a++) {
        ...
        var o = t[a],
          l = c[o.constraintType],
          u = { __size__: 0 };
        for (var p in ((o.params = o.params || {}), o.params))
          o.params.hasOwnProperty(p) && i.put(u, p, o.params[p]);
        var h = 0;
        for (var f in o.params) o.params.hasOwnProperty(f) && h++;
        o.params.__size__ = h;
        for (var g = 0; g < r.length; g++) i.put(u, r[g], null);
        var v = s(null, d[l], u);
        if (v.error)
          throw new n.Exception.ConstraintDefinitionException(
            "In compound constraint " + e + ": " + v.message
          );
      }
    }
    var l = {},
      ...
      u = 0;
    (function (e) {
      for (var t = 0; t < e.length; t++) (l[e[t]] = t), (c[t] = e[t]);
      (u = t),
        (l.Between = l.row),
        (l.Matches = l.Pattern),
        (l.Empty = l.Blank),
        (l.NotEmpty = l.NotBlank),
        (l.IsAlpha = l.Alpha),
        (l.IsNumeric = l.Numeric),
        (l.IsAlphaNumeric = l.AlphaNumeric);
    })([
      "Checked",
      "Selected",
      "Max",
    ...
    var d = {
      ...
      CompletelyFilled: {
        ...
        constraintType: l.CompletelyFilled,
        custom: !1,
        compound: !1,
        params: [],
      ...
      HTML5Required: {
        ...
        constraintType: l.HTML5Required,
        custom: !1,
        compound: !1,
        params: [],
        defaultMessage: "{label} is required.",
      ...
      HTML5MaxLength: {
        ...
        constraintType: l.HTML5MaxLength,
        custom: !1,
        compound: !1,
        params: ["maxlength"],
    ...
    return {
      ...
      constraintDefinitions: d,
      override: function i(r) {
        var s = void 0 === r.async ? d[r.name].async : r.async,
          u = r.validator;
        r.validatorRedefined &&
          !r.formSpecific &&
          (u = e.wrapValidatorWithEmptyCheck(u));
        var p = t.getNodeByType(r.constraintType);
        if (r.compound) {
          o(r.name, r.composingConstraints, r.params);
          var h = t.clone();
          a(r.name, r.composingConstraints);
          var f = t.analyze(p);
          if (f.cycle)
            throw (
              (t.initializeFromClone(h),
          ...
          s = !1;
          for (var g = 0; g < r.composingConstraints.length && !s; )
            (s = d[c[r.composingConstraints[g].constraintType]].async), g++;
        }
        null !== p &&
          (function e(n) {
            for (var i = 0; i < n.parents.length; i++) {
              var r = n.parents[i];
              r.type !== t.ROOT && ((d[c[r.type]].async = s), e(r));
            }
          })(p),
          (d[r.name] = {
            async: s,
            formSpecific: r.formSpecific,
            constraintType: l[r.name],
            custom: !0,
            compound: r.compound,
            params: r.params,
          ...
          d[r.name].custom &&
            r.validatorRedefined &&
            e.createPublicValidator(r.name, d);
      },
      custom: function t(n) {
        (l[n.name] = u), (c[u++] = n.name);
        var i = n.validator;
        n.formSpecific || (i = e.wrapValidatorWithEmptyCheck(n.validator)),
          (d[n.name] = {
            async: n.async,
            formSpecific: n.formSpecific,
            validator: i,
            constraintType: l[n.name],
            custom: !0,
            compound: !1,
            params: n.params,
            defaultMessage: n.defaultMessage,
          }),
          e.createPublicValidator(n.name, d);
      },
      compound: function t(n) {
        o(n.name, n.constraints, n.params);
        for (var i = !1, r = 0; r < n.constraints.length && !i; ) {
          var s = c[n.constraints[r].constraintType];
          (i = i || d[s].async), r++;
        }
        (l[n.name] = u),
          (c[u++] = n.name),
          (d[n.name] = {
            ...
            compound: !0,
            params: n.params,
            reportAsSingleViolation: n.reportAsSingleViolation,
            composingConstraints: n.constraints,
            defaultMessage: n.defaultMessage,
            validator: e.compoundValidator,
          }),
          e.createPublicValidator(n.name, d),
          a(n.name, n.constraints);
      },
      verifyConstraintDefinition: function e(t, i, r) {
        var a = { successful: !0, message: "", data: null },
          o = t.cloneNode(!1);
        if ("form" != o.tagName.toLowerCase() || d[i].formSpecific) {
          if ("form" != o.tagName.toLowerCase() && d[i].formSpecific)
            a = {
              successful: !1,
              message: n.generateExceptionMessage(
          ...
          else if ("select" != o.tagName.toLowerCase() && "Selected" == i)
            a = {
              successful: !1,
              message: n.generateExceptionMessage(
                t,
            ...
            var l = s(t, d[i], r);
            l.error
              ? (a = { successful: !1, message: l.message, data: null })
              : (a.data = r);
          }
        } else
          a = {
    ...
    return {
      parse: function r(s, a) {
                    ...
                    var o = {
                      ...
                      d = (function e(n) {
                        var r = i(n.shift()),
                          a = l(r.charAt(0));
                        if (a.successful) {
                          for (var o = 1; o < r.length && a.successful; )
                            (a = c(r.charAt(o))), o++;
                          a.successful && (a.data = r);
                        } else
                          a = {
                            successful: !1,
                            message:
                        ...
                        if (
                          (d = (function n(r) {
                            var a,
                              ...
                              l,
                              c,
                              d = { successful: !0, message: "", data: {} };
                            if ("(" == (c = r)[0]) {
                              r.shift();
                              var p,
                                h = {};
                              if (")" == (p = r)[0]) r.shift();
                              else if ((d = u(r)).successful) {
                                for (
                                  e.put(h, d.data.name, d.data.value),
                                    0 == i((f = r)[0]).length && r.shift();
                                  r.length > 0 &&
                                  "," == (g = r)[0] &&
                                  d.successful;
                                  ...
                                  r.shift(),
                                    (d = u(r)).successful &&
                                      (e.put(h, d.data.name, d.data.value),
                                      0 == i((v = r)[0]).length && r.shift());
                                if (d.successful) {
                                  var f,
                                    g,
                                    v,
                                    b = r.shift();
                                  0 == i(b).length && (b = r.shift()),
                                    ")" != b
                                      ? (d = {
                                          successful: !1,
                                          message:
                          ...
                          (d = n.verifyConstraintDefinition(s, y, d.data))
                            .successful
                        ) {
                          var p = d.data;
                          d.data = {
        ...
        function l(e) {
          ...
          return (
            (/[A-Za-z_]/.test(e) && void 0 !== e && null != e) ||
              (n = {
                successful: !1,
        ...
        function u(e) {
          ...
          if (n.successful) {
            ...
            "=" == a
              ? (n = (function e(n) {
                  0 == i((r = n)[0]).length && n.shift();
                  var r,
                    a,
                    o = { successful: !0, message: "", data: [] };
                  if (")" == (a = n)[0])
                    o = {
                      successful: !1,
                      message:
                    ...
                    var l,
                      ...
                      w = (o =
                        ...
                        (h =
                          ((c = l),
                          (u = c.shift()),
                          (p = { successful: !0, message: "", data: null }),
                          "-" == u
                            ? (p = d(c)).successful && (p.data = u + p.data)
                            : (c.unshift(u),
                              (p = {
                                successful: !1,
                                message: t.generateExceptionMessage(
                    ...
                    o.successful ||
                      (((o = (function e(n) {
                        var i = n.shift(),
                          r = "",
                          a = { successful: !0, message: "", data: null };
                        if ('"' == i) {
                          for (
                            var o, l = !1;
                            n.length > 0 && a.successful && !l;
                        ...
                        return (
                          (a.successful = a.successful && l), (a.data = r), a
                        );
                      })(n)).message = o.message + " " + w),
                      (w = o.message),
                      o.successful ||
                        (((o = (function e(n) {
                          var i = "",
                          ...
                          return (
                            (a.successful = a.successful && l), (a.data = i), a
                          );
                        })(n)).message = o.message + " " + w),
                        (w = o.message),
                        o.successful ||
                          (((o =
                            ((f = n),
                            (b = f.shift()),
                            (x = { successful: !0, message: "", data: null }),
                            "true" == i(b) || "false" == i(b)
                              ? (x = {
                                  successful: !0,
                                  message: "",
                                ...
                                if (
                                  ...
                                  for (
                                    ...
                                    n.shift(),
                                      (p = v(n)),
                                      u.push(p.data),
                                      0 == i((c = n)[0]).length && n.shift();
                                  (p.data = u),
                                    0 == i((d = n.shift())).length && n.shift(),
                                    "]" != d &&
                                      (p = {
                                        successful: !1,
                                        message:
        ...
        function d(e) {
          ...
          if ("." != (i = e)[0]) {
            if (((r = h(e)), "." == (n = e)[0])) {
              var a = r.data;
              (r = p(e)).successful && (r.data = a + r.data);
            }
          } else r = p(e);
          return (
            r.successful ||
              (r = {
                successful: !1,
                message:
                  t.generateExceptionMessage(s, y, "Not a positive number") +
                  " " +
                  r.message,
                data: null,
              }),
        ...
        function h(e) {
          var n = i(e.shift()),
            r = f(n.charAt(0));
          if (r.successful) {
            for (var a = 1; a < n.length && r.successful; )
              (r = f(n.charAt(a))), a++;
            r.successful && (r.data = n);
          } else
            e.unshift(n),
              (r = {
                successful: !1,
                message:
                  t.generateExceptionMessage(s, y, "Not a valid integer") +
                  " " +
                  r.message,
                data: [],
              });
        ...
        function f(e) {
          ...
          return (
            /[0-9]/.test(e) ||
              (n = {
                successful: !1,
                message: t.generateExceptionMessage(s, y, "Not a valid digit"),
                data: null,
              }),
            n
          );
        ...
        function v(e) {
          var n = { successful: !0, message: "", data: "" },
            r = i(e.shift());
          if (
            (0 == r.length && (r = e.shift()), (n = l(r.charAt(0))).successful)
          ) {
            for (var a = 1; a < r.length && n.successful; )
              (n = c(r.charAt(a))), a++;
            n.successful && (n.data = r);
          } else
            n = {
              successful: !1,
              message:
        ...
        return (function e(t) {
          for (
            var n = { successful: !0, message: "", data: null }, i = [];
            t.length > 0 && n.successful;
          ...
          (function t(n) {
            for (
              var i = n.str,
                r = n.delimiters.split(""),
                s = n.returnDelimiters || !1,
                a = n.returnEmptyTokens || !1,
                o = [],
                l = 0,
                c = 0;
              c < i.length;
              ...
              if (e.exists(r, i.charAt(c))) {
                var u = i.substring(l, c);
                0 == u.length ? a && o.push(u) : o.push(u),
                  s && o.push(i.charAt(c)),
                  (l = c + 1);
              }
            if (l < i.length) {
              var u = i.substring(l, i.length);
              0 == u.length ? a && o.push(u) : o.push(u);
            }
            return o;
          })({
  ...
  (function (e, t) {
    ...
    function l(n, i) {
      if (e.isEmpty(p[i][n]) && (delete p[i][n], e.isEmpty(p[i]))) {
        delete p[i];
        var r = t.Group[i];
        delete t.Group[i],
          delete t.ReverseGroup[r],
          t.deletedGroupIndices.push(r);
      }
    }
    function c(e) {
      var t = { successful: !0, message: "", data: null },
        ...
        i = null;
      return (
        void 0 !== n.tagName && (i = n.tagName.toLowerCase()),
        "form" !== i && "select" !== i && "textarea" !== i && "input" !== i
          ? (t = {
              successful: !1,
              message:
                i +
    ...
    function u(e) {
      ...
      t =
        null === r
          ? n.getElementsByAttribute(document.body, "*", "data-constraints")
          : [r];
      for (
        var s = { successful: !0, message: "", data: null }, a = 0;
        a < t.length && s.successful;

      )
        if ((s = c((r = t[a]))).successful) {
          r.id || (r.id = n.generateRandomId());
          var o = r.getAttribute("data-constraints");
          if (null !== o && (s = i.parse(r, o)).successful && null !== s.data)
            for (var l = s.data, u = 0; s.successful && u < l.length; ) {
              var p = l[u];
              (s = d(p.element, p.constraintName, p.definedParameters)), u++;
            }
          a++;
        }
      return s;
    ...
    function d(n, i, a) {
      var o = { successful: !0, message: "", data: null };
      a.groups || e.put(a, "groups", [t.ReverseGroup[t.Group.Default]]);
      var l = a.groups;
      -1 === l.indexOf(t.ReverseGroup[t.Group.Default]) &&
        (l.push(t.ReverseGroup[t.Group.Default]), (a.groups = l));
        ...
        if (!p[u]) {
          ...
          (d =
            t.deletedGroupIndices.length > 0
              ? t.deletedGroupIndices.pop()
              : t.firstCustomGroupIndex++),
            (t.Group[u] = d),
            (t.ReverseGroup[d] = u),
            (p[u] = {});
        }
        p[u][n.id] || (p[u][n.id] = {}), (p[u][n.id][i] = a);
      }
      if (r.constraintDefinitions[i].html5) {
        if (
          null !== n.getAttribute("type") &&
          null !== r.constraintDefinitions[i].inputType &&
          n.getAttribute("type") !== r.constraintDefinitions[i].inputType
        )
          o = {
            successful: !1,
            message: s.generateExceptionMessage(
              ...
              "Element type of " +
                ...
                i +
                ": " +
                r.constraintDefinitions[i].inputType
            ),
            data: null,
          };
        else {
          var h = r.constraintDefinitions[i].attribute,
            f = r.constraintDefinitions[i].inputType;
          ((null !== h && null === n.getAttribute(h)) ||
            (null !== f && null === n.getAttribute("type"))) &&
            (function e(t, n, i) {
              if (n === r.ReverseConstraint[r.Constraint.HTML5Required])
                t.setAttribute("required", "true");
              else
                for (
                  var s = r.constraintDefinitions[n], a = 0;
                  a < s.params.length;
                  a++
                )
                  t.setAttribute(s.params[a], i[s.params[a]]);
              var o = t.getAttribute("class");
              /regula-modified/.test(o) ||
                t.setAttribute("class", o + " regula-modified");
            })(n, i, a);
        }
      }
      return o;
    ...
    var p = null;
    return {
      initializeBoundConstraints: function e() {
        null === p && a();
      },
      resetBoundConstraints: a,
      getBoundConstraints: o,
      removeElementAndGroupFromBoundConstraintsIfEmpty: l,
      bindAfterParsing: u,
      bindHTML5ValidationConstraints: function t(i) {
        function s(e, t, i) {
          for (var r = 0; r < t.length; r++) {
            var s = t[r];
            s.id || (s.id = n.generateRandomId()), e[s.id] || (e[s.id] = []);
            var a = { constraint: i.constraint, params: {} };
            null === i.value &&
              (a.params[i.attribute] = n.getAttributeValueForElement(
                s,
                i.attribute
              )),
              e[s.id].push(a);
          ...
          l = [
            {
              attribute: "required",
              value: null,
              constraint: r.Constraint.HTML5Required,
            },
            {
              attribute: "type",
              value: "email",
              constraint: r.Constraint.HTML5Email,
            },
            {
              attribute: "type",
              value: "url",
              constraint: r.Constraint.HTML5URL,
            },
            {
              attribute: "pattern",
              value: null,
              constraint: r.Constraint.HTML5Pattern,
            },
            {
              attribute: "maxlength",
              value: null,
              constraint: r.Constraint.HTML5MaxLength,
            },
            {
              attribute: "min",
              value: null,
              constraint: r.Constraint.HTML5Min,
            },
            {
              attribute: "max",
              value: null,
              constraint: r.Constraint.HTML5Max,
            },
            {
              attribute: "step",
              value: null,
              constraint: r.Constraint.HTML5Step,
            },
          ],
          u = { email: r.Constraint.HTML5Email, url: r.Constraint.HTML5URL },
          p = {};
        if (null === a)
          for (var h = 0; h < l.length; h++) {
            ...
            s(
              ...
              (g =
                null == f.value
                  ? n.getElementsByAttribute(document.body, "*", f.attribute)
                  : n.getElementsByAttribute(
                      document.body,
                      "*",
                      f.attribute,
                      f.value
          ...
          (a.id || (a.id = n.generateRandomId()), (o = c(a)).successful)
        ) {
          p[a.id] = [];
          for (var h = 0; h < l.length; h++) {
            var f = l[h];
            if (null === f.value) {
              if (null != n.getAttributeValueForElement(a, f.attribute)) {
                var v = { constraint: f.constraint, params: {} };
                (v.params[f.attribute] = n.getAttributeValueForElement(
                  a,
                  f.attribute
                )),
                  p[a.id].push(v);
              ...
              var y = n.getAttributeValueForElement(a, f.attribute);
              null != y &&
                void 0 !== u[y] &&
                p[a.id].push({ constraint: u[y], params: {} });
            }
          }
        }
        return (
          e.iterateOverMap(p, function (e, t, n) {
            for (var i = document.getElementById(e), s = 0; s < t.length; s++) {
              var a = t[s];
              o = d(i, r.ReverseConstraint[a.constraint], a.params);
            }
          }),
          o
        );
      },
      bindFromOptions: function e(t) {
        var n = { successful: !0, message: "", data: null },
          i = t.element,
          r = t.constraints || [],
          a = i && i.tagName ? i.tagName.toLowerCase() : null;
        if (i) {
          if (1 !== i.nodeType)
            n = {
              successful: !1,
            ...
            for (var o = 0; o < r.length && n.successful; )
              (n = m(r[o], t)), o++;
          else n = u({ element: i });
        } else
          n = {
      ...
      unbind: function e(t) {
        for (var n = !1, i = 0; i < t.elements.length; i++) {
          var a = t.elements[i].id,
            o = t.constraints || [];
          if (0 == o.length)
            for (var c in p)
              p.hasOwnProperty(c) &&
                void 0 !== p[c][a] &&
                (delete p[c][a], "Default" !== c && l(a, c), (n = !0));
          else
            for (var u = 0; u < o.length; u++) {
              ...
              for (var c in p)
                p.hasOwnProperty(c) &&
                  void 0 !== p[c][a] &&
                  (delete p[c][a][r.ReverseConstraint[d]],
                  "Default" !== c && l(a, c),
                  (n = !0));
            }
        }
        if (t.elements.length > 0 && !n)
      ...
      isBound: function e(n) {
        var i = n.elementId,
          s = n.group,
          a = n.constraint,
          o = void 0 !== p[t.ReverseGroup[t.Group.Default]][i];
        if (o && void 0 !== s && void 0 === a) {
          var l = t.ReverseGroup[s];
          o = void 0 !== l && void 0 !== p[l][i];
        } else if (o && void 0 === s && void 0 !== a) {
          var c = r.ReverseConstraint[a];
          o =
            void 0 !== c && void 0 !== p[t.ReverseGroup[t.Group.Default]][i][c];
        } else if (o && void 0 !== s && void 0 !== a) {
          var l = t.ReverseGroup[s],
            c = r.ReverseConstraint[a];
          o =
            void 0 !== l &&
            void 0 !== c &&
            void 0 !== p[l][i] &&
  ...
  (function (e, t) {
    "function" == typeof define && define.amd
      ...
      : ((e.regula = t(
        ...
        (e.regulaModules = void 0));
  })(this, function (e, t, n, i, r, s, a) {
    var o = { validateEmptyFields: !0, enableHTML5Validation: !0, debug: !1 };
    return (
      n.initializeBoundConstraints(),
      s.initializePublicValidators(r.constraintDefinitions),
      {
        configure: function t(n) {
          e.iterateOverMap(n, function (e, t, n) {
            void 0 !== o[e] && (o[e] = t);
          });
        },
        bind: function e(r) {
          ...
          if (void 0 !== r && r) {
            var a = r.elements;
            if (void 0 !== a && a)
              for (var l = 0; s.successful && l < a.length; )
                (r.element = a[l]),
                  o.enableHTML5Validation &&
                    t.supportsHTML5Validation() &&
                    (s = n.bindHTML5ValidationConstraints({
                      element: r.element,
                    })),
                  s.successful
                    ? (s = n.bindFromOptions(r)).successful ||
                      (s.message =
                        "regula.bind: Element " +
                        (l + 1) +
                        " of " +
              ...
              o.enableHTML5Validation &&
                ...
                void 0 !== r.element &&
                null !== r.element &&
                (s = n.bindHTML5ValidationConstraints({ element: r.element })),
                s.successful && (s = n.bindFromOptions(r));
          } else
            n.resetBoundConstraints(),
              o.enableHTML5Validation &&
                t.supportsHTML5Validation() &&
                (s = n.bindHTML5ValidationConstraints({ element: null })),
              s.successful && (s = n.bindAfterParsing({ element: null }));
          if (!s.successful) throw new i.Exception.BindException(s.message);
        },
        unbind: function e(t) {
          if (void 0 !== t && t) {
            if (void 0 === t.elementId && void 0 === t.elements)
              throw new i.Exception.IllegalArgumentException(
                "regula.unbind requires an elementId attribute, or an elements attribute if options are provided"
              );
            if (!(void 0 === t.elements || t.elements instanceof Array))
              throw new i.Exception.IllegalArgumentException(
                "regula.unbind expects the elements attribute to be an array, if it is provided"
              );
            if (
              void 0 === t.elements &&
              ((t.elements = [document.getElementById(t.elementId)]),
              null === t.elements[0])
            )
              throw new i.Exception.IllegalArgumentException(
                "Element with id " +
                  t.elementId +
                  " does not have any constraints bound to it. " +
                  i.explodeParameters(t)
              );
            n.unbind(t);
          } else n.resetBoundConstraints();
        },
        isBound: function e(t) {
          ...
          if (t.hasOwnProperty("constraint") && void 0 === t.constraint)
            throw new i.Exception.IllegalArgumentException(
              "Undefined constraint was supplied as a parameter"
            );
          if (t.hasOwnProperty("group") && void 0 === t.group)
            throw new i.Exception.IllegalArgumentException(
        ...
        validate: function e(t, a) {
          s.init({
            config: o,
            ReverseConstraint: r.ReverseConstraint,
            constraintDefinitions: r.constraintDefinitions,
          ...
          if (
            void 0 === t ||
            void 0 === t.groups ||
            t.groups instanceof Array
          ) {
            if (void 0 !== t && void 0 !== t.groups && 0 == t.groups.length)
              throw new i.Exception.IllegalArgumentException(
                "regula.validate: If a groups attribute is provided, it must not be empty."
              );
            if (
              void 0 !== t &&
              t.hasOwnProperty("constraintType") &&
              void 0 === t.constraintType
            )
              throw new i.Exception.IllegalArgumentException(
            ...
            if (
              (void 0 === a && "function" == typeof t && (t = { callback: t }),
              void 0 !== a && (t.callback = a),
              void 0 !== t && void 0 !== t.elements)
            ) {
              if (!(t.elements instanceof Array))
                throw new i.Exception.IllegalArgumentException(
        ...
        custom: function e(t) {
          ...
          if (0 > o.constructor.toString().indexOf("Array"))
            throw new i.Exception.IllegalArgumentException(
        ...
        compound: function e(t) {
          ...
          var n = t.name,
            ...
            l = t.params || [],
            c =
              void 0 !== t.reportAsSingleViolation && t.reportAsSingleViolation;
          if (!n)
            throw new i.Exception.IllegalArgumentException(
          ...
          if (0 > l.constructor.toString().indexOf("Array"))
            throw new i.Exception.IllegalArgumentException(
        ...
        override: function e(t) {
          ...
          var s = !1,
            a = r.constraintDefinitions[n].formSpecific;
          r.constraintDefinitions[n].custom &&
            (a =
              void 0 === t.formSpecific
                ? r.constraintDefinitions[n].formSpecific
                : t.formSpecific);
          var o =
              r.constraintDefinitions[n].custom && void 0 !== t.async
                ? t.async
                : r.constraintDefinitions[n].async,
            l =
              (r.constraintDefinitions[n].custom && t.params) ||
              r.constraintDefinitions[n].params,
            c = t.defaultMessage || r.constraintDefinitions[n].defaultMessage,
            u = r.constraintDefinitions[n].compound,
            d = t.constraints || r.constraintDefinitions[n].constraints,
            p = r.constraintDefinitions[n].validator;
          if (
            (r.constraintDefinitions[n].custom &&
              !r.constraintDefinitions[n].compound &&
              void 0 !== t.validator &&
              ((p = t.validator), (s = !0)),
            "boolean" != typeof a)
          )
          ...
          r.override({
            ...
            compound: u,
            params: l,
            composingConstraints: d,
            defaultMessage: c,
            validator: p,
            validatorRedefined: s,
          });
        },
        ...
        bind: function (t) {
          return (
            this instanceof e &&
              (t || (t = {}),
              this.get().length > 0 &&
                n.extend(!0, t, { elements: this.get() })),
            regula.bind(t),
            this
          );
        },
        ...
        isBound: function (t) {
          return (
            this instanceof e &&
              (t || (t = {}),
              this.get().length > 0 &&
                n.extend(!0, t, { element: this.get(0) })),
            regula.isBound(t),
            this
          );
        },
    ...
    (e.fn.attr2 = function () {
      ...
      (e.fn.ajaxSubmit = function (t) {
        function n(n) {
          ...
          function o() {
            ...
            var n = c.attr2("target"),
              ...
              o =
                ...
                c.attr("encoding") ||
                "multipart/form-data";
            T.setAttribute("target", g),
              (!a || /post/i.test(a)) && T.setAttribute("method", "POST"),
              s != p.url && T.setAttribute("action", p.url),
            ...
            try {
              if (p.extraData)
                for (var d in p.extraData)
                  p.extraData.hasOwnProperty(d) &&
                    u.push(
                      e.isPlainObject(p.extraData[d]) &&
                        p.extraData[d].hasOwnProperty("name") &&
                        p.extraData[d].hasOwnProperty("value")
                        ? e(
              ...
              p.iframeTarget || v.appendTo("body"),
                y.attachEvent
                  ? y.attachEvent("onload", l)
                  : y.addEventListener("load", l, !1),
                setTimeout(t, 15);
              try {
                T.submit();
              } catch (h) {
              ...
              T.setAttribute("action", s),
                T.setAttribute("enctype", o),
                n ? T.setAttribute("target", n) : c.removeAttr("target"),
                e(u).remove();
            }
          }
          function l(t) {
            if (!b.aborted && !L) {
              if (
                ((O = r(y)) || (i("cannot access response document"), (t = I)),
                t === S && b)
              )
                return b.abort("timeout"), void E.reject(b, "timeout");
              if (t == I && b)
                return (
                  b.abort("server abort"),
                  void E.reject(b, "error", "server abort")
                );
              if ((O && O.location.href != p.iframeSrc) || _) {
                y.detachEvent
                  ? y.detachEvent("onload", l)
                  : y.removeEventListener("load", l, !1);
                var n,
                  s = "success";
                try {
                  if (_) throw "timeout";
                  var a = "xml" == p.dataType || O.XMLDocument || e.isXMLDoc(O);
                  if (
                    (i("isXml=" + a),
                    !a &&
                      window.opera &&
                  ...
                  var o = O.body ? O.body : O.documentElement;
                  ...
                  if (u || p.textarea) {
                    ...
                    if (d)
                      ...
                      h
                        ? (b.responseText = h.textContent
                            ? h.textContent
                            : h.innerText)
                        : g &&
                          (b.responseText = g.textContent
                            ? g.textContent
                            : g.innerText);
                    }
                  } else
                  ...
                  try {
                    ...
                    (s = "parsererror"), (b.error = n = x || s);
                  }
                } catch (w) {
                  i("error caught: ", w), (s = "error"), (b.error = n = w || s);
                }
                b.aborted && (i("upload aborted"), (s = null)),
                  b.status &&
                    (s =
                      (b.status >= 200 && b.status < 300) || 304 === b.status
                        ...
                        : "error"),
                  "success" === s
                    ? (p.success && p.success.call(p.context, k, "success", b),
                      E.resolve(b.responseText, "success", b),
                      f && e.event.trigger("ajaxSuccess", [b, p]))
                    : s &&
                      (void 0 === n && (n = b.statusText),
                      p.error && p.error.call(p.context, b, s, n),
                      E.reject(b, "error", n),
                      f && e.event.trigger("ajaxError", [b, p, n])),
                  f && e.event.trigger("ajaxComplete", [b, p]),
                  !f || --e.active || e.event.trigger("ajaxStop"),
                  p.complete && p.complete.call(p.context, b, s),
                  (L = !0),
                  p.timeout && clearTimeout(C),
                  setTimeout(function () {
                    p.iframeTarget ? v.attr("src", p.iframeSrc) : v.remove(),
                      (b.responseXML = null);
                  }, 100);
              }
            }
          ...
          if (
            ...
            for (d = 0; d < h.length; d++)
              (u = e(h[d])),
                s ? u.prop("disabled", !1) : u.removeAttr("disabled");
          if (
            (((p = e.extend(!0, {}, e.ajaxSettings, t)).context =
              p.context || p),
            (g = "jqFormIO" + new Date().getTime()),
            p.iframeTarget
              ? (w = (v = e(p.iframeTarget)).attr2("name"))
                ? (g = w)
                : v.attr2("name", g)
              : (v = e(
                  '<iframe name="' + g + '" src="' + p.iframeSrc + '" />'
                )).css({
                  position: "absolute",
                  top: "-1000px",
                  left: "-1000px",
            ...
            (b = {
              ...
              abort: function (t) {
                ...
                v.attr("src", p.iframeSrc),
                  (b.error = n),
                  p.error && p.error.call(p.context, b, n, t),
                  f && e.event.trigger("ajaxError", [b, p, n]),
                  p.complete && p.complete.call(p.context, b, n);
              },
            }),
            (f = p.global) && 0 == e.active++ && e.event.trigger("ajaxStart"),
            f && e.event.trigger("ajaxSend", [b, p]),
            p.beforeSend && !1 === p.beforeSend.call(p.context, b, p))
          )
            return p.global && e.active--, E.reject(), E;
          if (b.aborted) return E.reject(), E;
          (x = T.clk) &&
            (w = x.name) &&
            !x.disabled &&
            ((p.extraData = p.extraData || {}),
            (p.extraData[w] = x.value),
            "image" == x.type &&
              ((p.extraData[w + ".x"] = T.clk_x),
              (p.extraData[w + ".y"] = T.clk_y)));
          var S = 1,
            I = 2,
            A = e("meta[name=csrf-token]").attr("content"),
            D = e("meta[name=csrf-param]").attr("content");
          D && A && ((p.extraData = p.extraData || {}), (p.extraData[D] = A)),
        ...
        "function" == typeof t
          ...
          (l =
            (l =
              "string" == typeof (o = t.url || this.attr2("action"))
                ? e.trim(o)
                : "") ||
        ...
        if ((this.trigger("form-submit-validate", [f, this, t, u]), u.veto))
          return (
        ...
        if (
          ((t.success = function (e, n, i) {
            for (var r = t.context || this, s = 0, a = v.length; a > s; s++)
              v[s].apply(r, [e, n, i || c, c]);
          }),
          t.error)
        ) {
          var b = t.error;
        ...
        var w,
          ...
          T = c.attr("enctype") == C || c.attr("encoding") == C,
          E = r.fileapi && r.formdata;
        i("fileAPI :" + E),
          !1 !== t.iframe && (t.iframe || ((_ || T) && !E))
            ? t.closeKeepAlive
            ...
            : (w =
                (_ || T) && E
                  ? (function n(i) {
                      for (var r = new FormData(), s = 0; s < i.length; s++)
                        r.append(i[s].name, i[s].value);
                      if (t.extraData) {
                        var o = (function n(i) {
                          var r,
                            s,
                  ...
                  : e.ajax(t)),
          c.removeData("jqxhr").data("jqxhr", w);
      ...
      (e.fn.formToArray = function (t, n) {
        ...
        var p,
          h = this[0],
          f = this.attr("id"),
          g = t ? h.getElementsByTagName("*") : h.elements;
        if (
          (g && !/MSIE [678]/.test(navigator.userAgent) && (g = e(g).get()),
          f &&
            (p = e(':input[form="' + f + '"]').get()).length &&
            (g = (g || []).concat(p)),
          !g || !g.length)
        )
          return d;
        for (i = 0, c = g.length; c > i; i++)
          if ((a = (l = g[i]).name) && !l.disabled) {
            if (t && h.clk && "image" == l.type)
              h.clk == l &&
                (d.push({ name: a, value: e(l).val(), type: l.type }),
                d.push(
                  { name: a + ".x", value: h.clk_x },
                  { name: a + ".y", value: h.clk_y }
                ));
            else if ((o = e.fieldValue(l, !0)) && o.constructor == Array)
              for (n && n.push(l), s = 0, u = o.length; u > s; s++)
                d.push({ name: a, value: o[s] });
            else if (r.fileapi && "file" == l.type) {
              n && n.push(l);
              var v = l.files;
              if (v.length)
                for (s = 0; s < v.length; s++)
                  d.push({ name: a, value: v[s], type: l.type });
              else d.push({ name: a, value: "", type: l.type });
            } else
              null != o &&
                (n && n.push(l),
                d.push({
   ...
   */ function () {
    ...
    (e = window.jQuery),
      ...
      (i = (function () {
        function i(i, r) {
          (this.options = e.extend(!0, {}, this.Defaults, r)),
            (this.$element = e(i).addClass("rd-input-label")),
            (this.$target = e("#" + this.$element.attr("for"))),
            (this.$win = e(n)),
            (this.$doc = e(t)),
            this.initialize();
        }
        return (
          (i.prototype.Defaults = { callbacks: null }),
          (i.prototype.initialize = function () {
            return (
              this.$target
                .on("input", e.proxy(this.change, this))
                .on("focus", e.proxy(this.focus, this))
                .on("blur", e.proxy(this.blur, this))
                .on("hover", e.proxy(this.hover, this))
                .parents("form")
                .on("reset", e.proxy(this.reset, this)),
              this.change(),
              this.hover(),
              this
            );
          ...
          (i.prototype.reset = function () {
            return setTimeout(e.proxy(this.blur, this)), this;
          }),
      ...
      e.fn.extend({
        RDInputLabel: function (t) {
          return this.each(function () {
            var n;
            return (n = e(this)).data("RDInputLabel")
              ? void 0
              : n.data("RDInputLabel", new i(this, t));
          });
        },
      }),
      (n.RDInputLabel = i),
    ...
    (r.Defaults = {
        ...
        },
        {
          ...
          run: function () {
            var t = [],
              ...
              a = i.loop && n.length ? (i.rewind ? r : Math.max(r, s)) : 0,
              o = "",
              l = "";
            for (a /= 2; a--; )
      ...
      (r.prototype.onDragEnd = function (t) {
        ...
        e(n).off(".owl.core"),
          ...
          ((0 !== i.x && this.is("dragging")) || !this.is("valid")) &&
            ...
            this.current(
              this.closest(r.x, 0 !== i.x ? s : this._drag.direction)
            ),
            this.invalidate("position"),
            this.update(),
      ...
      (r.prototype.maximum = function (e) {
        ...
        if (r.loop) s = this._clones.length / 2 + this._items.length - 1;
          ...
          for (
            ...
            t-- && !((n += this._items[t].width() + this.settings.margin) > i);
      ...
      (r.prototype.coordinates = function (t) {
        ...
        return t === i
          ...
          : (this.settings.center
              ? (this.settings.rtl && ((r = -1), (s = t + 1)),
                (n = this._coordinates[t]),
                (n +=
                  ((this.width() - n + (this._coordinates[s] || 0)) / 2) * r))
      ...
      (r.prototype.to = function (e, t) {
        var n = this.current(),
          ...
          l = this.maximum();
        this.settings.loop
          ? (!this.settings.rewind && Math.abs(r) > a / 2 && (r += -1 * s * a),
            (i = (((((e = n + r) - o) % a) + a) % a) + o) !== e &&
              i - r <= l &&
              i - r > 0 &&
      ...
      (r.prototype.trigger = function (t, n, i, s, a) {
              ...
              if (
                ...
                for (
                  ...
                  this.load(a / 2 + this._core.relative(s)),
                    a && e.each(this._core.clones(this._core.relative(s)), o),
                    s++;
            }, this),
        }),
        (this._core.options = e.extend({}, r.Defaults, this._core.options)),
  ...
  (function (e, t, n, i) {
    ...
    (r.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      (r.prototype.fetch = function (e, t) {
        ...
        (i = i[6]),
          (this._videos[a] = { type: n, id: i, width: r, height: s }),
          t.attr("data-video", a),
      ...
      (r.prototype.thumbnail = function (t, n) {
        ...
        if (
          (t.wrap('<div class="owl-video-wrapper"' + a + "></div>"),
          this._core.settings.lazyLoad && ((l = "data-src"), (c = "owl-lazy")),
          o.length)
        )
          return d(o.attr(l)), o.remove(), !1;
        "youtube" === n.type
          ? d((s = "//img.youtube.com/vi/" + n.id + "/hqdefault.jpg"))
          : "vimeo" === n.type
          ? e.ajax({
              type: "GET",
            ...
            if (n.namespace && "position" === n.property.name) {
              var i = this._core.items(
                ...
                r = e
                  ...
                  .join();
              r && t.location.hash.slice(1) !== r && (t.location.hash = r);
            }
          }, this),
        }),
        (this._core.options = e.extend({}, r.Defaults, this._core.options)),
  ...
  (function (e) {
    ...
    function n(e) {
      if (e) {
        ...
        return (
          (e.bridget = function (t, r) {
            var s, a, o;
            (s = r).prototype.option ||
              ...
              (e.fn[a] = function (t) {
                if ("string" == typeof t) {
                  for (
                    var r = i.call(arguments, 1), s = 0, l = this.length;
                    l > s;
                    s++
                  ) {
                    var c = this[s],
                      u = e.data(c, a);
                    if (u) {
                      if (e.isFunction(u[t]) && "_" !== t.charAt(0)) {
                        var d = u[t].apply(u, r);
                        if (void 0 !== d) return d;
                      } else
                        n("no such method '" + t + "' for " + a + " instance");
                    } else
                      n(
                ...
                return this.each(function () {
                  ...
                  n
                    ? (n.option(t), n._init())
                    : ((n = new o(this, t)), e.data(this, a, n));
                });
              });
          }),
          e.bridget
    ...
    "function" == typeof define && define.amd
      ...
      : n("object" == typeof exports ? require("jquery") : e.jQuery);
  })(window),
  (function (e) {
    function t(t) {
      var n = e.event;
  ...
  function () {
    ...
    (i.getListeners = function (e) {
      ...
      (i.removeListener = function (e, n) {
        ...
        for (r in s)
          s.hasOwnProperty(r) && -1 !== (i = t(s[r], n)) && s[r].splice(i, 1);
        return this;
      }),
      ...
      (i.emitEvent = function (e, t) {
        ...
        for (r in s)
          if (s.hasOwnProperty(r))
            for (i = s[r].length; i--; )
              !0 === (n = s[r][i]).once && this.removeListener(e, n.listener),
  ...
  (function (e) {
    function t(e) {
      if (e) {
        ...
        for (var t, r = 0, s = n.length; s > r; r++)
          if ("string" == typeof i[(t = n[r] + e)]) return t;
      }
    }
    ...
    function i(t) {
      ...
      return function (u) {
        if (
            ...
            if (!c) {
              ...
              if (
                ...
                (d.style.width = "200px"),
                  ...
                  (d.style[o] = "border-box");
                var p = document.body || document.documentElement;
                p.appendChild(d), (l = 200 === n(a(d).width)), p.removeChild(d);
              }
            }
          })(),
          ...
          for (
            var h = (p.isBorderBox = !(!o || !d[o] || "border-box" !== d[o])),
              f = 0,
              g = s.length;
            g > f;
            f++
          ...
          var x = p.paddingLeft + p.paddingRight,
            ...
            E = p.borderTopWidth + p.borderBottomWidth,
            S = h && l,
            I = n(d.width);
          !1 !== I && (p.width = I + (S ? 0 : x + T));
          var A = n(d.height);
          return (
            !1 !== A && (p.height = A + (S ? 0 : w + E)),
            (p.innerWidth = p.width - (x + T)),
            (p.innerHeight = p.height - (w + E)),
            (p.outerWidth = p.width + _),
  ...
  (function (e) {
    ...
    function i() {
      t.isReady = !0;
      for (var e = 0, n = a.length; n > e; e++) (0, a[e])();
    }
    function r(r) {
      return (
        "complete" === s.readyState
          ? i()
          : (r.bind(s, "DOMContentLoaded", n),
            r.bind(s, "readystatechange", n),
            r.bind(e, "load", n)),
        t
      );
    }
  ...
  (function (e) {
    ...
    (i = r
      ...
      : function (e, t) {
          n(e);
          for (
            var i = e.parentNode.querySelectorAll(t), r = 0, s = i.length;
            s > r;
            r++
          )
            if (i[r] === e) return !0;
  ...
  (function (e, t) {
    ...
    (i.isArray = function (e) {
      ...
      (i.getParent = function (e, t) {
        for (; e != document.body; ) if (n((e = e.parentNode), t)) return e;
      }),
      ...
      (i.filterFindElements = function (e, t) {
        for (var r = [], s = 0, a = (e = i.makeArray(e)).length; a > s; s++) {
          var o = e[s];
          if (i.isElement(o)) {
            if (t) {
              n(o, t) && r.push(o);
              for (
                var l = o.querySelectorAll(t), c = 0, u = l.length;
                u > c;
                c++
              )
                r.push(l[c]);
    ...
    var a = e.console;
    return (
      (i.htmlInit = function (n, r) {
        t(function () {
          for (
            var t = i.toDashed(r),
              s = document.querySelectorAll(".js-" + t),
              o = "data-" + t + "-options",
              l = 0,
              c = s.length;
            c > l;
  ...
  (function (e, t) {
    ...
    r.extend(s.prototype, t.prototype),
      ...
      (s.prototype.getPosition = function () {
        var e = o(this.element),
          ...
          l =
            -1 != r.indexOf("%")
              ? (parseFloat(r) / 100) * a.width
              : parseInt(r, 10),
          c =
            -1 != s.indexOf("%")
              ? (parseFloat(s) / 100) * a.height
              : parseInt(s, 10);
        (l = isNaN(l) ? 0 : l),
          (c = isNaN(c) ? 0 : c),
      ...
      (s.prototype._transitionTo = function (e, t) {
        ...
        if ((this.setPosition(e, t), !a || this.isTransitioning)) {
          var o = {};
          (o.transform = this.getTranslate(e - n, t - i)),
            this.transition({
              to: o,
      ...
      (s.prototype.moveTo =
        l && c ? s.prototype._transitionTo : s.prototype.goTo),
    ...
    var f =
      "opacity," +
      (h.transform || "transform").replace(/([A-Z])/g, function (e) {
        return "-" + e.toLowerCase();
      });
    (s.prototype.enableTransition = function () {
      ...
      (s.prototype.transition =
        s.prototype[l ? "_transition" : "_nonTransition"]),
  ...
  (function (e, t) {
    ...
    return (
      ...
      r.extend(a.prototype, n.prototype),
      ...
      (a.prototype._layoutItems = function (e, t) {
        if ((this._emitCompleteOnItems("layout", e), e && e.length)) {
          for (var n = [], i = 0, r = e.length; r > i; i++) {
            ...
            (a.item = s), (a.isInstant = t || s.isLayoutInstant), n.push(a);
          }
      ...
      (a.prototype._emitCompleteOnItems = function (e, t) {
        ...
        var i = this,
          r = t.length;
        if (t && r)
          for (var s = 0, a = 0, o = t.length; o > a; a++)
            t[a].once(e, function () {
              ++s === r && n();
            });
        else n();
      ...
      (a.prototype.reveal = function (e) {
        ...
        for (var t = e && e.length, n = 0; t && t > n; n++) e[n].reveal();
      }),
      (a.prototype.hide = function (e) {
        this._emitCompleteOnItems("hide", e);
        for (var t = e && e.length, n = 0; t && t > n; n++) e[n].hide();
      }),
      ...
      (a.prototype.getItems = function (e) {
        for (var t = [], n = 0, i = (e = r.makeArray(e)).length; i > n; n++) {
          var s = e[n],
            a = this.getItem(s);
          a && t.push(a);
        }
      ...
      (a.create = function (e, t) {
        ...
        return (
          Object.create
            ...
            : r.extend(n.prototype, a.prototype),
          (n.prototype.constructor = n),
          (n.defaults = r.extend({}, a.defaults)),
      ...
      (i.prototype._getItemLayoutPosition = function (e) {
        ...
        for (
          var r = this._getColGroup(i),
            ...
            a = n.indexOf(r, s),
            o = { x: this.columnWidth * a, y: s },
            l = s + e.size.outerHeight,
  ...
  (function (e, t) {
    ...
    var o = n.prototype._manageStamp;
    return (
      ...
      (u.prototype._filter = function (e) {
        ...
        for (
          ...
          if (!l.isIgnored) {
            var c = s(l);
            c && n.push(l),
              c && l.isHidden ? i.push(l) : c || l.isHidden || r.push(l);
          }
        }
  ...
  function () {
    ...
    (e = "ontouchstart" in window),
      ...
      (r = (function () {
        ...
        return (
          ...
          (r.prototype.resize = function (n, i) {
            var r, s;
            return (
              (s = e ? n.getOption("deviceLayout") : n.getOption("layout")),
              (r = n.$element.add(n.$clone)),
              (s === n.currentLayout && n.loaded) ||
                (n.switchClass(r, n.currentLayout, s),
          ...
          (r.prototype.stickUp = function (e, n) {
            var i, r, s, a, o;
            function l() {
              "resize" === n.type
                ? e.switchClass(a, "", "rd-navbar--is-stuck")
                : a.addClass("rd-navbar--is-stuck"),
                (e.isStuck = !0);
            }
            return (
              (r = e.getOption("stickUp")),
              (t("html").hasClass("ios") ||
                e.$element.hasClass("rd-navbar-fixed")) &&
                (r = !1),
              (i = e.$doc.scrollTop()),
              (a = null != e.$clone ? e.$clone : e.$element),
              (o =
                "string" == typeof (s = e.getOption("stickUpOffset"))
                  ? s.indexOf("%") > 0
                    ? (parseFloat(s) * e.height) / 100
                    : parseFloat(s)
                  : s),
              r
                ? ((i >= o && !e.isStuck) || (i < o && e.isStuck)) &&
                  (e.$element
                    .add(e.$clone)
                    ...
                    ? ("resize" === n.type
                        ...
                        : a
                            ...
                            .one(
                              ...
                              t.proxy(e.resizeWrap, e, n)
                            ),
                      (e.isStuck = !1),
                      e.options.callbacks.onUnstuck &&
                        e.options.callbacks.onUnstuck.call(e))
                    : (e.options.callbacks.onStuck &&
                        e.options.callbacks.onStuck.call(e),
          ...
          (r.prototype.resizeWrap = function (e) {
            var t, n;
          ...
          (r.prototype.createNav = function (e) {
            return (
              e.$element
                ...
                .each(function () {
                  ...
                  return (
                    ...
                    e.hasClass("rd-navbar-megamenu")
                      ? e.parent().addClass("rd-navbar--has-megamenu")
                      : e.parent().addClass("rd-navbar--has-dropdown")
                  );
                })
                .parents("li")
                .addClass("rd-navbar-submenu"),
              t('<span class="rd-navbar-submenu-toggle"></span>').insertAfter(
                ".rd-navbar-nav li.rd-navbar-submenu > a"
              ),
              e.options.callbacks.onDomAppend &&
                e.options.callbacks.onDomAppend.call(this),
              e
            );
          }),
          (r.prototype.createClone = function (e) {
            return (
              (e.$clone = e.$element
                .clone()
          ...
          (r.prototype.closeToggle = function (e, n) {
            var i, r, s, a, o, l, c;
            return (
              (r = t(n.target)),
              (o = !1),
              ...
              e.options.stickUpClone && e.isStuck
                ? ((a = ".toggle-cloned"),
                  ...
                  (c = !r.hasClass("toggle-cloned")))
                : ((a = ".toggle-original"),
                  (s = ".toggle-original-elements"),
                  (c = !r.hasClass("toggle-original"))),
              n.target !== this &&
                !r.parents(a + "[data-rd-navbar-toggle]").length &&
                !r.parents(s).length &&
                l &&
                c &&
                ((i = t(this)
                  .parents("body")
                  .find(l)
                  .add(t(this).parents(".rd-navbar")[0])).each(function () {
                  if (!o)
                    return (o =
                      !0 === (n.target === this || t.contains(this, n.target)));
                }),
                o ||
                  (i.add(this).removeClass("active"),
                  e.options.callbacks.onToggleClose &&
                    e.options.callbacks.onToggleClose.call(this, e))),
              this
            );
          }),
          (r.prototype.switchToggle = function (e, n) {
            var i, r, s;
            return (
              n.preventDefault(),
              t(this).hasClass("toggle-cloned")
                ? ((s = ".rd-navbar--is-clone"),
                  (i = ".toggle-cloned-elements"))
                : ((s = ".rd-navbar-original"),
                  (i = ".toggle-original-elements")),
              (r = this.getAttribute("data-rd-navbar-toggle")) &&
                (t(s + " [data-rd-navbar-toggle]")
                  .not(this)
                  .each(function () {
                    var e;
                    if ((e = this.getAttribute("data-rd-navbar-toggle")))
                      return t(this)
                        ...
                        .add(this)
                        .add(
                          t.inArray(".rd-navbar", e.split(/\s*,\s*/i)) > -1 &&
                            t(this).parents("body")[0]
                        )
                        .removeClass("active");
                  }),
                t(this)
                  ...
                  .add(this)
                  .add(
                    t.inArray(".rd-navbar", r.split(/\s*,\s*/i)) > -1 &&
                      t(this).parents(".rd-navbar")[0]
                  )
                  .toggleClass("active")),
              e.options.callbacks.onToggleSwitch &&
                e.options.callbacks.onToggleSwitch.call(this, e),
              this
            );
          }),
          (r.prototype.dropdownOver = function (e, n) {
            var i;
            if (e.focusOnHover) {
              if (
                ((i = t(this)),
                clearTimeout(n),
                e.options.callbacks.onDropdownOver &&
                  !e.options.callbacks.onDropdownOver.call(this, e))
              )
                return this;
              i.addClass("focus")
                .siblings()
                .removeClass("opened")
                .each(e.dropdownUnfocus);
            }
            return this;
          }),
          (r.prototype.dropdownTouch = function (e, n) {
            var i, r;
            if (((i = t(this)), clearTimeout(n), e.focusOnHover)) {
              if (((r = !1), i.hasClass("focus") && (r = !0), !r))
                return (
                  i
                    .addClass("focus")
                    .siblings()
          ...
          (r.prototype.dropdownOut = function (e, n) {
            return (
              e.focusOnHover &&
                (t(this).one("mouseenter.navbar", function () {
                  return clearTimeout(n);
                }),
                e.options.callbacks.onDropdownOut &&
                  e.options.callbacks.onDropdownOut.call(this, e),
                clearTimeout(n),
                (n = setTimeout(
                  t.proxy(e.dropdownUnfocus, this, e),
                  e.options.focusOnHoverTimeout
                ))),
              this
            );
          }),
          (r.prototype.dropdownUnfocus = function (e) {
            return (
              t(this).find("li.focus").add(this).removeClass("focus"), this
            );
          }),
          (r.prototype.dropdownClose = function (e, n) {
            return (
              n.target === this ||
                ...
                (t(this)
                  ...
                  .removeClass("focus")
                  .removeClass("opened"),
                e.options.callbacks.onDropdownClose &&
                  e.options.callbacks.onDropdownClose.call(this, e)),
              this
            );
          }),
          (r.prototype.dropdownToggle = function (e) {
            return (
              t(this).toggleClass("opened").siblings().removeClass("opened"),
              e.options.callbacks.onDropdownToggle &&
                e.options.callbacks.onDropdownToggle.call(this, e),
              this
            );
          }),
          (r.prototype.goToAnchor = function (e, n) {
            var i, r;
            return (
              (i = t((r = this.hash))),
                ...
                (i.length &&
                  ...
                  t("html, body")
                    ...
                    .animate(
                      {
                        scrollTop:
                          i.offset().top + e.getOption("anchorNavOffset") + 1,
                      },
                      e.getOption("anchorNavSpeed"),
                      e.getOption("anchorNavEasing"),
                      function () {
                        return e.changeAnchor(r);
                      }
                    )),
                this)
            );
          }),
          (r.prototype.activateAnchor = function (e) {
            var n, i, r, s, a, o, l, c, u, d, p, h;
            if (
              ((s = this),
              (p = s.$doc.scrollTop()),
              (h = s.$win.height()),
              (a = s.$doc.height()),
              (d = s.getOption("anchorNavOffset")),
              !s.options.anchorNav)
            )
              return !1;
            if (p + h > a - 50)
              return (
                (n = t('[data-type="anchor"]').last()).length &&
                  n.offset().top >= p &&
                  ((i = t(
                    '.rd-navbar-nav a[href^="' + (o = "#" + n.attr("id")) + '"]'
            ...
            for (l in (u = t('.rd-navbar-nav a[href^="#"]').get()))
              (o = (r = t((c = u[l]))).attr("href")),
                (n = t(o)).length &&
                  n.offset().top + d <= p &&
                  n.offset().top + n.outerHeight() > p &&
                  (r
                    .parent()
                    .addClass("active")
                    .siblings()
          ...
          (r.prototype.changeAnchor = function (e) {
            return (
              history &&
                (history.state && history.state.id !== e
                  ? history.replaceState({ anchorId: e }, null, e)
                  : history.pushState({ anchorId: e }, null, e)),
              this
            );
          }),
          (r.prototype.applyHandlers = function (e) {
            return (
              null != e.options.responsive &&
                e.$win
                  ...
                  .on(
                    ...
                    t.proxy(
                      e.stickUp,
                      null != e.$clone ? e.$clone : e.$element,
                      e
                    )
                  )
                  .on(
                    "orientationchange.navbar",
                    t.proxy(e.resize, e.$win[0], e)
                  )
              ...
              e.$doc
                ...
                .on("scroll.navbar", t.proxy(e.activateAnchor, e)),
              e.$element
                .add(e.$clone)
                .find("[data-rd-navbar-toggle]")
                .each(function () {
                  var n;
                  return (
                    (n = t(this)).on("click", t.proxy(e.switchToggle, this, e)),
                    n
                      .parents("body")
                      .on("click", t.proxy(e.closeToggle, this, e))
                  );
                }),
              e.$element
                .add(e.$clone)
                ...
                .each(function () {
                  var n, i;
                  return (
                    (i = (n = t(this)).parents(".rd-navbar--is-clone").length
                      ? e.cloneTimer
                      : e.focusTimer),
                    n.on(
                      "mouseleave.navbar",
                      t.proxy(e.dropdownOut, this, e, i)
                    ),
                    n
                      .find("> a")
                      .on(
                        "mouseenter.navbar",
                        t.proxy(e.dropdownOver, this, e, i)
                      ),
                    n
                      .find("> a")
                      .on(
                        "touchstart.navbar",
                        t.proxy(e.dropdownTouch, this, e, i)
                      ),
                    n
                      .find("> .rd-navbar-submenu-toggle")
                      .on("click", t.proxy(e.dropdownToggle, this, e)),
                    n
                      .parents("body")
                      .on("click", t.proxy(e.dropdownClose, this, e))
                  );
                }),
              e.$element
                .add(e.$clone)
              ...
              e.$element
                ...
                .each(function () {
                  var e, n;
                  (e = t(this)),
                    (n = this.getBoundingClientRect()).left + e.outerWidth() >=
                    i.innerWidth - 10
                      ? (this.className += " rd-navbar-open-left")
                      : n.left - e.outerWidth() <= 10 &&
                        (this.className += " rd-navbar-open-right");
                }),
              e
            );
          }),
          (r.prototype.switchClass = function (e, n, i) {
            var r;
            return (
              (r = e instanceof jQuery ? e : t(e))
                .addClass("rd-navbar--no-transition")
                .removeClass(n)
                .addClass(i),
              r[0].offsetHeight,
              r.removeClass("rd-navbar--no-transition")
            );
          }),
          (r.prototype.getOption = function (e) {
            ...
            return null != this.options.responsive &&
              null != this.options.responsive[n][e]
              ? this.options.responsive[n][e]
              : this.options[e];
          }),
          (r.prototype.addAdditionalClassToToggles = function (e, n, i) {
            return t(e)
              .find("[data-rd-navbar-toggle]")
              .each(function () {
                var r;
                return (
                  t(this).addClass(n),
                  (r = this.getAttribute("data-rd-navbar-toggle")),
                  t(this).parents("body").find(e).find(r).addClass(i)
                );
              });
          }),
          r
      ...
      t.fn.extend({
        RDNavbar: function (e) {
          var n;
          if (!(n = t(this)).data("RDNavbar"))
            return n.data("RDNavbar", new r(this, e));
        },
      }),
      (i.RDNavbar = r),
      "undefined" != typeof module && null !== module
      ...
      e("body").append(
        ...
        e(i).click(function () {
          return (
            e("html, body")
              .stop()
              .animate({ scrollTop: 0 }, n.scrollSpeed, n.easingType),
            !1
          );
        }),
        ...
        function i(n) {
          ...
          n && s.css("display", "block"),
            o > c &&
              ...
              s.css(
                "transform",
                "translate3D(-50%," + Math.round(a * d) + "px, 0)"
              );
        }
        var r = e(this)
          .prepend(
  ...
  (function () {
      ...
      u = function (e, n) {
          ...
          if (
            ...
            x.isHorizontal()
              ? ((37 !== t && 39 !== t) ||
                ...
                ((37 === t && !x.rtl) || (39 === t && x.rtl)) && x.slidePrev())
              : ((38 !== t && 40 !== t) ||
                  (e.preventDefault
                    ? e.preventDefault()
                    : (e.returnValue = !1)),
        ...
        function l(e) {
          ...
          var t,
            ...
            l =
              ...
              "axis" in t && t.axis === t.HORIZONTAL_AXIS && ((n = i), (i = 0)),
              (r = 10 * n),
              (s = 10 * i),
              ...
              r && !n && (n = r < 1 ? -1 : 1),
              s && !i && (i = s < 1 ? -1 : 1),
              { spinX: n, spinY: i, pixelX: r, pixelY: s });
          ...
          if (0 !== a) {
            if ((x.params.mousewheelInvert && (a = -a), x.params.freeMode)) {
              var c =
                ...
                d = x.isEnd;
              if (
                (c >= x.minTranslate() && (c = x.minTranslate()),
                c <= x.maxTranslate() && (c = x.maxTranslate()),
                x.setWrapperTransition(0),
                x.setWrapperTranslate(c),
                x.updateProgress(),
                x.updateActiveIndex(),
                ((!u && x.isBeginning) || (!d && x.isEnd)) && x.updateClasses(),
          ...
          (i = e.attr("data-swiper-parallax") || "0"),
            ...
            (r =
              r.indexOf("%") >= 0
                ...
                : r * n * a + "px"),
            (s =
              s.indexOf("%") >= 0 ? parseInt(s, 10) * n + "%" : s * n + "px"),
        ...
        for (var g in n)
          if (
            ...
            n[g] === window ||
            n[g] === document ||
            ("undefined" != typeof Dom7 && n[g] instanceof Dom7) ||
            ("undefined" != typeof jQuery && n[g] instanceof jQuery)
          )
            f[g] = n[g];
          else for (var v in ((f[g] = {}), n[g])) f[g][v] = n[g][v];
        for (var y in p)
          if (void 0 === n[y]) n[y] = p[y];
          else if ("object" == typeof n[y])
            for (var b in p[y]) void 0 === n[y][b] && (n[y][b] = p[y][b]);
        var x = this;
        if (
          ((x.params = n),
          (x.originalParams = f),
              ...
              if (e && x.currentBreakpoint !== e) {
                var t =
                    e in x.params.breakpoints
                      ...
                      : x.originalParams,
                  n =
                    x.params.loop && t.slidesPerView !== x.params.slidesPerView;
          ...
          (x.container[0].swiper = x),
            ...
            ("fade" !== x.params.effect && "flip" !== x.params.effect) ||
              ...
              (x.params.watchSlidesProgress = !0),
              (x.params.spaceBetween = 0),
              void 0 === h && (x.params.virtualTranslate = !0)),
            x.params.grabCursor &&
              x.support.touch &&
            ...
            (x.imagesToLoad = []),
            (x.imagesLoaded = 0),
            (x.loadImage = function (e, t, n, i, r, s) {
              var a;
              function o() {
                s && s();
              }
            ...
            (x.startAutoplay = function () {
              return (
                ...
                !!x.params.autoplay &&
                !x.autoplaying &&
                ((x.autoplaying = !0), x.emit("onAutoplayStart", x), void r())
              );
            }),
            ...
            (x.updateSlidesSize = function () {
              ...
              if (void 0 !== x.size) {
                ...
                var a,
                  o,
                  l,
                  c = x.params.slidesPerColumn,
                  u = o / c,
                  d = u - (x.params.slidesPerColumn * u - x.slides.length);
                    ...
                    "none" !== g.css("display") &&
                      ("auto" === x.params.slidesPerView
                        ? ((l = x.isHorizontal()
                            ? g.outerWidth(!0)
                            : g.outerHeight(!0)),
                          x.params.roundLengths && (l = i(l)))
                        : ((l =
                            (x.size - (x.params.slidesPerView - 1) * t) /
                            x.params.slidesPerView),
                          x.params.roundLengths && (l = i(l)),
                          x.isHorizontal()
                            ? (x.slides[e].style.width = l + "px")
                            : (x.slides[e].style.height = l + "px")),
                      (x.slides[e].swiperSlideSize = l),
                      x.slidesSizesGrid.push(l),
                      x.params.centeredSlides
                        ? ((n = n + l / 2 + r / 2 + t),
                          0 === r && 0 !== e && (n = n - x.size / 2 - t),
                          0 === e && (n = n - x.size / 2 - t),
                          0.001 > Math.abs(n) && (n = 0),
                          s % x.params.slidesPerGroup == 0 &&
                            x.snapGrid.push(n),
                          x.slidesGrid.push(n))
                        : (s % x.params.slidesPerGroup == 0 &&
                            x.snapGrid.push(n),
                ...
                if (
                  ...
                  x.params.slidesPerColumn > 1 &&
                    ((x.virtualSize = (l + x.params.spaceBetween) * o),
                    (x.virtualSize =
                  ...
                  for (a = [], e = 0; e < x.snapGrid.length; e++)
                ...
                for (var n = 0; n < x.slides.length; n++) {
                  var i = x.slides[n],
                    r =
                      (t +
                        ...
                        i.swiperSlideOffset) /
                      (i.swiperSlideSize + x.params.spaceBetween);
                  if (x.params.watchSlidesVisibility) {
                    ...
                    ((s >= 0 && s < x.size) ||
                      (a > 0 && a <= x.size) ||
                      (s <= 0 && a >= x.size)) &&
                      x.slides.eq(n).addClass(x.params.slideVisibleClass);
                  }
            ...
            (x.updateClasses = function () {
              ...
              x.params.loop &&
                0 === i.length &&
                (i = x.slides.eq(0)).addClass(x.params.slideNextClass);
              var r = e
              ...
              if (
                ...
                if (
                  ...
                  var o = (s + 1) / a,
                    l = o,
                    c = 1;
                  x.isHorizontal() || ((c = o), (l = 1)),
                    x.paginationContainer
                      .find("." + x.params.paginationProgressbarClass)
                      .transform(
                        "translate3d(0,0,0) scaleX(" + l + ") scaleY(" + c + ")"
                      )
                ...
                "custom" === x.params.paginationType &&
                  ...
                  (x.paginationContainer.html(
                    x.params.paginationCustomRender(x, s + 1, a)
                  ),
          ...
          (x.onTouchStart = function (e) {
            if (
              (e.originalEvent && (e = e.originalEvent),
              (w = "touchstart" === e.type) || !("which" in e) || 3 !== e.which)
            ) {
              if (x.params.noSwiping && s(e, "." + x.params.noSwipingClass))
                return void (x.allowClick = !0);
              if (!x.params.swipeHandler || s(e, x.params.swipeHandler)) {
                var n = (x.touches.currentX =
                    "touchstart" === e.type
                      ? e.targetTouches[0].pageX
                      : e.pageX),
                  i = (x.touches.currentY =
                    "touchstart" === e.type
                ...
                if (
                  !(
                    ...
                    n <= x.params.iOSEdgeSwipeThreshold
                  )
                ) {
                  if (
                    ((T = !0),
          ...
          (x.onTouchMove = function (e) {
            if (
              ...
              if (w && x.params.touchReleaseOnEdges && !x.params.loop) {
                if (x.isHorizontal()) {
                  if (
              ...
              if (
                ...
                return (E = !0), void (x.allowClick = !1);
              if (
                (S && x.emit("onTouchMove", x, e),
                ...
                if (
                  (A && x.emit("onTouchMoveOpposite", x, e),
                  void 0 === _ &&
                    ((x.touches.currentX === x.touches.startX &&
                      x.touches.currentY === x.touches.startY) ||
                      (_ = !0)),
                  ...
                  if (_) {
                    ...
                    if (
                      ...
                      if (!(Math.abs(r) > x.params.threshold || O))
                        return void (D = k);
                      if (!O)
                        return (
                          (O = !0),
            ...
            if (
              ...
              if (
                (x.allowClick &&
                  ...
                  i < 300 &&
                    n - M < 300 &&
                    (L && clearTimeout(L), x.emit("onDoubleTap", x, e))),
                (M = Date.now()),
                setTimeout(function () {
                  x && (x.allowClick = !0);
                }, 0),
              ...
              if (
                ...
                if (d < -x.minTranslate()) return void x.slideTo(x.activeIndex);
                if (d > -x.maxTranslate())
                ...
                if (x.params.freeModeMomentum) {
                  ...
                  if (u < x.maxTranslate())
                    ...
                    x.params.freeModeMomentumBounce
                      ? (u - x.minTranslate() > f && (u = x.minTranslate() + f),
                        (p = x.minTranslate()),
                        (h = !0),
                        (P = !0))
                      : (u = x.minTranslate());
                    ...
                    (u =
                      Math.abs(x.snapGrid[g] - u) <
                        Math.abs(x.snapGrid[g - 1] - u) ||
                      "next" === x.swipeDirection
                        ? x.snapGrid[g]
                        : x.snapGrid[g - 1]),
                      x.rtl || (u = -u);
                  ...
                  x.params.freeModeMomentumBounce && h
                    ? (x.updateProgress(p),
                ...
                return void (
                  (!x.params.freeModeMomentum || i >= x.params.longSwipesMs) &&
              ...
              for (y = 0; y < x.slidesGrid.length; y += x.params.slidesPerGroup)
                void 0 !== x.slidesGrid[y + x.params.slidesPerGroup]
                  ? d >= x.slidesGrid[y] &&
                    d < x.slidesGrid[y + x.params.slidesPerGroup] &&
                    ((b = y),
                    (w =
                      x.slidesGrid[y + x.params.slidesPerGroup] -
                      x.slidesGrid[y]))
                  : d >= x.slidesGrid[y] &&
                    ((b = y),
                    (w =
              ...
              var _ = (d - x.slidesGrid[b]) / w;
              if (i > x.params.longSwipesMs) {
                if (!x.params.longSwipes) return void x.slideTo(x.activeIndex);
                "next" === x.swipeDirection &&
                  (_ >= x.params.longSwipesRatio
                    ? x.slideTo(b + x.params.slidesPerGroup)
                    : x.slideTo(b)),
                  "prev" === x.swipeDirection &&
                    (_ > 1 - x.params.longSwipesRatio
                      ? x.slideTo(b + x.params.slidesPerGroup)
                      : x.slideTo(b));
              } else {
                ...
                "next" === x.swipeDirection &&
                  x.slideTo(b + x.params.slidesPerGroup),
                  "prev" === x.swipeDirection && x.slideTo(b);
              }
            }
          }),
          ...
          (x.slideTo = function (e, t, n, i) {
            ...
            if (
              ...
              for (var s = 0; s < x.slidesGrid.length; s++)
                -Math.floor(100 * r) >= Math.floor(100 * x.slidesGrid[s]) &&
                  (e = s);
            return !(
              (!x.params.allowSwipeToNext &&
                r < x.translate &&
          ...
          (x.slideNext = function (e, t, n) {
            return x.params.loop
              ? !x.animating &&
                  ...
                  x.slideTo(x.activeIndex + x.params.slidesPerGroup, t, e, n))
              : x.slideTo(x.activeIndex + x.params.slidesPerGroup, t, e, n);
          }),
          ...
          (x.slidePrev = function (e, t, n) {
            return x.params.loop
              ? !x.animating &&
                  (x.fixLoop(),
                  x.container[0].clientLeft,
                  x.slideTo(x.activeIndex - 1, t, e, n))
              : x.slideTo(x.activeIndex - 1, t, e, n);
          }),
          ...
          (x.setWrapperTranslate = function (e, t, n) {
            var r = 0,
              s = 0;
            x.isHorizontal() ? (r = x.rtl ? -e : e) : (s = e),
              x.params.roundLengths && ((r = i(r)), (s = i(s))),
              x.params.virtualTranslate ||
                (x.support.transforms3d
                  ? x.wrapper.transform(
                      "translate3d(" + r + "px, " + s + "px, 0px)"
                    )
                  : x.wrapper.transform("translate(" + r + "px, " + s + "px)")),
              (x.translate = x.isHorizontal() ? r : s);
            var a = x.maxTranslate() - x.minTranslate();
            (0 === a ? 0 : (e - x.minTranslate()) / a) !== x.progress &&
              x.updateProgress(e),
              ...
              x.params.control &&
                x.controller &&
                x.controller.setTranslate(x.translate, n),
          ...
          (x.initObservers = function () {
            if (x.params.observeParents)
              for (var e = x.container.parents(), t = 0; t < e.length; t++)
                a(e[t]);
            a(x.container[0], { childList: !1 }),
              a(x.wrapper[0], { attributes: !1 });
          }),
          ...
          (x.createLoop = function () {
            ...
            for (
              e.each(function (n, s) {
                var a = t(this);
                n < x.loopedSlides && r.push(s),
                  n < e.length && n >= e.length - x.loopedSlides && i.push(s),
              ...
              x.wrapper.append(
                t(r[n].cloneNode(!0)).addClass(x.params.slideDuplicateClass)
              );
            for (n = i.length - 1; n >= 0; n--)
              x.wrapper.prepend(
                t(i[n].cloneNode(!0)).addClass(x.params.slideDuplicateClass)
              );
          }),
          ...
          (x.removeSlide = function (e) {
            ...
            x.params.loop && x.createLoop(),
              (x.params.observer && x.support.observer) || x.update(!0),
              x.params.loop
                ? x.slideTo(n + x.loopedSlides, 0, !1)
                : x.slideTo(n, 0, !1);
          }),
          ...
          (x.effects = {
                ...
                for (var e = 0; e < x.slides.length; e++) {
                  ...
                  if (
                    (x.isHorizontal()
                      ...
                      : ((o = a), (a = 0), (s = -r), (r = 0)),
                    (n[0].style.zIndex =
                      -Math.abs(Math.round(i)) + x.slides.length),
            ...
            cube: {
              setTranslate: function () {
                ...
                x.params.cube.shadow &&
                  (x.isHorizontal()
                    ? (0 ===
                        (e = x.wrapper.find(".swiper-cube-shadow")).length &&
                        ((e = t('<div class="swiper-cube-shadow"></div>')),
                        x.wrapper.append(e)),
                      e.css({ height: x.width + "px" }))
                    : 0 ===
                        (e = x.container.find(".swiper-cube-shadow")).length &&
                      ((e = t('<div class="swiper-cube-shadow"></div>')),
                ...
                for (var i = 0; i < x.slides.length; i++) {
                  ...
                  i % 4 == 0
                    ...
                    ? ((l = 0), (u = -(4 * a) * x.size))
                    : (i - 2) % 4 == 0
                    ? ((l = x.size + 4 * a * x.size), (u = x.size))
                    : (i - 3) % 4 == 0 &&
                      ((l = -x.size), (u = 3 * x.size + 4 * x.size * a)),
                    x.rtl && (l = -l),
            ...
            coverflow: {
              setTranslate: function () {
                for (
                  var e = x.translate,
                    n = x.isHorizontal() ? -e + x.width / 2 : -e + x.height / 2,
                    i = x.isHorizontal()
                  ...
                  var o = x.slides.eq(s),
                    ...
                    c =
                      ((n - o[0].swiperSlideOffset - l / 2) / l) *
                      x.params.coverflow.modifier,
                    u = x.isHorizontal() ? i * c : 0,
                    d = x.isHorizontal() ? 0 : i * c,
                    p = -r * Math.abs(c),
                    h = x.isHorizontal() ? 0 : x.params.coverflow.stretch * c,
                    f = x.isHorizontal() ? x.params.coverflow.stretch * c : 0;
          ...
          (x.lazy = {
            ...
            loadImageInSlide: function (e, n) {
              if (
                void 0 !== e &&
                (void 0 === n && (n = !0), 0 !== x.slides.length)
              ) {
                var i = x.slides.eq(e),
                  r = i.find(
                    "." +
                ...
                !i.hasClass(x.params.lazyLoadingClass) ||
                  i.hasClass(x.params.lazyStatusLoadedClass) ||
                  i.hasClass(x.params.lazyStatusLoadingClass) ||
                  (r = r.add(i[0])),
                  0 !== r.length &&
                    r.each(function () {
                      var e = t(this);
                      ...
                      var r = e.attr("data-background"),
                        ...
                        o = e.attr("data-sizes");
                      x.loadImage(e[0], s || r, a, o, !1, function () {
                        if (null != x && x) {
                          if (
                            (r
            ...
            load: function () {
              ...
              if (
                ...
                for (e = x.activeIndex; e < x.activeIndex + n; e++)
              ...
              if (x.params.lazyLoadingInPrevNext) {
                if (
                  ...
                  var i = x.params.lazyLoadingInPrevNextAmount,
                    r = n,
                    s = Math.min(
                      x.activeIndex + r + Math.max(i, r),
                      x.slides.length
                    ),
                    a = Math.max(x.activeIndex - Math.max(r, i), 0);
                  for (e = x.activeIndex + n; e < s; e++)
                    x.slides[e] && x.lazy.loadImageInSlide(e);
            ...
            setTranslate: function (e, t) {
              function n(t) {
                (e =
                  ...
                  (r && "container" !== x.params.controlBy) ||
                    ...
                    (r = (e - x.minTranslate()) * i + t.minTranslate())),
              ...
              if (Array.isArray(s))
                for (var a = 0; a < s.length; a++)
                  s[a] !== t && s[a] instanceof u && n(s[a]);
              else s instanceof u && t !== s && n(s);
            },
            setTransition: function (e, t) {
              ...
              if (Array.isArray(r))
                for (i = 0; i < r.length; i++)
                  r[i] !== t && r[i] instanceof u && n(r[i]);
              else r instanceof u && t !== r && n(r);
            },
          }),
          (x.hashnav = {
            onHashCange: function (e, t) {
              ...
              n !== x.slides.eq(x.activeIndex).attr("data-hash") &&
                x.slideTo(
                  x.wrapper
                    .children(
                      "." + x.params.slideClass + '[data-hash="' + n + '"]'
                    )
                    .index()
                );
            },
            attachEvents: function (e) {
              t(window)[e ? "off" : "on"]("hashchange", x.hashnav.onHashCange);
            },
            setHash: function () {
            ...
            scrollToSlide: function (e, t, n) {
              if (t)
                for (var i = 0, r = x.slides.length; i < r; i++) {
                  var s = x.slides.eq(i);
                  if (
                    this.slugify(s.attr("data-history")) === t &&
          ...
          (x.disableKeyboardControl = function () {
            (x.params.keyboardControl = !1), t(document).off("keydown", o);
          }),
          (x.enableKeyboardControl = function () {
            (x.params.keyboardControl = !0), t(document).on("keydown", o);
          }),
          (x.mousewheel = {
            event: !1,
          ...
          (x.zoom = {
            ...
            getDistanceBetweenTouches: function (e) {
              ...
              return Math.sqrt(
                Math.pow(i - t, 2) + Math.pow(e.targetTouches[1].pageY - n, 2)
              );
            },
            onGestureStart: function (e) {
              ...
              ((n.gesture.slide = t(this)),
              0 === n.gesture.slide.length &&
                (n.gesture.slide = x.slides.eq(x.activeIndex)),
            ...
            onTouchEnd: function (e, t) {
              ...
              if (n.gesture.image && 0 !== n.gesture.image.length) {
                ...
                0 !== n.velocity.x &&
                  (i = Math.abs((a - n.image.currentX) / n.velocity.x)),
                  0 !== n.velocity.y &&
            ...
            toggleZoom: function (e, n) {
              var i,
                ...
                _ = e.zoom;
              _.gesture.slide ||
                ((_.gesture.slide = e.clickedSlide
                  ? t(e.clickedSlide)
                  : e.slides.eq(e.activeIndex)),
                (_.gesture.image = _.gesture.slide.find("img, svg, canvas")),
                (_.gesture.imageWrap = _.gesture.image.parent(
                  "." + e.params.zoomContainerClass
                ))),
                _.gesture.image &&
                  0 !== _.gesture.image.length &&
                  (void 0 === _.image.touchesStart.x && n
                    ? ((i =
                        "touchend" === n.type
                      ...
                      (r =
                        "touchend" === n.type
                          ...
                          : n.pageY))
                    : ((i = _.image.touchesStart.x),
                      (r = _.image.touchesStart.y)),
                  _.scale && 1 !== _.scale
                    ? ((_.scale = _.currentScale = 1),
                      _.gesture.imageWrap
                        .transition(300)
                      ...
                      (_.gesture.slide = void 0))
                    : ((_.scale = _.currentScale =
                        _.gesture.imageWrap.attr("data-swiper-zoom") ||
                        e.params.zoomMax),
                      n
                        ? ((x = _.gesture.slide[0].offsetWidth),
                          (w = _.gesture.slide[0].offsetHeight),
                          (s = _.gesture.slide.offset().left),
                          (a = _.gesture.slide.offset().top),
                          (o = s + x / 2 - i),
                          (l = a + w / 2 - r),
                          (d = _.gesture.image[0].offsetWidth),
                          (p = _.gesture.image[0].offsetHeight),
                          (h = d * _.scale),
                          (f = p * _.scale),
                          (g = Math.min(x / 2 - h / 2, 0)),
                          (v = Math.min(w / 2 - f / 2, 0)),
                          (y = -g),
                          (b = -v),
                          (c = o * _.scale),
                          (u = l * _.scale),
                      ...
                      _.gesture.image
                        .transition(300)
                        .transform(
                          "translate3d(0,0,0) scale(" + _.scale + ")"
                        )));
            },
            attachEvents: function (e) {
              var n = e ? "off" : "on";
              if (x.params.zoom) {
                ...
                x.support.gestures
                  ? (x.slides[n]("gesturestart", x.zoom.onGestureStart, i),
                    x.slides[n]("gesturechange", x.zoom.onGestureChange, i),
                    x.slides[n]("gestureend", x.zoom.onGestureEnd, i))
                  : "touchstart" === x.touchEvents.start &&
                    (x.slides[n](x.touchEvents.start, x.zoom.onGestureStart, i),
                  ...
                  x.slides.each(function (e, i) {
                    t(i).find("." + x.params.zoomContainerClass).length > 0 &&
                      t(i)[n](x.touchEvents.move, x.zoom.onTouchMove);
                  }),
    ...
    u.prototype = {
      isSafari:
        (n = window.navigator.userAgent.toLowerCase()).indexOf("safari") >= 0 &&
        0 > n.indexOf("chrome") &&
        0 > n.indexOf("android"),
      ...
      browser: {
        ...
        lteIE9:
          (((i = document.createElement("div")).innerHTML =
            "<!--[if lte IE 9]><i></i><![endif]-->"),
          1 === i.getElementsByTagName("i").length),
      },
      device:
        ((s = (r = window.navigator.userAgent).match(
          /(Android);?[\s\/]+([\d.]+)?/
        )),
        (a = r.match(/(iPad).*OS\s([\d_]+)/)),
        (o = r.match(/(iPod)(.*OS\s([\d_]+))?/)),
        (l = !a && r.match(/(iPhone\sOS|iOS)\s([\d_]+)/)),
        { ios: a || l || o, android: s }),
      support: {
        touch:
        ...
        transforms3d:
          ...
          "webkitPerspective" in (c = document.createElement("div").style) ||
          "MozPerspective" in c ||
          "OPerspective" in c ||
          "MsPerspective" in c ||
          "perspective" in c,
    ...
    for (var d = ["jQuery", "Zepto", "Dom7"], p = 0; p < d.length; p++)
      window[d[p]] &&
        (function (e) {
  ...
  (function (e) {
    var t = function (n, i) {
      (this.$element = e(n)),
        (this.options = e.extend({}, t.DEFAULTS, this.dataOptions(), i)),
        this.init();
    };
    (t.DEFAULTS = {
      from: 0,
      ...
      (e.fn.countTo = function (n) {
        return this.each(function () {
          ...
          (r && "object" != typeof n) ||
            ...
            r["string" == typeof n ? n : "start"].call(r);
        });
      });
  })(jQuery),
  (function (e, t) {
      ...
      (t.prototype.init = function () {
        ...
        (t.prototype.structure = function () {
          ...
          if (
            ...
            o.css("transition-timing-function", this.s.cssEasing),
        ...
        (t.prototype.addHtml = function (t) {
          ...
          if (
            (this.s.dynamic
              ? this.s.dynamicEl[t].subHtmlUrl
                ...
                : (r = this.s.dynamicEl[t].subHtml)
              : (i = this.$items.eq(t)).attr("data-sub-html-url")
              ? (n = i.attr("data-sub-html-url"))
              : ((r = i.attr("data-sub-html")),
                this.s.getCaptionFromTitleOrAlt &&
                  !r &&
                  (r = i.attr("title") || i.find("img").first().attr("alt"))),
            !n)
          ) {
            if (null != r) {
          ...
          ".lg-sub-html" === this.s.appendSubHtmlTo
            ? n
              ...
              : this.$outer.find(this.s.appendSubHtmlTo).html(r)
            : n
            ? this.$slide.eq(t).load(n)
            : this.$slide.eq(t).append(r),
            null != r &&
              ("" === r
                ? this.$outer
        ...
        (t.prototype.loadContent = function (t, n, i) {
          var r,
            ...
            p = function (t) {
              ...
              for (var o = e(window).width(), l = 0; l < n.length; l++)
                if (parseInt(n[l], 10) > o) {
                  s = i[l];
                  break;
                }
            };
          if (u.s.dynamic)
            u.s.dynamicEl[t].poster &&
              ((d = !0), (a = u.s.dynamicEl[t].poster)),
              (c = u.s.dynamicEl[t].html),
              (s = u.s.dynamicEl[t].src),
              u.s.dynamicEl[t].responsive &&
                p(u.s.dynamicEl[t].responsive.split(",")),
              (o = u.s.dynamicEl[t].srcset),
              (l = u.s.dynamicEl[t].sizes);
          else {
            if (
              (u.$items.eq(t).attr("data-poster") &&
                ((d = !0), (a = u.$items.eq(t).attr("data-poster"))),
              (c = u.$items.eq(t).attr("data-html")),
              (s =
                u.$items.eq(t).attr("href") || u.$items.eq(t).attr("data-src")),
              u.$items.eq(t).attr("data-responsive"))
            ) {
              var h = u.$items.eq(t).attr("data-responsive").split(",");
              p(h);
            }
            (o = u.$items.eq(t).attr("data-srcset")),
              (l = u.$items.eq(t).attr("data-sizes"));
          }
          var f = !1;
          u.s.dynamic
            ? u.s.dynamicEl[t].iframe && (f = !0)
            : "true" === u.$items.eq(t).attr("data-iframe") && (f = !0);
          var g = u.isVideo(s, t);
            ...
            if (f)
              ...
              g
                ? (u.$slide
                  ...
                  u.$el.trigger("hasVideo.lg", [t, s, c]))
                : u.$slide
                    .eq(t)
                    .prepend(
              ...
              i && !e("body").hasClass("lg-from-hash") && (n = i),
                setTimeout(function () {
                  u.$slide.eq(t).addClass("lg-complete"),
                    u.$el.trigger("onSlideItemLoad.lg", [t, i || 0]);
                }, n);
            }),
            g && g.html5 && !d && u.$slide.eq(t).addClass("lg-complete"),
            !0 === n &&
        ...
        (t.prototype.slide = function (t, n, i, r) {
          ...
          if (!a.lGalleryOn || s !== t) {
            var o,
              ...
              c,
              u = this.$slide.length,
              d = a.lGalleryOn ? this.s.speed : 0;
            !a.lgBusy &&
              (this.s.download &&
                ((o = a.s.dynamic
                  ? !1 !== a.s.dynamicEl[t].downloadUrl &&
                    (a.s.dynamicEl[t].downloadUrl || a.s.dynamicEl[t].src)
                  : "false" !== a.$items.eq(t).attr("data-download-url") &&
                    (a.$items.eq(t).attr("data-download-url") ||
                      a.$items.eq(t).attr("href") ||
                      a.$items.eq(t).attr("data-src")))
                  ? (e("#lg-download").attr("href", o),
                    a.$outer.removeClass("lg-hide-download"))
                  : a.$outer.addClass("lg-hide-download")),
              (this.$el.trigger("onBeforeSlide.lg", [s, t, n, i]),
              (a.lgBusy = !0),
              ...
              n)
                ? (this.$slide.removeClass(
                  ...
                  u > 2
                    ...
                    : ((l = 0), (c = 1)),
                  "prev" === r
                    ? a.$slide.eq(c).addClass("lg-next-slide")
                    : a.$slide.eq(l).addClass("lg-prev-slide"),
                  a.$slide.eq(t).addClass("lg-current"))
                : (a.$outer.addClass("lg-no-trans"),
                  ...
                  setTimeout(function () {
                    a.$slide.removeClass("lg-current"),
                      a.$slide.eq(t).addClass("lg-current"),
                      a.$outer.removeClass("lg-no-trans");
                  }, 50)),
              a.lGalleryOn
                ? (setTimeout(function () {
                    a.loadContent(t, !0, 0);
                  ...
                  setTimeout(function () {
                    (a.lgBusy = !1),
                      a.$el.trigger("onAfterSlide.lg", [s, t, n, i]);
                  }, this.s.speed))
                : (a.loadContent(t, !0, a.s.backdropDuration),
                  (a.lgBusy = !1),
                  a.$el.trigger("onAfterSlide.lg", [s, t, n, i])),
              (a.lGalleryOn = !0),
        ...
        (t.prototype.enableDrag = function () {
          ...
          t.s.enableDrag &&
            ...
            (t.$slide.on("mousedown.lg", function (i) {
              t.$outer.hasClass("lg-zoomed") ||
                ((e(i.target).hasClass("lg-object") ||
                  e(i.target).hasClass("lg-video-play")) &&
                  (i.preventDefault(),
                  t.lgBusy ||
                    (t.manageSwipeClass(),
                    (n = i.pageX),
            ...
            e(window).on("mouseup.lg", function (a) {
              s
                ? ((s = !1), t.touchEnd(i - n), t.$el.trigger("onDragend.lg"))
                : (e(a.target).hasClass("lg-object") ||
                    e(a.target).hasClass("lg-video-play")) &&
        ...
        (t.prototype.destroy = function (t) {
          ...
          t ||
            ...
            t &&
              (n.s.dynamic || this.$items.off("click.lg click.lgcustom"),
          ...
          n.core.s.progressBar &&
            ...
            n.interval &&
              ...
              setTimeout(function () {
                t.css(
                  "transition",
                  "width " + (n.core.s.speed + n.core.s.pause) + "ms ease 0s"
                ),
                  e.addClass("lg-start");
              }, 20))),
    ...
    (t = { pager: !1 }),
      ((n = function (n) {
        ...
        if (
          ...
          for (var a = 0; a < r.core.s.dynamicEl.length; a++)
            s +=
              '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
              r.core.s.dynamicEl[a].thumb +
              '" /></div></span>';
        else
          r.core.$items.each(function () {
            s += r.core.s.exThumbImage
              ? '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                e(this).attr(r.core.s.exThumbImage) +
                '" /></div></span>'
              : '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                e(this).find("img").attr("src") +
                '" /></div></span>';
          });
        (n = r.core.$outer.find(".lg-pager-outer")).html(s),
          (t = r.core.$outer.find(".lg-pager-cont")).on(
            "click.lg touchend.lg",
            function () {
              var t = e(this);
              (r.core.index = t.index()),
      ...
      (n.prototype.destroy = function () {}),
      (e.fn.lightGallery.modules.pager = n);
  }),
  (function (e, t) {
    "function" == typeof define && define.amd
      ? define(["jquery"], function (e) {
    ...
    (t = {
      ...
      (n.prototype.build = function () {
        function t(e, t, n) {
          var a,
            o = i.core.isVideo(e, n) || {},
            l = "";
          o.youtube || o.vimeo || o.dailymotion
            ? o.youtube
              ? (a = i.core.s.loadYoutubeThumbnail
                  ? "//img.youtube.com/vi/" +
                    o.youtube[1] +
                    "/" +
              ...
              ? i.core.s.loadVimeoThumbnail
                ? ((a = "//i.vimeocdn.com/video/error_" + s + ".jpg"),
                  (l = o.vimeo[1]))
                : (a = t)
              : o.dailymotion &&
                (a = i.core.s.loadDailymotionThumbnail
                  ? "//www.dailymotion.com/thumbnail/video/" + o.dailymotion[1]
                  : t)
            : (a = t),
            (r +=
              '<div data-vimeo-id="' +
        ...
        if (
          ...
          for (var a = 0; a < i.core.s.dynamicEl.length; a++)
            t(i.core.s.dynamicEl[a].src, i.core.s.dynamicEl[a].thumb, a);
        else
          i.core.$items.each(function (n) {
        ...
        i.core.$outer.find(".lg-thumb").html(r),
          (n = i.core.$outer.find(".lg-thumb-item")).each(function () {
            var t = e(this),
              n = t.attr("data-vimeo-id");
            n &&
              e.getJSON(
                "//www.vimeo.com/api/v2/video/" + n + ".json?callback=?",
                { format: "json" },
                function (e) {
          ...
          n.eq(i.core.index).addClass("active"),
      ...
      (n.prototype.animateThumb = function (e) {
        var t,
          n = this.core.$outer.find(".lg-thumb");
          ...
          (this.left =
            ...
            this.core.lGalleryOn
              ? (n.hasClass("on") ||
                ...
                this.core.doCss() ||
                  n.animate({ left: -this.left + "px" }, this.core.s.speed))
              : this.core.doCss() || n.css("left", -this.left + "px"),
        ...
        t.$thumbOuter.addClass("lg-grab"),
          ...
          e(window).on("mousemove.lg.thumb", function (e) {
            r &&
              ...
              (a -= i - n) > t.thumbTotalWidth - t.thumbOuterWidth &&
                (a = t.thumbTotalWidth - t.thumbOuterWidth),
              a < 0 && (a = 0),
              t.setTranslate(a));
          }),
          e(window).on("mouseup.lg.thumb", function () {
            s
              ? ((s = !1),
                ...
                (t.left = a),
                Math.abs(i - n) < t.core.s.swipeThreshold &&
                  (t.thumbClickable = !0))
              : (t.thumbClickable = !0),
              r &&
                ((r = !1),
      ...
      (n.prototype.enableThumbSwipe = function () {
        ...
        e.core.$outer.find(".lg-thumb").on("touchstart.lg", function (n) {
          ...
          e.core.$outer.find(".lg-thumb").on("touchmove.lg", function (s) {
            e.thumbTotalWidth > e.thumbOuterWidth &&
              (s.preventDefault(),
              (n = s.originalEvent.targetTouches[0].pageX),
              (i = !0),
              e.$thumbOuter.addClass("lg-dragging"),
              (r = e.left),
              (r -= n - t) > e.thumbTotalWidth - e.thumbOuterWidth &&
          ...
          e.core.$outer.find(".lg-thumb").on("touchend.lg", function () {
            e.thumbTotalWidth > e.thumbOuterWidth && i
              ? ((i = !1),
                ...
                Math.abs(n - t) < e.core.s.swipeThreshold &&
                  (e.thumbClickable = !0),
                (e.left = r))
              : (e.thumbClickable = !0);
          });
  ...
  (function (e, t) {
    ...
    (t = {
      ...
      ((n = function (n) {
        ...
        var t = this;
        t.core.$el.on("hasVideo.lg.tm", function (e, n, i, r) {
          if (
            (t.core.$slide
              .eq(n)
              .find(".lg-video")
              .append(t.loadVideo(i, "lg-object", !0, n, r)),
            r)
          ) {
            if (t.core.s.videojs)
              try {
                videojs(
                  t.core.$slide.eq(n).find(".lg-html5").get(0),
              ...
              t.videoLoaded ||
                t.core.$slide.eq(n).find(".lg-html5").get(0).play();
          }
        }),
          t.core.$el.on("onAferAppendSlide.lg.tm", function (e, n) {
            var i = t.core.$slide.eq(n).find(".lg-video-cont");
            i.hasClass("lg-has-iframe") ||
              (i.css("max-width", t.core.s.videoMaxWidth),
              (t.videoLoaded = !0));
          });
        var n = function (e) {
          if (
            ...
            if (e.hasClass("lg-has-video")) {
              ...
              t.core.s.dynamic
                ? u(
                    (l = t.core.s.dynamicEl[t.core.index].src),
                    (c = t.core.s.dynamicEl[t.core.index].html)
                  )
                : u(
                    (l =
                      t.core.$items.eq(t.core.index).attr("href") ||
                      t.core.$items.eq(t.core.index).attr("data-src")),
                    (c = t.core.$items.eq(t.core.index).attr("data-html"))
                  );
        ...
        (t.core.s.enableSwipe || t.core.s.enableDrag)
          ? t.core.$el.on("onSlideClick.lg.tm", function () {
              n(t.core.$slide.eq(t.core.index));
            })
          : t.core.$slide.on("click.lg", function () {
              n(e(this));
            }),
          t.core.$el.on("onBeforeSlide.lg.tm", function (n, i, r) {
            var s,
              a = t.core.$slide.eq(i),
              o = a.find(".lg-youtube").get(0),
              l = a.find(".lg-vimeo").get(0),
              c = a.find(".lg-dailymotion").get(0),
              u = a.find(".lg-vk").get(0),
            ...
            u &&
              e(u).attr(
                "src",
                e(u).attr("src").replace("&autoplay", "&noplay")
              ),
              (s = t.core.s.dynamic
                ? t.core.s.dynamicEl[r].src
                : t.core.$items.eq(r).attr("href") ||
                  t.core.$items.eq(r).attr("data-src"));
            var f = t.core.isVideo(s, r) || {};
            (f.youtube || f.vimeo || f.dailymotion || f.vk) &&
              t.core.$outer.addClass("lg-hide-download");
          }),
          t.core.$el.on("onAfterSlide.lg.tm", function (e, n) {
            t.core.$slide.eq(n).removeClass("lg-video-playing");
          });
      }),
      (n.prototype.loadVideo = function (t, n, i, r, s) {
        var a = "",
          o = 1,
          l = "",
          c = this.core.isVideo(t, r) || {};
        if ((i && (o = this.videoLoaded ? 0 : 1), c.youtube))
          (l = "?wmode=opaque&autoplay=" + o + "&enablejsapi=1"),
            this.core.s.youtubePlayerParams &&
              (l = l + "&" + e.param(this.core.s.youtubePlayerParams)),
            (a =
          ...
          (l = "?wmode=opaque&autoplay=" + o + "&api=postMessage"),
  ...
  (function (e, t) {
    ...
    (i = {
      ...
      useLeftForZoom:
        ((t = !1),
        (n = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)) &&
          54 > parseInt(n[2], 10) &&
          (t = !0),
        t),
    }),
      ((r = function (t) {
        ...
        t.core.s.actualSize &&
          (n += '<span id="lg-actual-size" class="lg-icon"></span>'),
          ...
          t.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (n, i, r) {
            var s = t.core.s.enableZoomAfter + r;
            e("body").hasClass("lg-from-hash") && r
              ? (s = 0)
        ...
        var i = 1,
          r = function (n) {
            var i,
              ...
              a = (e(window).width() - s.prop("offsetWidth")) / 2,
              o =
                (e(window).height() - s.prop("offsetHeight")) / 2 +
                e(window).scrollTop();
            (i = t.pageX - a), (r = t.pageY - o);
            var l = (n - 1) * i,
              c = (n - 1) * r;
            s
              .css("transform", "scale3d(" + n + ", " + n + ", 1)")
              .attr("data-scale", n),
              t.core.s.useLeftForZoom
                ? s
                    .parent()
          ...
          a = function (n, r, a, o) {
            var l,
              c,
              u = r.prop("offsetWidth");
            (c = t.core.s.dynamic
              ? t.core.s.dynamicEl[a].width || r[0].naturalWidth || u
              : t.core.$items.eq(a).attr("data-width") ||
                r[0].naturalWidth ||
                u),
              ...
              o
                ...
                : ((t.pageX =
                    n.pageX || n.originalEvent.targetTouches[0].pageX),
                  (t.pageY =
                    n.pageY || n.originalEvent.targetTouches[0].pageY)),
              s(),
              setTimeout(function () {
      ...
      (r.prototype.zoomSwipe = function () {
        ...
        e.core.$slide.on("touchstart.lg", function (n) {
          if (e.core.$outer.hasClass("lg-zoomed")) {
            ...
            (s =
              i.prop("offsetHeight") * i.attr("data-scale") >
              e.core.$outer.find(".lg").height()),
              ((r =
                i.prop("offsetWidth") * i.attr("data-scale") >
          ...
          e.core.$slide.on("touchmove.lg", function (a) {
            if (e.core.$outer.hasClass("lg-zoomed")) {
              var o,
                l,
                c = e.core.$slide.eq(e.core.index).find(".lg-img-wrap");
              a.preventDefault(),
                (i = !0),
                (n = {
                ...
                (l = s
                  ? -Math.abs(c.attr("data-y")) + (n.y - t.y)
                  : -Math.abs(c.attr("data-y"))),
                (o = r
                  ? -Math.abs(c.attr("data-x")) + (n.x - t.x)
                  : -Math.abs(c.attr("data-x"))),
                (Math.abs(n.x - t.x) > 15 || Math.abs(n.y - t.y) > 15) &&
                  (e.core.s.useLeftForZoom
                    ? c.css({ left: o + "px", top: l + "px" })
                    : c.css(
                        "transform",
        ...
        t.core.$slide.on("mousedown.lg.zoom", function (i) {
          ...
          e(window).on("mousemove.lg.zoom", function (e) {
            if (r) {
              var l,
                c,
                u = t.core.$slide.eq(t.core.index).find(".lg-img-wrap");
              (s = !0),
                (i = { x: e.pageX, y: e.pageY }),
                t.core.$outer.addClass("lg-zoom-dragging"),
                (c = o
                  ? -Math.abs(u.attr("data-y")) + (i.y - n.y)
                  : -Math.abs(u.attr("data-y"))),
                (l = a
                  ? -Math.abs(u.attr("data-x")) + (i.x - n.x)
                  : -Math.abs(u.attr("data-x"))),
                t.core.s.useLeftForZoom
                  ? u.css({ left: l + "px", top: c + "px" })
                  : u.css(
                      "transform",
                      "translate3d(" + l + "px, " + c + "px, 0)"
                    );
          ...
          e(window).on("mouseup.lg.zoom", function (e) {
            r &&
              ...
              s &&
                (n.x !== i.x || n.y !== i.y) &&
                ((i = { x: e.pageX, y: e.pageY }), t.touchendZoom(n, i, a, o)),
              (s = !1)),
              t.core.$outer.removeClass("lg-grabbing").addClass("lg-grab");
          });
      }),
      (r.prototype.touchendZoom = function (e, t, n, i) {
        var r = this.core.$slide.eq(this.core.index).find(".lg-img-wrap"),
          ...
          l =
            (this.core.$outer.find(".lg").height() - s.prop("offsetHeight")) /
            2,
          c = Math.abs(
          ...
          u =
            (this.core.$outer.find(".lg").width() - s.prop("offsetWidth")) / 2,
          d = Math.abs(
        ...
        (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) &&
          ...
          this.core.s.useLeftForZoom
            ? r.css({ left: a + "px", top: o + "px" })
            : r.css("transform", "translate3d(" + a + "px, " + o + "px, 0)"));
      }),
      (r.prototype.destroy = function () {
        var t = this;
      ...
      ((n = function (n) {
        ...
        n.core.$el.on("onAfterSlide.lg.tm", function (e, t, i) {
          ...
          e(window).on("hashchange.lg.hash", function () {
            ...
            t.indexOf("lg=" + n.core.s.galleryId) > -1
              ? n.core.slide(e, !1, !1)
              : n.core.lGalleryOn && n.core.destroy();
          });
      }),
      (n.prototype.destroy = function () {
        this.core.s.hash &&
  ...
  (function (e, t) {
    ...
    (t = {
        ...
        (n += t.core.s.facebook
          ...
          (n += t.core.s.twitter
            ? '<li><a id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' +
              ...
              "</span></a></li>"
            : ""),
          (n += t.core.s.googlePlus
            ? '<li><a id="lg-share-googleplus" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' +
              this.core.s.googlePlusDropdownText +
              "</span></a></li>"
            : ""),
          (n += t.core.s.pinterest
            ...
            setTimeout(function () {
              e("#lg-share-facebook").attr(
                ...
                "https://www.facebook.com/sharer/sharer.php?u=" +
                  encodeURIComponent(
                    t.getSahreProps(r, "facebookShareUrl") ||
                      window.location.href
                  )
              ),
                e("#lg-share-twitter").attr(
                  ...
                  "https://twitter.com/intent/tweet?text=" +
                    t.getSahreProps(r, "tweetText") +
                    "&url=" +
                    encodeURIComponent(
                      t.getSahreProps(r, "twitterShareUrl") ||
                        window.location.href
                    )
                ),
                e("#lg-share-googleplus").attr(
                  ...
                  "https://plus.google.com/share?url=" +
                    encodeURIComponent(
                      t.getSahreProps(r, "googleplusShareUrl") ||
                        window.location.href
                    )
                ),
                e("#lg-share-pinterest").attr(
                  ...
                  "http://www.pinterest.com/pin/create/button/?url=" +
                    encodeURIComponent(
                      t.getSahreProps(r, "pinterestShareUrl") ||
                        window.location.href
                    ) +
                    "&media=" +
                    encodeURIComponent(t.getSahreProps(r, "src")) +
                    "&description=" +
                    t.getSahreProps(r, "pinterestText")
                );
            }, 100);
          });
      }),
      (n.prototype.getSahreProps = function (e, t) {
        var n = "";
      ...
      (n.prototype.destroy = function () {}),
      (e.fn.lightGallery.modules.share = n);
  }),
  /**
   * @module       WOW
        ...
        (n = (function () {
          ...
          return (
            (e.prototype.get = function (e) {
              var t, n, i, r, s;
              for (s = this.keys, t = i = 0, r = s.length; r > i; t = ++i)
                if ((n = s[t]) === e) return this.values[t];
            }),
            (e.prototype.set = function (e, t) {
              var n, i, r, s, a;
              for (a = this.keys, n = r = 0, s = a.length; s > r; n = ++r)
        ...
        return (
          ...
          (r.prototype.applyStyle = function (e, t) {
            ...
            return (
              ...
              this.animate(
                ((s = this),
                function () {
                  return s.customStyle(e, t, i, n, r);
                })
              )
            );
          }),
              ...
              (r = t[n]),
                ...
                i.push(
                  function () {
                    var t, i, a, o;
                    for (
                      a = this.vendors, o = [], t = 0, i = a.length;
                      i > t;
                      t++
                    )
                      (s = a[t]),
                        o.push(
                          (e["" + s + n.charAt(0).toUpperCase() + n.substr(1)] =
                            r)
                        );
                    return o;
                  }.call(this)
          ...
          (r.prototype.vendorCSS = function (e, t) {
            ...
            for (
              ...
              (l = s[n]), (a = a || o.getPropertyCSSValue("-" + l + "-" + t));
            return a;
          }),
...
var pJS = function (e, t) {
  ...
  t && Object.deepExtend(i, t),
    ...
    (i.fn.particle.prototype.draw = function () {
      ...
      if (this.color.rgb)
        ...
        var n =
          ...
          ")";
      switch (
        ((i.canvas.ctx.fillStyle = n), i.canvas.ctx.beginPath(), this.shape)
      ) {
        case "circle":
          i.canvas.ctx.arc(this.x, this.y, e, 0, 2 * Math.PI, !1);
          break;
        case "edge":
          i.canvas.ctx.rect(this.x - e, this.y - e, 2 * e, 2 * e);
          break;
        case "triangle":
        ...
        case "polygon":
          i.fn.vendors.drawShape(
            i.canvas.ctx,
            this.x - e / (i.particles.shape.polygon.nb_sides / 3.5),
            this.y - e / 0.76,
        ...
        case "star":
          i.fn.vendors.drawShape(
            i.canvas.ctx,
            this.x - (2 * e) / (i.particles.shape.polygon.nb_sides / 4),
            this.y - e / 1.52,
          ...
          break;
        case "image":
          if ("svg" == i.tmp.img_type) var r = this.img.obj;
    ...
    (i.fn.interact.bounceParticles = function (e, t) {
      var n = e.x - t.x,
        i = e.y - t.y;
      e.radius + t.radius >= Math.sqrt(n * n + i * i) &&
    ...
    (i.fn.modes.bubbleParticle = function (e) {
      ...
      function n(t, n, r, s, o) {
        if (t != n) {
          if (i.tmp.bubble_duration_end) {
            ...
            if (c != t) {
              var u = s - (d * (s - t)) / i.interactivity.modes.bubble.duration;
              "size" == o && (e.radius_bubble = u),
                "opacity" == o && (e.opacity_bubble = u);
            }
          } else
      ...
      if (
        ...
        var r = e.x - i.interactivity.mouse.pos_x,
          ...
          a = Math.sqrt(r * r + s * s),
          o = 1 - a / i.interactivity.modes.bubble.distance;
    ...
    (i.fn.modes.repulseParticle = function (e) {
      if (
        ...
        if (
          ...
          a >= d &&
            (function t() {
              var n = Math.atan2(u, c);
              if (
                ((e.vx = p * Math.cos(n)),
                (e.vy = p * Math.sin(n)),
                "bounce" == i.particles.move.out_mode)
              ) {
                var r = { x: e.x + e.vx, y: e.y + e.vy };
                r.x + e.radius > i.canvas.w
                  ? (e.vx = -e.vx)
                  : r.x - e.radius < 0 && (e.vx = -e.vx),
                  r.y + e.radius > i.canvas.h
                    ? (e.vy = -e.vy)
                    : r.y - e.radius < 0 && (e.vy = -e.vy);
              }
            })();
        } else
